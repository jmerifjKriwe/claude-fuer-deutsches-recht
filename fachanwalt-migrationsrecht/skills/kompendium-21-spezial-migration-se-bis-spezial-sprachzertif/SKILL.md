...
description: "fachanwalt-migrationsrecht: Konsolidiertes Skill-Kompendium 21; bündelt 17 frühere Spezialskills (spezial-migration-selbststaendige, spezial-migrationsrecht-tatbestand-beweis-und-belege, spezial-minderjaehrige-unbegleitet, spezial-niederlassungserlaubnis, spezial-opfer-zeugen-menschenhandel und 12 weitere) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 21 - fachanwalt-migrationsrecht
...
**Frühere Beschreibung:** Selbstständige Migration: Spezial-Skill im Migrationsrecht; prüft wirtschaftliches Interesse, Finanzierung, Businessplan, Altersvorsorge; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
**Frühere Beschreibung:** Migrationsrecht: Tatbestandsmerkmale, Beweisfragen und Beleglage im Plugin fachanwalt migrationsrecht; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
**Frühere Beschreibung:** Unbegleitete Minderjährige: Spezial-Skill im Migrationsrecht; prüft Alter, Jugendamt, Vormund, Dublin, Kindeswohl; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
**Frühere Beschreibung:** Niederlassungserlaubnis: Spezial-Skill im Migrationsrecht; prüft Zeiten, Beiträge, Sprach-/Integrationsanforderungen, Ausnahmen; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
**Frühere Beschreibung:** Opfer/Zeugen/Menschenhandel: Spezial-Skill im Migrationsrecht; prüft Schutzstatus, Kooperation, Sicherheit, Sozialleistungen; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 6. `spezial-passbeschaffung-zumutbarkeit`

**Frühere Beschreibung:** Passbeschaffung Zumutbarkeit: Spezial-Skill im Migrationsrecht; prüft Mitwirkung, Botschaftskontakt, Schutzstatus, Beweisalternativen; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 7. `spezial-petition-migration`

**Frühere Beschreibung:** Petition Migration: Spezial-Skill im Migrationsrecht; prüft Landtag/Bundestag, Ziel, Timing, Parallelverfahren; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 8. `spezial-qualifikations-schriftsatz-brief-und-memo-bausteine`

**Frühere Beschreibung:** Qualifikations: Schriftsatz-, Brief- und Memo-Bausteine im Plugin fachanwalt migrationsrecht; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
## 9. `spezial-rechtsberatungsstelle-formular-portal-und-einreichung`

**Frühere Beschreibung:** Rechtsberatungsstelle: Formular, Portal und Einreichungslogik im Plugin fachanwalt migrationsrecht; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
## 10. `spezial-reform-mandantenkommunikation-entscheidungsvorlage`

**Frühere Beschreibung:** Reform: Mandantenkommunikation und Entscheidungsvorlage im Plugin fachanwalt migrationsrecht; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
## 11. `spezial-reiseausweis-fluechtling`

**Frühere Beschreibung:** Reiseausweis Flüchtling: Spezial-Skill im Migrationsrecht; prüft Anspruch, Passbeschaffung, Zumutbarkeit, Reise-/Heimatstaatrisiko; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 12. `spezial-religionswechsel`

**Frühere Beschreibung:** Religionswechsel: Spezial-Skill im Migrationsrecht; prüft Ernsthaftigkeit, Nachweise, Herkunftslandrisiko, Anhörung; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 13. `spezial-remonstration-visum`

**Frühere Beschreibung:** Remonstration/Visumklage: Spezial-Skill im Migrationsrecht; prüft Begründung, Frist, Akteneinsicht, Botschaft, VG Berlin; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 14. `spezial-schengenvisum-abgrenzung`

**Frühere Beschreibung:** Schengenvisum Abgrenzung: Spezial-Skill im Migrationsrecht; prüft Kurzaufenthalt, Rückkehrbereitschaft, Zweckwechsel, Missbrauchsrisiko; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 15. `spezial-schnittstellen-internationaler-bezug-und-schnittstellen`

**Frühere Beschreibung:** Schnittstellen: Internationaler Bezug und Schnittstellen im Plugin fachanwalt migrationsrecht; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
## 16. `spezial-sichere-herkunft-und-drittstaat`

**Frühere Beschreibung:** Sichere Herkunft/Drittstaat: Spezial-Skill im Migrationsrecht; prüft EU/nationalen Listenstatus, Widerlegung, individuelle Risiken; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
...
## 17. `spezial-sprachzertifikate`

**Frühere Beschreibung:** Sprachzertifikate: Spezial-Skill im Migrationsrecht; prüft anerkanntes Zertifikat, Niveau, Ausnahmen, Härtefälle; mit deutschem Recht, EU/EMRK/GFK, Belegen, Fristen und Quellencheck.
