...
Dieser Skill behandelt **Einbuergerung Lebensunterhalt Mehrstaatigkeit** als zusammenhängenden Arbeitsgang im Migrationsrecht. Im Mittelpunkt steht die Prüfung von Einbürgerung Lebensunterhalt, Einbürgerung Mehrstaatigkeit, Einbürgerung Vorstrafen und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
