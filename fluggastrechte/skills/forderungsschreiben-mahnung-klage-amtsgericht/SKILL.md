...
description: "Forderungsschreiben Mahnung Klage Amtsgericht im Fluggastrechte: prüft konkret Zweite Stufe nach Ablauf der Frist aus dem ersten, Prüffeld für klage amtsgericht fluggast, Pauschalreise gegen Flug-Einzelbuchung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Forderungsschreiben Mahnung Klage Amtsgericht** als zusammenhängenden Arbeitsgang im Fluggastrechte. Im Mittelpunkt steht die Prüfung von Zweite Stufe nach Ablauf der Frist aus dem ersten, Prüffeld für klage amtsgericht fluggast, Pauschalreise gegen Flug-Einzelbuchung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
