...
| `arbeitsblatt-schriftsatz-brief-und-memo-bausteine` | Arbeitsblatt: Schriftsatz-, Brief- und Memo-Bausteine im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `datenpunkt-dokument-excel-beweislast` | Datenpunkt: Dokumentenmatrix, Lückenliste und Nachforderung im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `dokument-behoerden-gericht-und-registerweg` | Dokument: Behörden-, Gerichts- oder Registerweg im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `excel-beweislast-und-darlegungslast` | Excel: Beweislast, Darlegungslast und Substantiierung im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `fristen-und-risikoampel` | Fristen- und Risikoampel im Plugin Tabellenreview 3D im Tabellenreview 3d. |
...
| `gestapelt-immobilien-massenpruefung` | Gestapelt: Compliance-Dokumentation und Aktenvermerk im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `immobilien-formular-portal-und-einreichung` | Immobilien: Formular, Portal und Einreichungslogik im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `massenpruefung-mehrparteien-konflikt-und-interessen` | Massenpruefung: Mehrparteienkonflikt und Interessenmatrix im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `mehrblatt-sonderfall-onboarding-perspektiven` | Mehrblatt: Sonderfall und Edge-Case-Prüfung im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `onboarding-mandantenkommunikation-entscheidungsvorlage` | Onboarding: Mandantenkommunikation und Entscheidungsvorlage im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `perspektiven-verhandlung-vergleich-und-eskalation` | Perspektiven: Verhandlung, Vergleich und Eskalation im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `spaltenprompts-fristen-form-und-zustaendigkeit` | Spaltenprompts: Fristen, Form, Zuständigkeit und Rechtsweg im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `tabellenreview-erstpruefung-und-mandatsziel` | Tabellenreview: Erstprüfung, Rollenklärung und Mandatsziel im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `vendor-red-team-und-qualitaetskontrolle` | Vendor: Red-Team und Qualitätskontrolle im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `vertragsstapel-vorlage-arbeitsvertrag` | Vertragsstapel: Internationaler Bezug und Schnittstellen im Plugin tabellenreview 3d im Tabellenreview 3d. |
...
| `wirtschaft-wuerfel-zeilenprompts` | Wirtschaft: Zahlen, Schwellenwerte und Berechnung im Plugin tabellenreview 3d im Tabellenreview 3d. |
