...
| Skill | Beschreibung |
| --- | --- |
| `aggregation-spaltenprompts-definieren` | Aggregation Spaltenprompts Definieren: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `belegkette-rueckverfolgung-caching-rerun` | Belegkette Rueckverfolgung Caching Rerun: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `datenpunkt-dokument-excel-beweislast` | Datenpunkt Dokument Excel Beweislast: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `erstpruefung-rollenklaerung` | Tabellenreview: Erstprüfung, Rollenklärung und Mandatsziel: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
...
| `excel-multi-kreuzblatt-konsistenzpruefung-pdf` | Excel Multi Kreuzblatt Konsistenzpruefung PDF: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gestapelt-immobilien-massenpruefung` | Gestapelt Immobilien Massenpruefung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `mehrblatt-sonderfall-onboarding-perspektiven` | Mehrblatt Sonderfall Onboarding Perspektiven: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `professional-review-tabellenreview-vendor-red` | Professional Review Tabellenreview Vendor RED: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `prompt-versionierung-paket-review` | Prompt Versionierung Paket Review: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `tabellenreview-3d-mandantenkommunikation-redteam-qualitygate` | Mandantenkommunikation Redteam Qualitygate: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `tabellenreview-3d-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `tabellenreview-3d-tr3d-bestreitensgruende-leitfaden` | Tr3d Bestreitensgruende Leitfaden: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `tr3d-pruefkategorien-vorlage-vendor-wuerfel` | Tr3d Pruefkategorien Vorlage Vendor Wuerfel: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `vertragsstapel-vorlage-arbeitsvertrag` | Vertragsstapel Vorlage Arbeitsvertrag: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `vorlage-ma-arbeitsblatt-perspektiven-audit` | Vorlage MA Arbeitsblatt Perspektiven Audit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `wirtschaft-wuerfel-zeilenprompts` | Wirtschaft Wuerfel Zeilenprompts: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `zeilenprompts-definieren` | Zeilenprompts Definieren: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
