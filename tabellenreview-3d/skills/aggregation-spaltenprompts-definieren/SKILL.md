...
description: "Aggregation Spaltenprompts Definieren im Plugin Tabellenreview 3D: prüft konkret Risikoampeln für alle geprüften Positionen aggregieren, Spaltenprompts für die drei Prüfperspektiven des, Arbeitsblatt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Aggregation Spaltenprompts Definieren** als zusammenhängenden Arbeitsgang im Plugin Tabellenreview 3D. Im Mittelpunkt steht die Prüfung von Risikoampeln für alle geprüften Positionen aggregieren, Spaltenprompts für die drei Prüfperspektiven des, Arbeitsblatt. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
