...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`vertragsausfueller-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/vertragsausfueller-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`vertragsausfueller-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/vertragsausfueller-unified-mini-prompt.md)
