...
Dieser Skill behandelt **Leistungsgruppen Qualitaetskriterien** als zusammenhängenden Arbeitsgang im Plugin Krankenhausrecht. Im Mittelpunkt steht die Prüfung von Leistungsgruppen und Qualitaetskriterien nach KHVVG, Medizinprodukterecht Betreiberpflichten MDR MPBetreibV, Mindestmengen nach § 136b SGB V und G-BA-Mm-R. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
