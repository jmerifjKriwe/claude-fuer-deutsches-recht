...
description: "Klage Klinikakten Bescheide Klinikverbund im Plugin Krankenhausrecht: prüft konkret Klage gegen Budgetbescheid (Land) oder, zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Klinikakten und, Klinikverbund Fusion Kartell Vergabe Planungsrecht. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Klage Klinikakten Bescheide Klinikverbund** als zusammenhängenden Arbeitsgang im Plugin Krankenhausrecht. Im Mittelpunkt steht die Prüfung von Klage gegen Budgetbescheid (Land) oder, zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Klinikakten und. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
