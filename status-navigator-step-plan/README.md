...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`status-navigator-step-plan-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/status-navigator-step-plan-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`status-navigator-step-plan-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/status-navigator-step-plan-unified-mini-prompt.md)
