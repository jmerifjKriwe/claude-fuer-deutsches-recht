...
description: Pruefraster fuer EU-Sanktionen US-OFAC UK-HMT UN-Sicherheitsrat. EU-Verordnungen zu Russland Belarus Iran Nordkorea Syrien Venezuela Cuba und gelistete Personen Unternehmen. Anwendungsbereich EU-Unionsbuerger und Unternehmen mit Sitz EU. Personenbezogene Sanktionen Asset-Freeze. Sektorale Sanktionen Embargos Importverbote Exportverbote spezielle Dienstleistungen. Pruefung Re-Export Klauseln. Pruefung AWG AWV Bundesausfuhrkontrollamt BAFA. Strafbarkeit § 18 § 19 AWG. Sanctions screening tools Vergleich Konsolidierte EU-Liste OFAC SDN HMT. Sektor-spezifische Restriktionen Oel Gas Finanzen Luxus.
---
...
1. **Geschäftspartner** prüfen gegen Konsolidierte Listen
2. **Ultimate Beneficial Owner** (UBO) prüfen
3. **Indirekte Eigentums-Verhältnisse** ab 50 Prozent prüfen
4. **Listen-Update-Aktualität** sicherstellen
5. **Risikoländer-Bezug**
...
1. **Geschäft sofort stoppen** (Zahlungs-Stopp Logistik-Stopp)
2. **Compliance-Officer** und Geschäftsführer informieren
3. **Anwalt** kontaktieren — Rechtsberatung
4. **Sachverhalts-Aufklärung** intern
...
- Skill `mandat-triage-strafrecht` heranziehen
...
- `sanktions-pruefung-{kunde}.md` strukturiert
- Listen-Screening-Ergebnis dokumentiert
