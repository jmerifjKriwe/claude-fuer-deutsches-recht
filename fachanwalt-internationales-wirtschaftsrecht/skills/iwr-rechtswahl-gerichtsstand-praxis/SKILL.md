...
description: "Rechtswahl und Gerichtsstand in der Praxis: Pruefraster Art. 3 ROM I, Art. 25 EuGVVO, asymmetrische Klauseln, Schiedsklausel statt staatlicher Gerichtsstand. Mustertexte fuer typische Konstellationen B2B und Verbraucher."
---

# IWR: Rechtswahl-Praxis

## Aufgabe
Rechtswahl und Gerichtsstand in der Praxis: Pruefraster Art.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `fachanwalt-internationales-wirtschaftsrecht` zum Thema `iwr-rechtswahl-gerichtsstand-praxis`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Rechtswahl und Gerichtsstand in der Praxis: Pruefraster Art. 3 ROM I, Art. 25 EuGVVO, asymmetrische Klauseln, Schiedsklausel statt staatlicher Gerichtsstand. Mustertexte fuer typische Konstellationen B2B und Verbraucher..
