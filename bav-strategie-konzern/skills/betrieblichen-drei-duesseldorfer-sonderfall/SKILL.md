...
description: "Betrieblichen Drei Duesseldorfer Sonderfall im betriebliche Altersversorgung (bAV): prüft konkret Betrieblichen, Drei, Duesseldorfer. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Betrieblichen Drei Duesseldorfer Sonderfall** als zusammenhängenden Arbeitsgang im betriebliche Altersversorgung (bAV). Im Mittelpunkt steht die Prüfung von Betrieblichen, Drei, Duesseldorfer. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
