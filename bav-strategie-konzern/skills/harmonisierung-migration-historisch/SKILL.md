...
description: "Harmonisierung Migration Historisch im betriebliche Altersversorgung (bAV): prüft konkret bAV-Systeme nach Unternehmensrestrukturierung rechtssicher, Due Diligence historisch gewachsener bAV-Altsysteme im, Datenfluesse bei internationalem bAV-Buyout. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Harmonisierung Migration Historisch** als zusammenhängenden Arbeitsgang im betriebliche Altersversorgung (bAV). Im Mittelpunkt steht die Prüfung von bAV-Systeme nach Unternehmensrestrukturierung rechtssicher, Due Diligence historisch gewachsener bAV-Altsysteme im, Datenfluesse bei internationalem bAV-Buyout. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
