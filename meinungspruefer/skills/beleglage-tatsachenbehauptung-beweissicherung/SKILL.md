...
Dieser Skill behandelt **Beleglage Tatsachenbehauptung Beweissicherung** als zusammenhängenden Arbeitsgang im Plugin Meinungspruefer. Im Mittelpunkt steht die Prüfung von Erstellt eine Belegmatrix für Tatsachenbehauptungen, Verdachtsäußerungen und gem, Erstellt einen Beweissicherungsplan für Screenshots. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
