...
description: "Anschluss Router im Plugin Vertragsrecht: prüft konkret Einstieg, Schnelltriage und Fallrouting im Vertragsrecht-Plugin, Anschluss-Skills Router im Plugin vertragsrecht, Chronologie und Belegmatrix im Plugin vertragsrecht. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Anschluss Router** als zusammenhängenden Arbeitsgang im Plugin Vertragsrecht. Im Mittelpunkt steht die Prüfung von Einstieg, Schnelltriage und Fallrouting im Vertragsrecht-Plugin, Anschluss-Skills Router im Plugin vertragsrecht. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
