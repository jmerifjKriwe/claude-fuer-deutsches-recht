...
| Skill | Beschreibung |
| --- | --- |
| `aenderungs-historie-agb-eskalations-marker` | Aenderungs Historie, Agb Prüfung, Eskalations Marker: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `bgb-business-einzelabrufe-sonderfall` | Bgb Dokumentenmatrix Und Lueckenliste, Business Compliance Dokumentation Und Akte, Einzelabrufe Sonderfall Und Edge Case: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten bela... |
...
| `fernabsatz-lieferanten-red-team` | Fernabsatz Formular Portal Und Einreichung, Lieferanten Tatbestand Beweis Und Belege, Prüfung Red Team Und Qualitaetskontrolle: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächste... |
| `fristennotiz-naechster-vertriebsvertraege` | Anpassen Fristennotiz Und Naechster Schritt, Vertriebsvertraege Fristen Form Und Zustaendigkeit, Lieferantenvertrag Prüfung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten b... |
| `mandat-arbeitsbereich-vr-einfuehrung` | Vertragsrecht Mandat Arbeitsbereich, Vr Einfuehrung Vertragstypen Bgb, Abmahnung Uwg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `nda-pruefungsvorschlaege-saas-msa` | Nda Prüfung, Pruefungsvorschlaege, Saas Msa Prüfung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `rahmenvertrag-beweislast-vertragsrecht-vert` | Rahmenvertrag Beweislast Und Darlegungslast, Vertragsrecht Erstpruefung Und Mandatsziel, Vert Rahmenvertrag Einzelabrufe Spezial: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächs... |
| `renewal-review-routing` | Renewal Schriftsatz Brief Und Memo Bausteine, Review Behörden Gericht Und Registerweg, Routing Zahlen Schwellen Und Berechnung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächste... |
| `saas-tracking-vert` | Saas Risikoampel Und Gegenargumente, Tracking Verhandlung Vergleich Und Eskalation, Vert Mandantenkommunikation Entscheidungsvorlage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den n... |
| `vert-vertragsschluss-vertragspruefung` | Vert Vertragsschluss Bauleiter, Vertragspruefung, Vertragsrecht Anpassen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `vertragsrecht-anschluss-router` | Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix, ...: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `vertragsrecht-dokumente-intake` | Dokumentenintake: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `vertragsrecht-einstieg-routing` | Einstieg und Routing: Einstieg und Routing; klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `vertragsrecht-fristen-risikoampel-mandantenkommunikation` | Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `vertragsrecht-output-waehlen` | Output wählen: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
| `vertragsrecht-quellen-livecheck` | Rechtsquellen-Livecheck: Quellenprüfung; Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `vertragsrecht-rechtsquellen` | Rechtsquellen: Quellenprüfung; Abschlussprodukt und Übergabe: Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `vertragsrecht-unterlagen-luecken` | Unterlagen und Lücken: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `vertragsrecht-vert-agb-kontrolle-leistungsstoerungen-leitfaden` | Vert Agb Kontrolle B2b Spezial / Vert Leistungsstoerungen Leitfaden / Vr Agb Recht Grundzuege: bearbeitet die maßgeblichen Prüffelder, setzt den passenden Prüfpfad und erzeugt den nächsten belastbaren Output. |
...
| `vr-leistungsstoerungen-widerruf-fernabsatz` | Vr Leistungsstoerungen Spezial, Widerruf Fernabsatz: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `widerruf-zusammenfassungen-interessen` | Widerruf Internationaler Bezug Und Schnittstellen, Zusammenfassungen Mehrparteien Konflikt Und Interessen, Stakeholder Zusammenfassung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den... |
