...
description: "rechtsberatungsstelle: Konsolidiertes Skill-Kompendium 15; bündelt 2 frühere Spezialskills (spezial-uebergabe-schriftsatz-brief-und-memo-bausteine, status) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 15 - rechtsberatungsstelle
...
**Frühere Beschreibung:** Uebergabe: Schriftsatz-, Brief- und Memo-Bausteine im Plugin rechtsberatungsstelle; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
**Frühere Beschreibung:** Fallstatuszusammenfassung nach Zielgruppe — mandantengerichtet (verständliche Sprache), intern (für den Supervisor) oder gerichts-/behördengerichtet (formale Schriftsatzform per Verfahrensordnung). Gleiche Fakten, unterschiedliche Darstellung und Tiefe. Lädt, wenn ein Studierender den Mandanten informieren, den Supervisor briefen oder einen gerichtlichen/behördlichen Statusbericht vorbereiten muss.
