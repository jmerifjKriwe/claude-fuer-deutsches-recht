...
description: "Rechtsberatung Uebergabe Schriftsatz Brief Memo Bausteine Status im Plugin Rechtsberatungsstelle: prüft konkret Uebergabe, Fallstatuszusammenfassung nach Zielgruppe —. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Rechtsberatung Uebergabe Schriftsatz Brief Memo Bausteine Status** als zusammenhängenden Arbeitsgang im Plugin Rechtsberatungsstelle. Im Mittelpunkt steht die Prüfung von Uebergabe, Fallstatuszusammenfassung nach Zielgruppe —. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
