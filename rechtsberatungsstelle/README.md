...
| `rbs-einfuehrung-rdg-rbst-anlaufstellen` | Rbs Einfuehrung Themen, Rbs Rdg Grenzen Spezial, Rbst Anlaufstellen Bauleiter: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
