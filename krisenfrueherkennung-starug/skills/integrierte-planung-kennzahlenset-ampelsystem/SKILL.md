...
**Integrierte Planung Kennzahlenset Ampelsystem** ordnet den Fall über die tragenden Prüffelder: Integriertes Drei-Statement-Modell (GuV/Bilanz/Cashflow), StaRUG-konformes KPI-Set und Ampelsystem für, Bauleiter Frueherkennungssystem § 1 StaRUG. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
