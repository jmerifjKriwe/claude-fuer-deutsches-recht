...
| Skill | Beschreibung |
| --- | --- |
| `anrede-anwaltskanzleien-bittet` | Anrede Anwaltskanzleien Bittet: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `dankt-dsgvo-sonderfall-e-mail` | Dankt DSGVO Sonderfall E Mail: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `dringlichkeitsmarker-einwilligung-hinweis` | Dringlichkeitsmarker Einwilligung Hinweis: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `erstantwort-foermlich-mail` | Erstantwort Foermlich Mail: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `folgekorrespondenz-vorbereiten-konfliktcheck` | Folgekorrespondenz Vorbereiten Konfliktcheck: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ma-mandant-manda-erstgespraechsleitfaden` | MA Mandant Manda Erstgespraechsleitfaden: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `manda-mandatsablehnung-rechtsschutz` | Manda Mandatsablehnung Rechtsschutz: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandantenanfragen-anfrage-eingang-anrede` | Anfrage Eingang Anrede: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `mandantenanfragen-assistent-ma-einfuehrung-erstkontakt` | MA Einfuehrung Erstkontakt: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandantenanfragen-assistent-mandantenkommunikation-redteam` | Mandantenkommunikation Redteam: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `mandantenanfragen-assistent-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `mehrsprachige-antwort-muster-erstantwort-spam` | Mehrsprachige Antwort Muster Erstantwort Spam: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `nennt-sachverhalt-telefon` | Nennt Sachverhalt Telefon: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `telefonische-terminvergabe-interessen` | Telefonische Terminvergabe Interessen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `uebernimmt-telefon-konfiguration` | Uebernimmt Telefon Konfiguration: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vertraulichkeit-erinnerung` | Vertraulichkeit Erinnerung: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
