...
description: "Aufsichtsstruktur einfuehrend: EZB-SSM, BaFin, Bundesbank, ESMA. KWG, ZAG, WpIG, WpHG, KAGB, MAR. Welche Behoerde ist wofuer zustaendig, wie kommunizieren wir. Tabellarische Uebersicht und Beispielsachverhalte fuer das Erstgespraech."
---
...
Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `fachanwalt-bank-kapitalmarktrecht` zum Thema `bk-einfuehrung-aufsichtsstruktur`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Aufsichtsstruktur einfuehrend: EZB-SSM, BaFin, Bundesbank, ESMA. KWG, ZAG, WpIG, WpHG, KAGB, MAR. Welche Behoerde ist wofuer zustaendig, wie kommunizieren wir. Tabellarische Uebersicht und Beispielsachverhalte fuer das Erstgespraech..
