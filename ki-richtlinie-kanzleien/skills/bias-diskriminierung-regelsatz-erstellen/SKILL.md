...
description: "Bias Diskriminierung Regelsatz Erstellen im Plugin Ki Richtlinie Kanzleien: prüft konkret Bias und Diskriminierung in KI-Outputs für Kanzleien prüfen, Compliance-Regelsatz Zehn Gebote für KI-Einsatz in, KI-Dienstleister Due Diligence für Kanzleien durchführen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Bias Diskriminierung Regelsatz Erstellen** als zusammenhängenden Arbeitsgang im Plugin Ki Richtlinie Kanzleien. Im Mittelpunkt steht die Prüfung von Bias und Diskriminierung in KI-Outputs für Kanzleien prüfen, Compliance-Regelsatz Zehn Gebote für KI-Einsatz in, KI-Dienstleister Due Diligence für Kanzleien durchführen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
