...
Dieser Skill behandelt **Literatur Quellen Prompting Leitfaden RDG** als zusammenhängenden Arbeitsgang im Plugin Ki Richtlinie Kanzleien. Im Mittelpunkt steht die Prüfung von Pflicht-Literatur und Aktualisierungsliste für, Prompting-Leitfaden für juristische KI-Nutzung in Kanzleien, Prüffeld für rdg pruefung chatbot. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
