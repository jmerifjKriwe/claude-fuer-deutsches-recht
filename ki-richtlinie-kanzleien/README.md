...
| `kirk-leitfaden-prompts-kr-executive` | Kirk Mandantenkommunikation Leitfaden, Kirk Prompts Templates Versionierung Spezial, Kr Richtlinie Executive Summary 1 Pager Template: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den... |
...
| `vo-hochrisiko-kirk-fortbildung-bauleiter` | Ki Vo Hochrisiko Personalwesen, Kirk Fortbildung Pflicht Spezial, Kirk Ki Richtlinie Bauleiter: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
