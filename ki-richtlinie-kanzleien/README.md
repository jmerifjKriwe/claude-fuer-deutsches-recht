...
| Skill | Beschreibung |
| --- | --- |
| `anonymisierung-pseudonymisierung` | Anonymisierung Pseudonymisierung, Automatisierte Entscheidungen Art 22 Dsgvo, Berufsrecht Bausteine: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `anwaelten-berufsrechtskonforme-beruht` | Anwaelten Behörden Gericht Und Registerweg, Berufsrechtskonforme Tatbestand Beweis Und Belege, Beruht Verhandlung Vergleich Und Eskalation: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert... |
| `bias-diskriminierung-regelsatz-erstellen` | Bias Und Diskriminierung Prüfung, Compliance Regelsatz Erstellen, Dienstleister Due Diligence: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `bora-brak-dsgvo` | Bora Zahlen Schwellen Und Berechnung, Brak Internationaler Bezug Und Schnittstellen, Dsgvo Compliance Dokumentation Und Akte: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten... |
...
| `dokumentationspflichten-protokoll-dsgvo` | Dokumentationspflichten Protokoll, Dsgvo Compliance Bausteine, Executive Summary Bausteine: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `geschgehg-halluzinations-handhabung-kanzlei` | Geschgehg Bausteine, Halluzinations Handhabung, Kanzlei Kontext Analyse: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `hinweisen-kanzleien-pflegt` | Hinweisen Formular Portal Und Einreichung, Kanzleien Dokumentenmatrix Und Lueckenliste, Pflegt Erstpruefung Und Mandatsziel: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten b... |
| `kennzeichnungspflichten-veroeffentlichungen` | Kennzeichnungspflichten Veroeffentlichungen, Ki Kompetenz Erwerb Plan, Ki Vo Betreiber Pflichten: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `ki-richtlinie-kanzleien-anschluss-routing` | Anschluss-Routing: Einstieg und Routing; klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `ki-richtlinie-kanzleien-dokumente-intake` | Dokumentenintake: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `ki-richtlinie-kanzleien-einstieg-routing` | Einstieg und Routing: Einstieg und Routing; klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `ki-richtlinie-kanzleien-output-waehlen` | Output wählen: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
| `ki-richtlinie-kanzleien-quellen-livecheck` | Rechtsquellen-Livecheck: Quellenprüfung; Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `ki-richtlinie-kanzleien-start-chronologie-fristen` | Kaltstart, Chronologie, Belegmatrix und Fristenampel, ...: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `ki-richtlinie-kanzleien-unterlagen-luecken` | Unterlagen und Lücken: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `ki-richtlinie-nutzung-mandatsdaten` | Nutzungsrichtlinie Fristen Form Und Zustaendigkeit, Auftragsverarbeitungsvertrag Prüfen, Musterklauseln It Vertrag: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbare... |
| `kirk-leitfaden-kirk-prompts-kr-executive` | Kirk Mandantenkommunikation Leitfaden, Kirk Prompts Templates Versionierung Spezial, Kr Richtlinie Executive Summary 1 Pager Template: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den... |
| `literatur-quellen-prompting-leitfaden-rdg` | Literatur Und Quellen, Prompting Leitfaden, Rdg Prüfung Chatbot: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `rechtsabteilungen-syndikus-verordnung` | Rechtsabteilungen Risikoampel Und Gegenargumente, Syndikus Schriftsatz Brief Und Memo Bausteine, Verordnung Mehrparteien Konflikt Und Interessen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und l... |
...
| `richtlinien-skelett-update-schatten` | Richtlinien Skelett Erzeugen, Richtlinien Update Zyklus, Schatten Ki Aufdeckung: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `transparenz-mandanten-urheberrecht` | Transparenz Mandanten, Urheberrecht Bausteine: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `vo-hochrisiko-kirk-fortbildung-kirk-bauleiter` | Ki Vo Hochrisiko Personalwesen, Kirk Fortbildung Pflicht Spezial, Kirk Ki Richtlinie Bauleiter: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
