...
| Skill | Beschreibung |
| --- | --- |
| `anonymisierung-pseudonymisierung` | Anonymisierung Pseudonymisierung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `anwaelten-berufsrechtskonforme-beruht` | Anwaelten Berufsrechtskonforme Beruht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bias-diskriminierung-regelsatz-erstellen` | Bias Diskriminierung Regelsatz Erstellen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bora-brak-dsgvo` | BORA Brak DSGVO: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `dokumentationspflichten-protokoll-dsgvo` | Dokumentationspflichten Protokoll DSGVO: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `geschgehg-halluzinations-handhabung-kanzlei` | Geschgehg Halluzinations Handhabung Kanzlei: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hinweisen-kanzleien-pflegt` | Hinweisen Kanzleien Pflegt: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kennzeichnungspflichten-veroeffentlichungen` | Kennzeichnungspflichten Veroeffentlichungen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ki-richtlinie-kanzleien-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ki-richtlinie-nutzung-mandatsdaten` | Nutzung Mandatsdaten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kirk-leitfaden-prompts-kr-executive` | Kirk Leitfaden Prompts KR Executive: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `literatur-quellen-prompting-leitfaden-rdg` | Literatur Quellen Prompting Leitfaden RDG: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `rechtsabteilungen-syndikus-verordnung` | Rechtsabteilungen Syndikus Verordnung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `richtlinien-skelett-update-schatten` | Richtlinien Skelett Update Schatten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `transparenz-mandanten-urheberrecht` | Transparenz Mandanten Urheberrecht: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vo-hochrisiko-kirk-fortbildung-bauleiter` | VO Hochrisiko Kirk Fortbildung Bauleiter: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
