...
| `boilerplate-klauseln-definitionen` | Boilerplate Klauseln Katalog, Definitionen Klauseln Stringent: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
