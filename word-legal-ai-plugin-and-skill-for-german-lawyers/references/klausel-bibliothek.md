...
Anwendung: B2B und B2C (je Baustein gekennzeichnet)
...
9. Vertragsstrafe
10. Kuendigung
11. Force Majeure / Hoehere Gewalt
...
20. Schiedsklausel und Mediation
21. Whole Agreement / Vollstaendigkeit
22. Abtretung
23. Compliance / Anti-Korruption
24. Subunternehmer
25. Audit-Recht
...
### 1.1 Praeambel (beides, gruen)

> ### Praeambel
>
> Die Parteien beabsichtigen, [Kurzbeschreibung des Vertragszwecks]. Vor diesem Hintergrund schliessen sie folgenden Vertrag.

**EN:**

> ### Preamble
>
> The parties intend to [short description of contract purpose]. Against this background they enter into the following Agreement.

### 1.2 Erwaegungsgruende (beides, gruen)

> ### Erwaegungen
>
> (A) Die Verkaeuferin ist Eigentuemerin von [Beschreibung des Vertragsgegenstands].
> (B) Die Kaeuferin beabsichtigt den Erwerb zu den nachstehenden Bedingungen.
> (C) Im Hinblick auf das gemeinsame Verstaendnis der Parteien wird folgendes vereinbart.

---

## 2. Definitionen

### 2.1 Definitionsabschnitt (beides, gruen)
...
>
> The terms used in this Agreement with capital initial letters shall have the following meaning:
>
> "Subject Matter" means [definition].
> "Contract Year" means twelve consecutive calendar months starting on the Effective Date.
> "Affiliates" means affiliated companies within the meaning of Sections 15 et seqq. AktG.
> "Business Day" means a day from Monday to Friday that is not a statutory public holiday at the Customer's seat.
> "Written Form" means written form within the meaning of Section 126 BGB; electronic form pursuant to Section 126a BGB is equivalent.

---

## 3. Leistungsbeschreibung

### 3.1 Leistungsbeschreibung mit Spezifikation (B2B, gruen)
...
>
> (2) Der Gesamtaufwand ist auf EUR [...] netto im Vertragsjahr begrenzt. Eine Ueberschreitung bedarf einer schriftlichen Vereinbarung zwischen den Parteien.
>
...
### 6.2 Aufrechnung B2C (B2C, rot bei zu enger Fassung)

> ### § X Aufrechnung
>
> Die Verbraucherin kann gegen Forderungen aus diesem Vertrag aufrechnen, soweit ihre Gegenforderung unbestritten, rechtskraeftig festgestellt oder entscheidungsreif ist.

**Hinweis**: Bei B2C nicht enger fassen als § 309 Nr. 3 BGB erlaubt.

---

## 7. Gewaehrleistung

### 7.1 Werkvertragsgewaehrleistung B2B (B2B, gelb)

> ### § X Gewaehrleistung
>
> (1) Die Auftragnehmerin gewaehrleistet, dass die Leistung der vereinbarten Beschaffenheit entspricht.
>
> (2) Die Gewaehrleistungsfrist betraegt zwoelf Monate ab Abnahme der Leistung. § 634a Abs. 1 Nr. 2 BGB bleibt unberuehrt.
>
> (3) Im Mangelfall hat die Auftragnehmerin nach ihrer Wahl die Moeglichkeit der Nachbesserung oder Neuherstellung. Erst nach zweimaligem erfolglosen Nachbesserungsversuch ist die Auftraggeberin berechtigt, vom Vertrag zurueckzutreten oder Minderung zu verlangen.

### 7.2 Kaufrecht B2C (B2C, gruen)
...
### 8.1 Haftungsbegrenzung B2B (B2B, gelb in AGB)
...
>
> (3) Otherwise, each party shall be liable only for breach of material contractual obligations (cardinal duties), the fulfilment of which is essential for achieving the purpose of this Agreement and on the fulfilment of which the other party may regularly rely; in such case liability shall be limited in amount to the typical and foreseeable damage.
>
> (4) Liability under paragraph 3 is limited to EUR [...] per damage event; aggregate liability per contract year is limited to EUR [...].
>
> (5) Liability for lost profits and indirect damages is excluded within the limitation under paragraphs 3 and 4.
>
> (6) Liability under the German Product Liability Act remains unaffected.

### 8.2 Haftung B2C (B2C, rot bei zu enger Fassung, sonst gelb)
...
### 9.1 Vertragsstrafe Geheimhaltungsverstoss B2B (B2B, gelb in AGB)
...
### 9.2 Vertragsstrafe nach Hamburger Brauch (B2B, gruen)
...
### 10.1 Ordentliche Kuendigung Dauerschuldverhaeltnis (B2B, gruen)

> ### § X Laufzeit, Kuendigung
>
> (1) Der Vertrag wird auf unbestimmte Zeit geschlossen. Er kann von jeder Partei mit einer Frist von drei Monaten zum Ende eines Kalendervierteljahres ordentlich gekuendigt werden.
>
> (2) Die Kuendigung bedarf der Schriftform.

### 10.2 Mindestlaufzeit (B2B, gruen)

> ### § X Mindestlaufzeit
>
> (1) Der Vertrag hat eine Mindestlaufzeit von 24 Monaten ab Vertragsbeginn.
>
> (2) Er verlaengert sich um jeweils zwoelf Monate, wenn er nicht von einer Partei mit einer Frist von drei Monaten zum Ende der jeweiligen Vertragslaufzeit in Schriftform gekuendigt wird.

**Hinweis B2C**: Bei Verbrauchervertraegen § 309 Nr. 9 BGB beachten (max. zwei Jahre Mindestlaufzeit, max. ein Jahr Verlaengerung, max. drei Monate Kuendigungsfrist).

### 10.3 Ausserordentliche Kuendigung aus wichtigem Grund (beides, gruen)

> ### § X Kuendigung aus wichtigem Grund
>
...
### 11.1 Force Majeure Standard (beides, gruen)
...
### 12.1 NDA Vollklausel (B2B, gruen, siehe Skill `geheimhaltung-nda-vertraulichkeit`)
...
### 14.1 Uebertragung Werkergebnis (B2B, gruen, mild)
...
### 14.2 Uebertragung Werkergebnis (B2B, gelb, scharf)
...
### 16.1 Massgebliche Sprache (beides, gruen)
...
**Hinweis**: Vorsicht in AGB — strenge doppelte Schriftformklauseln sind teilweise unwirksam (Individualvereinbarung geht vor). Siehe Skill `schriftform-und-textform-bgb`.

---

## 18. Salvatorische Klausel

### 18.1 Salvatorische Klausel mit Ersetzungsregel (beides, gruen)
...
### 20.1 DIS-Schiedsklausel (B2B, gruen)
...
> ### § X Mediation
>
> (1) Vor Anrufung des Schiedsgerichts oder eines staatlichen Gerichts werden die Parteien versuchen, Streitigkeiten aus diesem Vertrag durch Mediation beizulegen.
>
> (2) Die Mediation wird in deutscher Sprache nach der Mediationsordnung der DIS durchgefuehrt. Wenn die Mediation nicht innerhalb von drei Monaten nach Beginn zu einer Einigung fuehrt, steht es jeder Partei frei, das Schiedsverfahren einzuleiten.

---

## 21. Whole Agreement / Vollstaendigkeit

### 21.1 Whole-Agreement-Klausel (B2B, gruen)

> ### § X Vollstaendigkeit
>
> Dieser Vertrag enthaelt saemtliche Abreden der Parteien zum Vertragsgegenstand. Aeltere muendliche oder schriftliche Abreden zum Vertragsgegenstand werden durch diesen Vertrag aufgehoben und ersetzt.

---

## 22. Abtretung

### 22.1 Abtretungsverbot mit Ausnahme verbundene Unternehmen (B2B, gruen)

> ### § X Abtretung
>
> Die Abtretung von Rechten und Pflichten aus diesem Vertrag bedarf der vorherigen schriftlichen Zustimmung der anderen Partei. Die Zustimmung darf nicht unbillig verweigert werden. Eine Abtretung an verbundene Unternehmen im Sinne der §§ 15 ff. AktG bedarf keiner Zustimmung; die abtretende Partei wird die andere Partei jedoch unverzueglich schriftlich informieren.

---

## 23. Compliance / Anti-Korruption

### 23.1 Compliance B2B (B2B, gruen)

> ### § X Compliance
>
> (1) Die Parteien verpflichten sich, alle anwendbaren gesetzlichen Bestimmungen, insbesondere die Antikorruptionsgesetze, das Geldwaeschegesetz, die Sanktionsbestimmungen und die Vorschriften zum Datenschutz, zur Arbeitssicherheit und zum Umweltschutz, einzuhalten.
>
> (2) Die Parteien werden keinerlei Zuwendungen, weder unmittelbar noch mittelbar, an Mitarbeiter, Berater oder sonstige Vertreter der anderen Partei mit dem Ziel gewaehren, eine unsachliche Beeinflussung von Entscheidungen herbeizufuehren.
>
> (3) Bei begruendetem Verdacht auf einen Compliance-Verstoss informiert die betroffene Partei die andere Partei unverzueglich.

---

## 24. Subunternehmer

### 24.1 Subunternehmer mit Zustimmungsvorbehalt (B2B, gruen)
...
### 25.1 Audit-Recht (B2B, gelb in AGB)
...
- BGB, AktG, GeschGehG, UrhG, DSGVO, BDSG, Produkthaftungsgesetz, ZPO
