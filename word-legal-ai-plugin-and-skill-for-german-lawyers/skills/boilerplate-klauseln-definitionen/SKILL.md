...
**Boilerplate Klauseln Definitionen** ordnet den Fall über die tragenden Prüffelder: Katalog typischer Boilerplate-Klauseln im deutschen, Defined Terms in Vertraegen sauber bauen. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
