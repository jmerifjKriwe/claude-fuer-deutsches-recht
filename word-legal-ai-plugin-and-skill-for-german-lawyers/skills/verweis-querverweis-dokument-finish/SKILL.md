...
description: "Verweis Querverweis Dokument Finish im Word-Legal-AI für Anwälte: prüft konkret Verweis- und Querverweistechnik in juristischen Dokumenten, Finalisiert juristische Word-Dokumente vor Versand, Nummer. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Verweis Querverweis Dokument Finish** als zusammenhängenden Arbeitsgang im Word-Legal-AI für Anwälte. Im Mittelpunkt steht die Prüfung von Verweis- und Querverweistechnik in juristischen Dokumenten, Finalisiert juristische Word-Dokumente vor Versand, Nummer. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
