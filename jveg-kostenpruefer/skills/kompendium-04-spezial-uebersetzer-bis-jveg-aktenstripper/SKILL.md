...
description: "jveg-kostenpruefer: Konsolidiertes Skill-Kompendium 04; bündelt 3 frühere Spezialskills (spezial-uebersetzer-fristennotiz-und-naechster-schritt, jveg-sachverstaendigenrechnung-bauleiter, jveg-aktenstripper) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 04 - jveg-kostenpruefer
...
**Frühere Beschreibung:** Uebersetzer: Fristennotiz und nächster Schritt im Plugin jveg kostenpruefer; schärft Rollen, Belege, Fachnormen, Risiken, Gegenargumente und nächsten verwertbaren Schritt statt austauschbarer Standardprüfung.
...
**Frühere Beschreibung:** Bauleiter Sachverstaendigenrechnung JVEG: Honorargruppen, Zeitaufwand, Auslagen, Mehrwertsteuer. Pruefraster Sachverstaendiger und Kostenfestsetzung.
...
**Frühere Beschreibung:** JVEG-relevante Daten aus Gerichtsakten und Gutachterunterlagen extrahieren: Termine, Stunden, Auslagen. Normen: §§ 2 ff. JVEG. Prüfraster: Terminsprotokoll, Stundennachweis, Belegstruktur. Output: Extrahierter Datensatz für Kostenprüfung. Abgrenzung: nicht Kostenberechnung.
