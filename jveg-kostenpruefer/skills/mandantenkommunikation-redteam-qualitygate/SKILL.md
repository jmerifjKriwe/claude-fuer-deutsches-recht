...
**Mandantenkommunikation Redteam Qualitygate** ordnet den Fall über die tragenden Prüffelder: Mandantenkommunikation im Plugin jveg-kostenpruefer, Red-Team Qualitygate im Plugin jveg-kostenpruefer, Antragsfristen nach JVEG prüfen. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
