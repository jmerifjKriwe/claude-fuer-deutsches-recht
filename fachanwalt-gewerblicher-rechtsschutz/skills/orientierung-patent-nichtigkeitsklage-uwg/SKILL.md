...
Dieser Skill behandelt **Orientierung Patent Nichtigkeitsklage UWG** als zusammenhängenden Arbeitsgang im Plugin Fachanwalt Gewerblicher Rechtsschutz. Im Mittelpunkt steht die Prüfung von Gewerblichen Rechtsschutz-Mandat einordnen und, Patentnichtigkeitsklage beim BPatG vorbereiten oder, Einstweilige Verfuegung im UWG-Verfahren beantragen oder. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
