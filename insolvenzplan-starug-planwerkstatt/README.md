...
| Skill | Beschreibung |
| --- | --- |
| `abstimmung-anlagen-interessen-cram` | Abstimmung Anlagen Interessen Cram: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `down-red-gestaltender-gruppen` | Down RED Gestaltender Gruppen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `inso-starug-planwerkstatt-start-chronologie-fristen` | Inso Starug Planwerkstatt Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-intake-klassen` | Intake Klassen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-starug-ips-abstimmung-mehrheiten-anlagenpaket` | IPS Abstimmung Mehrheiten Anlagenpaket: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-starug-ips-cramdown-obstruktion-datenraum-register` | IPS Cramdown Obstruktion Datenraum Register: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-starug-ips-gerichtliche-schritte-kommandocenter` | IPS Gerichtliche Schritte Kommandocenter: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-starug-ips-minderheitenschutz-planbetroffene` | IPS Minderheitenschutz Planbetroffene: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `insolvenzplan-starug-ips-redteam-qualitygate-sanierungskonzept` | IPS Redteam Qualitygate Sanierungskonzept: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `insolvenzplan-vergleichsrechnung-quote` | Vergleichsrechnung Quote: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
| `ips-gruppen-klassenbildung` | IPS Gruppen Klassenbildung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ips-stabilisierung-stakeholder` | IPS Stabilisierung Stakeholder: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ips-verfahrenswahl-restrukturierungsplan` | IPS Verfahrenswahl Restrukturierungsplan: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ips-vergleichsrechnung-ipsplan-cram` | IPS Vergleichsrechnung Ipsplan Cram: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ipsplan-planstruktur-prepack-plan` | Ipsplan Planstruktur Prepack Plan: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `sanierungskonzept-starug-spezial-teil` | Sanierungskonzept Starug Spezial Teil: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
