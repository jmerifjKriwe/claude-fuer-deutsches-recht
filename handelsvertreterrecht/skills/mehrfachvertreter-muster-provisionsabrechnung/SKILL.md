...
Dieser Skill behandelt **Mehrfachvertreter Muster Provisionsabrechnung** als zusammenhängenden Arbeitsgang im Handelsvertreterrecht. Im Mittelpunkt steht die Prüfung von Analysiert die Rechtsstellung des Mehrfachvertreters nach §, Erstellt Musterprovisonionsabrechnungen für, Analysiert den Verkauf einer Handelsvertretungsagentur und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
