...
Dieser Skill behandelt **Ausgleich MA Deal Ausgleichsanmeldung** als zusammenhängenden Arbeitsgang im Handelsvertreterrecht. Im Mittelpunkt steht die Prüfung von Berechnet den Ausgleichsanspruch nach § 89b HGB, Analysiert Ausgleichsansprüche bei M&A-Transaktionen, Unterstützt bei fristgerechter Anmeldung des und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
