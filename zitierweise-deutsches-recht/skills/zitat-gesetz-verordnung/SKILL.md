...
description: "Gesetz/Verordnung zitieren: Norm-Bezeichnung, ggf. § und Absatz. Beispiel § 17 InsO, § 311 Abs. 2 BGB, Art. 26 DSGVO. Bei zeitlicher Bezugnahme: § X i. d. F. v. JJJJ."
---

# Gesetz/Verordnung zitieren

## Aufgabe
Gesetz/Verordnung zitieren: Norm-Bezeichnung, ggf.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `zitierweise-deutsches-recht` zum Thema `zitat-gesetz-verordnung`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Gesetz/Verordnung zitieren: Norm-Bezeichnung, ggf. § und Absatz. Beispiel § 17 InsO, § 311 Abs. 2 BGB, Art. 26 DSGVO. Bei zeitlicher Bezugnahme: § X i. d. F. v. JJJJ..
