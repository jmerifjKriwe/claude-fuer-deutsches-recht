...
## Aufgabe
Streitstand in Memo/Schriftsatz darstellen: h.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `zitierweise-deutsches-recht` zum Thema `zitat-streitstand-darstellen`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Streitstand in Memo/Schriftsatz darstellen: h. M. (Rechtsprechung BGH + ueberwiegende Literatur), Gegenmeinung (Verfasser + Stellenangabe), eigene Loesung. Format mit klarer Position..
