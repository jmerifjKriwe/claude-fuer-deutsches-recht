...
## Aufgabe
Leitsatz-Entscheidung mit Leitsatz zitieren: BGH, Urt.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `zitierweise-deutsches-recht` zum Thema `zitat-leitsatzentscheidung`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Leitsatz-Entscheidung mit Leitsatz zitieren: BGH, Urt. ..., Leitsatz 1 lautet: ... Original-Leitsatz im Wortlaut, dann Begruendung mit Rn. Format fuer Schriftsatz und Memo..
