...
Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `zitierweise-deutsches-recht` zum Thema `zitat-rechtsprechung-ohne-fundstelle`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Rechtsprechung ohne offizielle Fundstelle: nur juris- oder BeckRS-Eintrag. Loesungen: dejure.org-Permalink, Gericht/Datum/Aktenzeichen + 'juris', alternativ BeckRS-Eintrag mit klarer Angabe. Vermeiden: 'BeckRS allein' fuer wichtige Argumente..
