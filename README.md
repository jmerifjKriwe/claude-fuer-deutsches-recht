...
|---|---|
| **Plugins** | 100 |
| **Skills (SKILL.md)** | 2278 — [Gesamtuebersicht](./SKILLS.md) |
| **Testakten** | 49 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Letzter Release** | `v18.0.0` — [latest auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
