...
|---|---|
| **Plugins** | 209 |
| **Skills (SKILL.md)** | 9102 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 201 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Plugin-Version / Arbeitsstand** | `v209.0.0` — [latest Release auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
