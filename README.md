...
|---|---|
| **Plugins** | 108 |
| **Skills (SKILL.md)** | 2656 — [Gesamtübersicht](./SKILLS.md) |
| **Testakten** | 63 |
| **Fachanwalts-/-anwältinnen-Profile** | 24 |
| **Letzter Release** | `v50.8.0` — [latest auf GitHub](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest) |
