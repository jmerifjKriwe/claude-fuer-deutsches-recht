...
description: "Review Sonderfall Source RED im Plugin Gewerblicher Rechtsschutz: prüft konkret Tatbestand, Beweis und Belegaufbau im gewerblichen Rechtsschutz, Sonderfälle und Edge Cases im gewerblichen Rechtsschutz, Red-Team und Qualitätskontrolle im gewerblichen Rechtsschutz. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Review Sonderfall Source RED** als zusammenhängenden Arbeitsgang im Plugin Gewerblicher Rechtsschutz. Im Mittelpunkt steht die Prüfung von Tatbestand, Beweis und Belegaufbau im gewerblichen Rechtsschutz, Sonderfälle und Edge Cases im gewerblichen Rechtsschutz. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
...
- Rolle und Ziel im Gewerblicher Rechtsschutz klären: Welche Partei vertritt der Mandant, welcher Ergebnistyp ist gefragt (Schriftsatz, Bescheidprüfung, Vertragsentwurf, Eilantrag, Stellungnahme)? Welches der oben gelisteten Prüffelder trägt die Akte wirklich?
