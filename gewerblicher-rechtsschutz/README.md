...
| Skill | Beschreibung |
| --- | --- |
| `abmahnung-urheberrecht-erfindungsmeldung` | Nutze dies, wenn Abmahnung Urheberrecht, Erfindungsmeldung Aufnahme, Evvollzug Neu 002 Urteilsverfuegung Beschlussverfuegung Und Zust im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Abmahnung Urheberre... |
| `allgemein-workflow-chronologie-fristen` | Nutze dies, wenn Allgemein, Workflow Chronologie Und Belegmatrix, Workflow Fristen Und Risikoampel im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Allgemein, Workflow Chronologie Und Belegmatrix, Workf... |
| `anmeldung-spezial-compliance-euipo` | Nutze dies, wenn Spezial Anmeldung Behörden Gericht Und Registerweg, Spezial Compliance Mandantenkommunikation Entscheidungsvorlage, Spezial Euipo Dokumentenmatrix Und Lueckenliste im Plugin Gewerblicher Rechtsschutz konkret bearbeitet w... |
| `anschluss-routing` | Nutze dies, wenn Anschluss-Routing im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Gewerblicher Rechtsschutz.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Gewerblicher Rechtsschutz.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill pas... |
| `evvollzug` | Nutze dies, wenn Workflow Mandantenkommunikation, Workflow Redteam Qualitygate, Evvollzug Neu 001 Einstweilige Verfuegung Vollziehung Frist Und im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Was kann hier s... |
| `evvollzug-auslandszustellung-ev-abmahnung` | Nutze dies, wenn Evvollzug Neu 006 Auslandszustellung Ev Und Uebersetzung, Evvollzug Neu 007 Abmahnung Abschlussschreiben Und Hauptsache, Evvollzug Neu 008 Schutzschrift Register Und Forumstrategie im Plugin Gewerblicher Rechtsschutz kon... |
| `evvollzug-zustellung-durch-bea-einstweiliger` | Nutze dies, wenn Evvollzug Neu 003 Zustellung Durch Gerichtsvollzieher Im Ip Verf, Evvollzug Neu 004 Bea Zustellung Einstweiliger Rechtsschutz Risi, Evvollzug Neu 005 Ordnungsmittelantrag Vollstreckung Unterlassun im Plugin Gewerblicher... |
| `freedom-gewerblicher-markenrecherche` | Nutze dies, wenn Spezial Freedom Schriftsatz Brief Und Memo Bausteine, Spezial Gewerblicher Erstpruefung Und Mandatsziel, Spezial Markenrecherche Risikoampel Und Gegenargumente im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werde... |
| `fto-triage-gewerblicher-rechtsschutz-mandat` | Nutze dies, wenn Fto Triage, Gewerblicher Rechtsschutz Anpassen, Gewerblicher Rechtsschutz Mandat Arbeitsbereich im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Fto Triage, Gewerblicher Rechtsschutz An... |
...
| `gewr-einstweilige-dpma-spezial-fristen` | Nutze dies, wenn Gewr Einstweilige Verfuegung Eilverfahren Spezial, Spezial Dpma Fristen Form Und Zustaendigkeit, Spezial Fristen Abschlussprodukt Und Übergabe im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser:... |
| `gewr-geschaeftsgeheimnisgesetz` | Nutze dies, wenn Gewr Geschaeftsgeheimnisgesetz Spezial, Gewr Markenanmeldung Bauleiter, Gewr Uwg Abmahnung Checkliste im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Gewr Geschaeftsgeheimnisgesetz Spe... |
| `gw-einfuehrung-gw-einstweilige-mandat-triage` | Nutze dies, wenn Gw Einfuehrung Rechtsschutzwege, Gw Einstweilige Verfuegung Spezial, Mandat Triage Gewerblicher Rechtsschutz im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Gw Einfuehrung Rechtsschutz... |
| `markenanmeldung-dpma-markenrecherche-open` | Nutze dies, wenn Markenanmeldung Dpma, Markenrecherche, Open Source Prüfung im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Markenanmeldung Dpma, Markenrecherche, Open Source Prüfung prüfen.; Erstelle... |
| `open-operate-reaktion` | Nutze dies, wenn Spezial Open Formular Portal Und Einreichung, Spezial Operate Verhandlung Vergleich Und Eskalation, Spezial Reaktion Internationaler Bezug Und Schnittstellen im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden... |
| `output-waehlen` | Nutze dies, wenn Output wählen im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Output wählen prüfen.; Erstelle eine Arbeitsfassung zu Output wählen.; Welche Normen und Nachweise brauche ich?. |
| `patentscreening-quellenkarte` | Nutze dies, wenn Patentscreening Quellenkarte im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `quellen-livecheck` | Nutze dies, wenn Rechtsquellen-Livecheck im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `rechtsschutz-review-sonderfall-source-red` | Nutze dies, wenn Spezial Rechtsschutz Tatbestand Beweis Und Belege, Spezial Review Sonderfall Und Edge Case, Spezial Source Red Team Und Qualitaetskontrolle im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Wa... |
| `schutzrechts-fristennotiz-ip-klausel` | Nutze dies, wenn Spezial Schutzrechts Fristennotiz Und Naechster Schritt, Ip Klausel Prüfung, Spezial Klausel Beweislast Und Darlegungslast im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Spezial Schut... |
| `schutzrechts-portfolio-schutzschrift` | Nutze dies, wenn Schutzrechts Portfolio, Schutzschrift Eilverfuegung, Spezial Abmahnung Compliance Dokumentation Und Akte im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Schutzrechts Portfolio, Schutzs... |
| `takedown-anweisung-unterlassungsverlangen` | Nutze dies, wenn Takedown Anweisung, Unterlassungsverlangen, Verletzungs Triage im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Takedown Anweisung, Unterlassungsverlangen, Verletzungs Triage prüfen.; E... |
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `urheberrechts-versand-interessen-streitwert` | Nutze dies, wenn Spezial Urheberrechts Zahlen Schwellen Und Berechnung, Spezial Versand Mehrparteien Konflikt Und Interessen, Streitwert Igr Berechnen im Plugin Gewerblicher Rechtsschutz konkret bearbeitet werden soll. Auslöser: Bitte Sp... |
