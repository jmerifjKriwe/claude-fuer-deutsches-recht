...
description: "agb-recht-pruefer: Konsolidiertes Skill-Kompendium 19; bündelt 10 frühere Spezialskills (reisebedingungen, reseller-agb, risk-acceptance-memo, rollout-mail-bestandskunden, rollout-monitoring-agb und 5 weitere) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 19 - agb-recht-pruefer
...
**Frühere Beschreibung:** Branchen-Spezialskill für Reisebedingungen: prüft typische AGB-Risiken des Vertragstyps und erzeugt Klauselarchitektur, Red Flags und bessere Bedingungen.
...
**Frühere Beschreibung:** Branchen-Spezialskill für Reseller AGB: prüft typische AGB-Risiken des Vertragstyps und erzeugt Klauselarchitektur, Red Flags und bessere Bedingungen.
...
**Frühere Beschreibung:** Output- und Streit-Skill für Risk Acceptance Memo: macht aus der AGB-Prüfung verwertbare Redlines, Entwürfe, Playbooks, Abmahnreaktionen oder Entscheidungsunterlagen.
...
**Frühere Beschreibung:** Output- und Streit-Skill für Rollout Mail Bestandskunden: macht aus der AGB-Prüfung verwertbare Redlines, Entwürfe, Playbooks, Abmahnreaktionen oder Entscheidungsunterlagen.
...
**Frühere Beschreibung:** Einstiegs- und Workflow-Skill für Rollout Monitoring AGB: sortiert Ziel, Rolle, Dokumente, Normenstand, AGB-Risiko und nächsten Output schnell und anfängertauglich.
...
**Frühere Beschreibung:** Klausel-Spezialskill für Rügeobliegenheit: prüft, redlined und entwirft die Klausel mit Risikoampel, Verbraucher-/B2B-Unterscheidung und praxistauglicher Ersatzfassung.
...
**Frühere Beschreibung:** Branchen-Spezialskill für SaaS AGB: prüft typische AGB-Risiken des Vertragstyps und erzeugt Klauselarchitektur, Red Flags und bessere Bedingungen.
...
**Frühere Beschreibung:** Klausel-Spezialskill für Schiedsgericht: prüft, redlined und entwirft die Klausel mit Risikoampel, Verbraucher-/B2B-Unterscheidung und praxistauglicher Ersatzfassung.
...
## 9. `schriftform-textform`

**Frühere Beschreibung:** Klausel-Spezialskill für Schriftform Textform: prüft, redlined und entwirft die Klausel mit Risikoampel, Verbraucher-/B2B-Unterscheidung und praxistauglicher Ersatzfassung.
...
**Frühere Beschreibung:** Klausel-Spezialskill für Security Incidents: prüft, redlined und entwirft die Klausel mit Risikoampel, Verbraucher-/B2B-Unterscheidung und praxistauglicher Ersatzfassung.
