...
| `abtretung-adversarial-test` | Abtretung, Adversarial Test Agb, Aenderungsvorbehalt 308, Agb Arbeitnehmerueberlassung Aueg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `agb-leasingvertrag-fortwirkung-schiedsklausel` | Agb Im Leasingvertrag Fortwirkung, Agb Schiedsklausel Opt Out Deutsches Recht, Agb Vertragsstrafe 309 Nr 6, Ergaenzende Vertragsauslegung Bei Agb Luecken: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundl... |
...
| `agb-recht-pruefer-kaltstart-triage` | Einstiegs- und Arbeitsmodul für Allgemein: sortiert Ziel, Rolle, Dokumente, Normenstand, AGB-Risiko und nächsten Output schnell und anfängertauglich. |
| `agb-recht-verbraucherfreundliche-fassung-verbraucherschutz` | Verbraucherfreundliche Fassung / Verbraucherschutz Schnellcheck / Vereinsbedingungen / Verfuegbarkeit Wartungsfenster / 1 weitere Module: führt durch diese fachlich verbundenen Arbeitsmodule, wählt den passenden Prüfpfad und erzeugt den... |
| `agb-recht-vergaberechtliche-vertragsbedingungen-vertragsstrafe` | Vergaberechtliche Vertragsbedingungen / Vertragsstrafe / Vertraulichkeit Klausel / Agb Vereinsausschluss Haftung / 1 weitere Module: führt durch diese fachlich verbundenen Arbeitsmodule, wählt den passenden Prüfpfad und erzeugt den nächs... |
...
| `arbeitsrecht-agb-architekten-ingenieur` | Arbeitsrecht Agb 310 Abs4, Architekten Ingenieur Agb, Auditrechte, Aufrechnung Zurueckbehaltung 309: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `avv-agb-b2b-harte-b2c-b2b2c-backup` | Avv Und Agb Schnittstelle, B2b Harte Fassung, B2c B2b B2b2c Rollencheck, Backup Datenverlust: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `bankvertrag-sparkassen-bauvertrag-vob` | Agb Im Bankvertrag Sparkassen Und Banken, Agb Im Bauvertrag Vob B 2024: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `battle-forms-bau-vob-beweislast-zugang` | Battle Of Forms Agb Kollision, Bau Vob Agb, Beweislast Und Zugang 309, Bewertung Rezensionen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `begriff-vorformuliert-digitalen-produkten-iso` | Agb Begriff Vorformuliert 305, Agb Bei Digitalen Produkten 327f Update, Agb Bei Iso Vertraegen International, Agb Bei Kreditvertraegen Verbraucherdarlehen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrund... |
...
| `blue-pencil-board-agb-bonitaetspruefung-bonus` | Blue Pencil Und Geltungserhaltende Reduktion, Board Brief Agb, Bonitaetspruefung, Bonus Rabatt: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `change-request-clickwrap-beweisakte-cloud` | Change Request, Clickwrap Beweisakte, Cloud Hosting Agb, Consulting Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `crypto-exchange-darlehen-finanzierung` | Crypto Exchange Agb, Darlehen Finanzierung Agb, Datenexport Portabilitaet, Datenschutzverweise Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `deutsch-englisch-digitale-inhalte-handbuch` | Deutsch Englisch Agb, Digitale Inhalte Services, Dokumentation Handbuch, Dokumentenfamilie Rangfolge: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `eigentumsvorbehalt-einbeziehung-hinweis` | Eigentumsvorbehalt, Einbeziehung Hinweis Kenntnisnahme 305, Einbeziehung Online Clickwrap Browsewrap, Einkaufsbedingungen B2b: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten... |
...
| `energieversorgung-agb-entgelt-nebenkosten` | Energieversorgung Agb, Entgelt Nebenkosten Service Fees, Exklusivitaet, Factoring Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `fitnessstudio-agb-force-majeure-formvorgaben` | Fitnessstudio Agb, Force Majeure Hoehere Gewalt, Formvorgaben Anzeigen Erklaerungen 309, Forschung Entwicklung Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbare... |
...
| `formulararbeitsvertrag-haendlervertrag-agb` | Formulararbeitsvertrag, Haendlervertrag Agb, Inhaltskontrolle 307 Generalklausel, Klausel Checkliste Self Service: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
...
| `franchise-agb-gaming-garantie-beschaffenheit` | Franchise Agb, Gaming Agb, Garantie Beschaffenheit, Gerichtsstand: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `gesetzliches-leitbild-gewahrleistung` | Gesetzliches Leitbild Abweichung 307, Gewahrleistung Ausschluss, Gewerbemiete Agb, Handelsvertreter Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `haftung-sanktionen-grobe-fahrlaessigkeit` | Compliance Sanktionen, Haftung Grobe Fahrlaessigkeit Vorsatz, Haftung Indirekte Schaeden, Haftung Leben Koerper Gesundheit 309: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächste... |
...
| `individualabrede-305b-individualklage` | Individualabrede 305b, Individualklage Verteidigung, Insolvenzverkauf Agb, Ip Nutzungsrechte: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `ipr-art-versionierung-aenderungshistorie` | Agb Und Ipr Art 6 Rom I Verbraucher, Agb Versionierung Aenderungshistorie, Agb Werkleistung Vob B Aktuell, Agentur Marketing Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächs... |
...
| `ki-service-kollisionsrecht-ipr-konto` | Ki Service Agb, Kollisionsrecht Ipr Agb, Konto Kündigung Sperre, Kündigung Aus Wichtigem Grund: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `klausel-entwerfen-low-risk-klauselbibliothek` | Klausel Entwerfen Balanced, Klausel Entwerfen Low Risk, Klauselbibliothek Aufbau, Klauselinventar Und Scope: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `klauselverbote-systematik` | Klauselverbote 308 Systematik, Klauselverbote 309 Systematik, Konzernklausel, Msa Rahmenvertrag: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `kurzfristige-preiserhoehung-lieferfrist` | Kurzfristige Preiserhoehung 309, Lieferfrist Teillieferung, Agb Anwaltsvertrag Und Allg Mandatsbedingungen, Agb Im Arbeitsvertrag 310 Abs 4 Vertieft: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage u... |
| `lagerbedingungen-laufzeit-verlaengerung` | Lagerbedingungen, Laufzeit Verlaengerung 309, Leasing Agb, Leistungsaenderung Produktupdate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `logistik-spedition-maengelrechte` | Logistik Spedition Agb, Maengelrechte 309, Mahngebuehren Und Zinsanpassung Agb, Mandanteninterview Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `marketplace-agb-mediation-escalation` | Marketplace Agb, Mediation Escalation, Medizinische Leistungen Agb, Mehrdeutigkeit 305c2: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `massenschaden-datenmodell-rechtsabteilung` | Massenschaden Datenmodell, Rechtsabteilung Haftungsdeckel Für Daten Und Ki Schaeden, Schadenspauschale 309, Abmahnung Reagieren: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächst... |
...
| `mindestabnahme-mitwirkungspflichten` | Mindestabnahme, Mitwirkungspflichten, Nacherfuellung Vorrang, Nda Standardbedingungen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `non-solicitation-norm-live-open-source` | Non Solicitation, Norm Live Check Gesetze Im Internet, Open Source Komponenten, Parking Mobility Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `plattform-online-gate-rollout-rangfolge` | Plattform Und Online Checkout, Quality Gate Vor Rollout, Rangfolge Sprache, Rechtsabteilung Preisanpassung Bei Dauervertraegen Nach Energiek: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefe... |
...
| `plattformnutzung-app-vereinen-verbaenden` | Agb Bei Plattformnutzung App Stores, Agb Bei Vereinen Und Verbaenden: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `product-counsel-feedback-rechte-annahmefrist` | Product Counsel Workflow, Feedback Rechte, Annahmefrist Leistungsfrist 308, Kuendigungsfiktion Und Nachfrist 308: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
...
| `rechtsabteilung-change-vertragsstrafe` | Rechtsabteilung Change Control Klauseln Im Konzernvertrag, Rechtsabteilung Vertragsstrafe In Einheitspreis Und Liefervertra, Salvatorische Klausel, Salvatorische Klausel Grenzen Rspr: wählt den konkreten Prüfpfad, trennt Frist, Zuständig... |
...
| `rechtsfolge-kein-rechtsfolgen-rueckabwicklung` | Rechtsfolge 306 Kein Blue Pencil, Rechtsfolgen Rueckabwicklung Agb, Rechtswahl, Redline Kommentar Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `rechtswahl-schweizer-risikoklassifizierung` | Agb Rechtswahl Schweizer Recht Rom I, Agb Risikoklassifizierung Ampel, Agb Transparenzgebot 307 Abs 1 Satz 2, Agb Und 242 Bgb Eingriffsnorm: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefer... |
...
| `reisebedingungen-reseller-agb-risk-acceptance` | Reisebedingungen, Reseller Agb, Risk Acceptance Memo, Rollout Mail Bestandskunden: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `ruegeobliegenheit-saas-agb-schiedsgericht` | Ruegeobliegenheit, Saas Agb, Schiedsgericht, Schriftform Textform: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `sicherungsrechte-sla-service-social-media` | Sicherungsrechte, Sla Service Credits, Social Media Agb, Softwarelizenz Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `steuern-umsatzsteuer-stummer-upload` | Steuern Umsatzsteuer, Stummer Upload Agb Dokumente, Subscription Abonnement, Subscription Box Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `support-response-telekommunikation-agb` | Support Response Times, Telekommunikation Agb, Transparenzgebot 307, Uklag Unterlassung Verbandsklage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `unternehmerverkehr-abs1-schnellcheck-user` | Unternehmerverkehr 310 Abs1, Unternehmerverkehr Schnellcheck, User Content Moderation, Vdug Abhilfeklage Agb Schnittstelle: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten be... |
...
| `verjaehrungsverkuerzung-verkaufsbedingungen` | Verjaehrungsverkuerzung, Verkaufsbedingungen B2b, Versicherung Avb, Versionsdiff Agb: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `versicherungsvertraegen-vvg-agb` | Agb Bei Versicherungsvertraegen Vvg, Agb Im Konzernverbund, Agb Im Mietrecht Wohnraum Vs Gewerbe, Agb In Kapitalanlagen Effektenhandel: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den... |
...
| `vorkasse-abschlag-wartung-maintenance-website` | Vorkasse Abschlag Sicherheit, Wartung Maintenance, Website Update Check, Wesentliche Rechte Pflichten 307: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `wohnraummiete-agb-zahlungsdienste` | Wohnraummiete Agb, Zahlungsdienste Agb, Zahlungsmittel Chargeback, Zahlungsverzug Mahnkosten: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
