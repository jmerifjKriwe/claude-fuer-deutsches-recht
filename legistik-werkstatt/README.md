...
| `goldplating-vermeiden-inkrafttreten` | Goldplating Vermeiden Inkrafttreten: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `laender-landtage-legistik-ministerien` | Laender Landtage Legistik Ministerien: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legistik-werkstatt-folgenabschaetzung-erfuellungsaufwand` | Folgenabschaetzung Erfuellungsaufwand: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legistik-werkstatt-verfassungsmaessigkeit-quercheck` | Verfassungsmaessigkeit Quercheck: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-aa-eu-bmi-verwaltungsverfahren` | Legw AA EU BMI Verwaltungsverfahren: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-aa-konsular-bmas-arbeitsrecht` | Legw AA Konsular Bmas Arbeitsrecht: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmas-teilhabe-bmbfsfj-familien` | Legw Bmas Teilhabe Bmbfsfj Familien: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmds-it-ki-verordnung` | Legw Bmds IT KI Verordnung: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmftr-kuenstliche-raumfahrt` | Legw Bmftr Kuenstliche Raumfahrt: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmi-bevoelkerungsschutz-oeffentlicher` | Legw BMI Bevoelkerungsschutz Oeffentlicher: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmleh` | Legw Bmleh: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `legw-bmleh-agrar-forst-jagdrecht` | Legw Bmleh Agrar Forst Jagdrecht: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmukn-wasser-bmv-luft-mobilitaets` | Legw Bmukn Wasser BMV Luft Mobilitaets: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmvg-reservisten` | Legw Bmvg Reservisten: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmwsb-bau-bauproduktenrecht-technische` | Legw Bmwsb BAU Bauproduktenrecht Technische: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-bmz-menschenrechte-multilaterale` | Legw BMZ Menschenrechte Multilaterale: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-gesetzesentwurf-kabinett-aa-voelkerrecht` | Legw Gesetzesentwurf Kabinett AA Voelkerrecht: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-ressort-bmds-bmftr-bmg-bmi-bmjv-bmv` | Legw Ressort Bmds Bmftr BMG BMI Bmjv BMV: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-ressort-bmvg-bmwe-bmwsb-bmz` | Legw Ressort Bmvg Bmwe Bmwsb BMZ: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-ressort-verbaendeanhoerung` | Legw Ressort Verbaendeanhoerung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-ressortaufgaben-bmds-bmf-bmftr-bmg-bmi` | Legw Ressortaufgaben Bmds BMF Bmftr BMG BMI: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-ressortaufgaben-bmv-bmvg-bmwe-bmwsb-bmz` | Legw Ressortaufgaben BMV Bmvg Bmwe Bmwsb BMZ: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `legw-rmap-evaluierung-export` | Legw Rmap Evaluierung Export: bündelt 8 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `normenkartierung-normenkontrollrat-kmu` | Normenkartierung Normenkontrollrat KMU: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `referenten-vorlagen-interessen-synopse` | Referenten Vorlagen Interessen Synopse: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `schulung-legistik-aenderungs-fraktionen` | Schulung Legistik Aenderungs Fraktionen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
