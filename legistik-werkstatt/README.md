...
| `legistik-werkstatt-folgenabschaetzung-erfuellungsaufwand` | Folgenabschaetzung Erfuellungsaufwand / Folgenabschaetzung Nachhaltigkeit / Formulierungshilfe Bauen / Gesetzgebungskompetenz Pruefen: bearbeitet die maßgeblichen Prüffelder, setzt den passenden Prüfpfad und erzeugt den nächsten belastba... |
...
| `legistik-werkstatt-verfassungsmaessigkeit-quercheck` | Verfassungsmaessigkeit Quercheck / Verordnungsermaechtigung Art80 / Xml Paralleldarstellung / Zirkelschluss Pruefen: bearbeitet die maßgeblichen Prüffelder, setzt den passenden Prüfpfad und erzeugt den nächsten belastbaren Output. |
