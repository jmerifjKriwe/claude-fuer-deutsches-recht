...
Dieser Skill behandelt **Normenkartierung Normenkontrollrat KMU** als zusammenhängenden Arbeitsgang im Legistik (Gesetzgebungstechnik). Im Mittelpunkt steht die Prüfung von Alle durch ein legistisches Vorhaben beruehrten Normen, Vorlage an Nationalen Normenkontrollrat NKR vorbereiten und, Richtige Startbahn und Normebene für ein legistisches und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
