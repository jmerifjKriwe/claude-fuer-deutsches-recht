...
| Vorhabenart | Zuständigkeit im BMZ | Vorlageweg |
|---|---|---|
...
- **Mitzeichnende Ressorts** typisch für BMZ-Vorhaben: BMI (Verwaltung), BMF
...
Nachgeordnete Behörden des BMZ im Vollzug einbinden. Vollzugsfolgen pruefen.
