...
description: "Taetigkeit Fristennotiz Agentische Datenbank im Plugin Patentrecherche: prüft konkret Taetigkeit, Agentische Patentdatenbank-Recherche, EPO-Einspruch (Opposition) Strategie. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Taetigkeit Fristennotiz Agentische Datenbank** als zusammenhängenden Arbeitsgang im Plugin Patentrecherche. Im Mittelpunkt steht die Prüfung von Taetigkeit, Agentische Patentdatenbank-Recherche, EPO-Einspruch (Opposition) Strategie. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
