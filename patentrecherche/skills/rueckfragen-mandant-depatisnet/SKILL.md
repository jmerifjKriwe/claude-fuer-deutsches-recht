...
description: "Rueckfragen Mandant Depatisnet im Plugin Patentrecherche: prüft konkret Prüft Rechtsstand eines Patents oder einer Anmeldung im, Generiert Rückfragen an den Mandanten wenn das vorgelegte, Depatisnet. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Rueckfragen Mandant Depatisnet** als zusammenhängenden Arbeitsgang im Plugin Patentrecherche. Im Mittelpunkt steht die Prüfung von Prüft Rechtsstand eines Patents oder einer Anmeldung im, Generiert Rückfragen an den Mandanten wenn das vorgelegte, Depatisnet. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
