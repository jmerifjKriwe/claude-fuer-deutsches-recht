...
| Skill | Beschreibung |
| --- | --- |
| `asset-freeze-atlas-ausfuhranmeldung-audit` | Asset Freeze Atlas Ausfuhranmeldung Audit: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-aml-kyc-finanzsanktionen` | AML KYC Finanzsanktionen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-bafa-genehmigungen-cbam-co2` | Bafa Genehmigungen Cbam CO2: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-chemikalien-reach-cites` | Chemikalien Reach Cites: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-embargo-iran-myanmar` | Embargo Iran Myanmar: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-embargo-syrien-endverwendung` | Embargo Syrien Endverwendung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-ersatzteile-dual-exporteur` | Ersatzteile Dual Exporteur: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-financial-institutions` | Financial Institutions: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-kontingente-lizenzen` | Kontingente Lizenzen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-presse-krise` | Presse Krise: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-sanktionsumgehung-red-zoll` | Sanktionsumgehung RED Zoll: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-versandverfahren-ncts` | Versandverfahren Ncts: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aussenwirtschaft-zoll-allgemeingenehmigung-agg-antidumping` | Allgemeingenehmigung AGG Antidumping: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `awv-beteiligungsmeldungen` | AWV Beteiligungsmeldungen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bafa-nullbescheid-catch-all-cbam` | Bafa Nullbescheid Catch ALL Cbam: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `incoterms-exportkontrolle-internal` | Incoterms Exportkontrolle Internal: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `legal-hold-lieferanten-onboarding` | Legal Hold Lieferanten Onboarding: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `nichtpraeferenzieller-ursprung-ofac-sdn-post` | Nichtpraeferenzieller Ursprung Ofac SDN Post: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `passive-veredelung-rueckwaren-erlass` | Passive Veredelung Rueckwaren Erlass: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `sammelgenehmigung-export-schulung` | Sammelgenehmigung Export Schulung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `software-verschluesselung-swiss-sanctions` | Software Verschluesselung Swiss Sanctions: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `uk-sanctions-us-ear-voruebergehende` | UK Sanctions US EAR Voruebergehende: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vzta-antrag-warennummer-hs-wto-handelspolitik` | Vzta Antrag Warennummer HS WTO Handelspolitik: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zolllager-freilager-aussenwirtschaft` | Zolllager Freilager Aussenwirtschaft: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zolltarif-vzta-zollwert-royalties-ursprung` | Zolltarif Vzta Zollwert Royalties Ursprung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
