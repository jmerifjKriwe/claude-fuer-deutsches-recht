...
**Zolltarif Vzta Zollwert Royalties Ursprung** ordnet den Fall über die tragenden Prüffelder: Zolltarifrecht und verbindliche Zolltarifauskuenfte (vZTA), Zollwerterhöhungen durch Lizenzgebuehren (Royalties) und, Zusammenhang von Zollwert und Ursprung bei der Einfuhr. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
