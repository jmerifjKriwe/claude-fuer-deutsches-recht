...
description: "Zolltarif Vzta Zollwert Royalties Ursprung im Außenwirtschaftsrecht, Zoll und Sanktionen: prüft konkret Zolltarifrecht und verbindliche Zolltarifauskuenfte (vZTA), Zollwerterhöhungen durch Lizenzgebuehren (Royalties) und, Zusammenhang von Zollwert und Ursprung bei der Einfuhr. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Zolltarif Vzta Zollwert Royalties Ursprung** als zusammenhängenden Arbeitsgang im Außenwirtschaftsrecht, Zoll und Sanktionen. Im Mittelpunkt steht die Prüfung von Zolltarifrecht und verbindliche Zolltarifauskuenfte (vZTA), Zollwerterhöhungen durch Lizenzgebuehren (Royalties) und, Zusammenhang von Zollwert und Ursprung bei der Einfuhr. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
