...
Dieser Skill behandelt **Ungewoehnlich Niedriges Unterschwellen** als zusammenhängenden Arbeitsgang im Plugin Fachanwalt Vergaberecht. Im Mittelpunkt steht die Prüfung von Ungewoehnlich niedriges Angebot pruefen, Rechtsschutz unterhalb der EU-Schwellenwerte planen, Leitfaden Eignungspruefung § 122 GWB und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
