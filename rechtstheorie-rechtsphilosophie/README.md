...
| **Rechtstheorie und Rechtsphilosophie-Plugin** | Vollständiges Plugin mit Skills, README und Begleitdateien. | [`rechtstheorie-rechtsphilosophie.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/rechtstheorie-rechtsphilosophie.zip) |
| **Rechtstheorie und Rechtsphilosophie-Testakte** | Demonstrationsmaterial zum Ausprobieren des Workflows. | [`alle-testakten.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/alle-testakten.zip) |
