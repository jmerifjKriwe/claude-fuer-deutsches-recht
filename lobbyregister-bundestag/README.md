...
| Skill | Beschreibung |
| --- | --- |
| `account-rollen-regelungsvorhaben-erfassen` | Account Rollen Regelungsvorhaben Erfassen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aktualisierung-unverzueglich-adressatenkreis` | Aktualisierung Unverzueglich Adressatenkreis: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `anonymisierung-schutzantrag-auftraggeber` | Anonymisierung Schutzantrag Auftraggeber: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ausnahmen-bundesregierung-bundestag` | Ausnahmen Bundesregierung Bundestag: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `benachrichtigungskonto-monitor` | Benachrichtigungskonto Monitor: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `betraute-personen-datenschutz` | Betraute Personen Datenschutz: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bussgeld-pruefverfahren-quartalsmonitor` | Bussgeld Pruefverfahren Quartalsmonitor: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `dokumentationsakte-revisionsspur-drehtuer` | Dokumentationsakte Revisionsspur Drehtuer: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `end-to-erstkontakt-offenlegung` | END TO Erstkontakt Offenlegung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `erstregistrierung-ausfuellen` | Erstregistrierung Ausfuellen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `freiwillige-registrierung-fremdmandat` | Freiwillige Registrierung Fremdmandat: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fruehere-interessenvertretung` | Fruehere Interessenvertretung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hausausweis-anhoerung-interessen` | Hausausweis Anhoerung Interessen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `intake-mandat-lobbyregister` | Intake Mandat Lobbyregister: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `interessenvertretung-begriff-interne` | Interessenvertretung Begriff Interne: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `jahresabschluss-rechenschaftsbericht-konzern` | Jahresabschluss Rechenschaftsbericht Konzern: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `lobbyregister-hauptfinanzierungsquellen-angaben` | Hauptfinanzierungsquellen Angaben: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mitgliedschaften-mitgliederzahl-nicht` | Mitgliedschaften Mitgliederzahl Nicht: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `oeffentliche-zuwendungen-personen` | Oeffentliche Zuwendungen Personen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `registereintrag-finalcheck-registerfuehrende` | Registereintrag Finalcheck Registerfuehrende: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `registrierungspflicht-schenkungen-sponsoring` | Registrierungspflicht Schenkungen Sponsoring: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stellungnahmen-gutachten-suche-open` | Stellungnahmen Gutachten Suche Open: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `taetigkeitsbeschreibung-unterauftragnehmer` | Taetigkeitsbeschreibung Unterauftragnehmer: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `verhaltenskodex-integritaet-verstoesse-melden` | Verhaltenskodex Integritaet Verstoesse Melden: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vertretungsberechtigte-personen-visitenkarte` | Vertretungsberechtigte Personen Visitenkarte: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
