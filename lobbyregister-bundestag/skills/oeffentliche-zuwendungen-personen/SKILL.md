...
description: "Oeffentliche Zuwendungen Personen im Lobbyregister Bundestag: prüft konkret Prüft Zuwendungen und Zuschuesse der deutschen öffentlichen, Mitgliedst, Bestimmt, ob natuerliche Person. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Oeffentliche Zuwendungen Personen** als zusammenhängenden Arbeitsgang im Lobbyregister Bundestag. Im Mittelpunkt steht die Prüfung von Prüft Zuwendungen und Zuschuesse der deutschen öffentlichen, Mitgliedst, Bestimmt. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
