...
description: "END TO Erstkontakt Offenlegung im Lobbyregister Bundestag: prüft konkret Geführter Gesamtmit 50-Skill-Routing, Formuliert Offenlegung beim erstmaligen Kontakt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **END TO Erstkontakt Offenlegung** als zusammenhängenden Arbeitsgang im Lobbyregister Bundestag. Im Mittelpunkt steht die Prüfung von Geführter Gesamtmit 50-Skill-Routing, Formuliert Offenlegung beim erstmaligen Kontakt. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
