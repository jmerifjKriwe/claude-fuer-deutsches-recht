...
| Skill | Beschreibung |
| --- | --- |
| `153a-stpo-iii-bewaehrung-stgb` | 153a Stpo III Bewaehrung Stgb: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bewaehrung-auflagen-bewaehrungswiderruf-56f` | Bewaehrung Auflagen Bewaehrungswiderruf 56F: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `bewaehrung-interessen-deutschem` | Bewaehrung Interessen Deutschem: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `freiheitsstrafe-strafmass-geldstrafe` | Freiheitsstrafe Strafmass Geldstrafe: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `geldstrafe-grossen-rechtsmittel` | Geldstrafe Grossen Rechtsmittel: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `gesamtstrafenbildung-stgb-gestaendnis` | Gesamtstrafenbildung Stgb Gestaendnis: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `jgg-jugendstrafe-minder-schwerer` | JGG Jugendstrafe Minder Schwerer: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `orientierung-triage-paragraph-stgb-besonders` | Orientierung Triage Paragraph Stgb Besonders: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `regelbeispiele-stgb-strafbefehl` | Regelbeispiele Stgb Strafbefehl: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `strafbefehl-stpo-strafmilderung-stgb` | Strafbefehl Stpo Strafmilderung Stgb: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafkammer-strafzumessung` | Strafkammer Strafzumessung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafrecht-verfahrensstadium-strafbefehl` | Strafrecht Verfahrensstadium Strafbefehl: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafz-aufklaerungshilfe-kronzeuge` | Strafz Aufklaerungshilfe Kronzeuge: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafz-strafzumessungstatsachen` | Strafz Strafzumessungstatsachen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `strafzumessung-output-waehlen` | Output wählen: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
...
| `strafzumessung-regelbeispiele-strafrahmenwahl` | Regelbeispiele Strafrahmenwahl: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `verstaendigung-257c` | Verstaendigung 257c: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
