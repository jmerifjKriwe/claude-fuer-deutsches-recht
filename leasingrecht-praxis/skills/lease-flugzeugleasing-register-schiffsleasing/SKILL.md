...
description: "Lease Flugzeugleasing Register Schiffsleasing im Plugin Leasingrecht Praxis: prüft konkret Flugzeug-Leasing, Schiffsleasing, Leasingrefinanzierung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Lease Flugzeugleasing Register Schiffsleasing** als zusammenhängenden Arbeitsgang im Plugin Leasingrecht Praxis. Im Mittelpunkt steht die Prüfung von Flugzeug-Leasing, Schiffsleasing, Leasingrefinanzierung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
