...
Dieser Skill behandelt **Inso P139 Eroffnungsantrag P147** als zusammenhängenden Arbeitsgang im Insolvenz- und Sanierungsrecht. Im Mittelpunkt steht die Prüfung von § 139 InsO (Berechnung der Fristen vor dem, § 147 InsO (Rechtshandlungen nach Verfahrenseröffnung) im, § 157 InsO (Entscheidung über den Fortgang des Verfahrens) und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
