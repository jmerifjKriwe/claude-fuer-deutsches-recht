...
# Kompendium 03 - fachanwalt-insolvenz-sanierungsrecht
...
**Frühere Beschreibung:** Livecheck: Fristennotiz und nächster Schritt im Insolvenz- und Sanierungsrecht: fachlich vertiefter Spezialskill mit Normenradar (InsO/StaRUG/IDW-S6), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt.
...
**Frühere Beschreibung:** Sanierungsrecht: Fristen, Form, Zuständigkeit und Rechtsweg im Insolvenz- und Sanierungsrecht: fachlich vertiefter Spezialskill mit Normenradar (InsO/StaRUG/IDW-S6), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt.
...
**Frühere Beschreibung:** § 104 InsO (Fixgeschäfte, Finanzleistungen, vertragliches Liquidationsnetting) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
**Frühere Beschreibung:** § 116 InsO (Erlöschen von Geschäftsbesorgungsverträgen) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
**Frühere Beschreibung:** § 255 InsO (Wiederauflebensklausel) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 6. `inso-p279-gegenseitige-vertrage`

**Frühere Beschreibung:** § 279 InsO (Gegenseitige Verträge) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 7. `inso-p336-vertrag-uber-einen-unbeweglichen-gegenstand`

**Frühere Beschreibung:** § 336 InsO (Vertrag über einen unbeweglichen Gegenstand) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 8. `inso-p043-haftung-mehrerer-personen`

**Frühere Beschreibung:** § 43 InsO (Haftung mehrerer Personen) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 9. `inso-p060-haftung-des-insolvenzverwalters`

**Frühere Beschreibung:** § 60 InsO (Haftung des Insolvenzverwalters) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 10. `inso-p071-haftung-der-mitglieder-des-glaubigerausschusses`

**Frühere Beschreibung:** § 71 InsO (Haftung der Mitglieder des Gläubigerausschusses) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 11. `inso-p092-gesamtschaden`

**Frühere Beschreibung:** § 92 InsO (Gesamtschaden) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 12. `inso-p093-personliche-haftung-der-gesellschafter`

**Frühere Beschreibung:** § 93 InsO (Persönliche Haftung der Gesellschafter) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 13. `inso-p227-haftung-des-schuldners`

**Frühere Beschreibung:** § 227 InsO (Haftung des Schuldners) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 14. `inso-p280-haftung-insolvenzanfechtung`

**Frühere Beschreibung:** § 280 InsO (Haftung. Insolvenzanfechtung) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 15. `inso-p334-personliche-haftung-der-ehegatten`

**Frühere Beschreibung:** § 334 InsO (Persönliche Haftung der Ehegatten) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 16. `inso-p155-handels-und-steuerrechtliche-rechnungslegung`

**Frühere Beschreibung:** § 155 InsO (Handels- und steuerrechtliche Rechnungslegung) im Mandat prüfen: Normzweck, Tatbestand, Belege, Rechtsfolge, Fristen, Schnittstellen und sichere Quellenprüfung.
...
## 17. `spezial-steuerrecht-formular-portal-und-einreichung`

**Frühere Beschreibung:** Steuerrecht: Formular, Portal und Einreichungslogik im Insolvenz- und Sanierungsrecht: fachlich vertiefter Spezialskill mit Normenradar (InsO/StaRUG/IDW-S6), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt.
...
## 18. `erstgespraech-mandatsannahme`

**Frühere Beschreibung:** Strukturierter Erstgespraechsleitfaden für Insolvenz- und Restrukturierungsrecht: Erfassung der Konstellation, Konflikt- und GwG-Check, Vollmacht, Streitwert/Gebührenvereinbarung, Fristen-Erstprognose und Handlungsweichen.
...
## 19. `fa-inso-drittstaaten-anerkennung-registervollzug`

**Frühere Beschreibung:** Fachanwaltlicher Spezialskill für Drittstaateninsolvenz in Deutschland: Anerkennung nach §§ 335 ff., 343 InsO, Inzidentprüfung, office holder, debtor in possession, GmbH-Anteile, Grundbuch, Handelsregister und Nachweispaket.
...
## 20. `fa-insolvenz-npl-und-distressed-debt`

**Frühere Beschreibung:** Prüft NPL-Kauf, distressed debt, Kreditdienstleister, Gläubigerstellung, Planmehrheiten, Anfechtung und Loan-to-own.
...
## 21. `fa-insolvenz-schuldschein-und-lma`

**Frühere Beschreibung:** Prüft Schuldschein- und LMA-Finanzierungen in Sanierung, Eigenverwaltung, StaRUG und Insolvenzplan.
