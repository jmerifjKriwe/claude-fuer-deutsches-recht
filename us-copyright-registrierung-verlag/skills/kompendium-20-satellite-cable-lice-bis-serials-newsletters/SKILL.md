...
**Frühere Beschreibung:** Prueft statutory licenses für Cable, Satellite, retransmission, reporting und payment issues.
...
**Frühere Beschreibung:** Prueft Sicherheiten an Copyrights, UCC/recordation Schnittstelle, Kreditverträge, Catalog Finance und Insolvenzrisiken.
...
**Frühere Beschreibung:** Prueft Mask Works, Semiconductor Chip Protection Act, registration, scope and term for chip layouts.
...
**Frühere Beschreibung:** Serials, Newsletter, Updates und Datenbanken: periodische Publikationen, Online-only-Ausgaben, Updates und Gruppengebühren praxisnah sortieren.
