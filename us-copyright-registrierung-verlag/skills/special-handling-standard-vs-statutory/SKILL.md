...
description: "Special Handling Standard VS Statutory im Plugin Us Copyright Registrierung Verlag: prüft konkret Special Handling bei Eilbedarf, Antragstyp sauber wählen, Prueft statutory damages, actual damages. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Special Handling Standard VS Statutory** als zusammenhängenden Arbeitsgang im Plugin Us Copyright Registrierung Verlag. Im Mittelpunkt steht die Prüfung von Special Handling bei Eilbedarf, Antragstyp sauber wählen, Prueft statutory damages und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
