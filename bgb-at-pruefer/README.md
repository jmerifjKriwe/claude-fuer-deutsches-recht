...
| `agb-einbeziehung-amtlicher-zpo-anfechtung` | AGB Einbeziehung Amtlicher ZPO Anfechtung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anfechtungsfolgen-paragraphen-anspruchsaufbau` | Anfechtungsfolgen Paragraphen Anspruchsaufbau: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `anfechtungsfrist-erklaerung-annahmefrist` | Anfechtungsfrist Erklaerung Annahmefrist: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `auslegung-sachverhalt-bgb-at-erklaerungskette` | Auslegung Sachverhalt BGB AT Erklaerungskette: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `eigenschaftsirrtum-paragraph-einseitige` | Eigenschaftsirrtum Paragraph Einseitige: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elektronische-bea-elektronischer-zugang` | Elektronische BEA Elektronischer Zugang: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `erwerbsgeschaeft-dienst-formnichtigkeit` | Erwerbsgeschaeft Dienst Formnichtigkeit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fallaufnahme-pruefprogramm-prozessform` | Fallaufnahme Pruefprogramm Prozessform: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gesetzesverbot-sittenwidrigkeit-gutachtenstil` | Gesetzesverbot Sittenwidrigkeit Gutachtenstil: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `insichgeschaeft-paragraph-irrtumsanfechtung` | Insichgeschaeft Paragraph Irrtumsanfechtung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `klausurloesungen-fehlerdiagnose-konsens` | Klausurloesungen Fehlerdiagnose Konsens: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `paragraphen-cic-vorvertragliche-ergaenzende` | Paragraphen CIC Vorvertragliche Ergaenzende: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `personen-rechtsfaehigkeit-privatautonomie` | Personen Rechtsfaehigkeit Privatautonomie: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `schweigen-erklaerungswert-stellvertretung` | Schweigen Erklaerungswert Stellvertretung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `taschengeld-paragraph-uebermittlungsirrtum` | Taschengeld Paragraph Uebermittlungsirrtum: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `training-fallvarianten-digitale-elemente` | Training Fallvarianten Digitale Elemente: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `verjaehrung-grundschema-vertreter-ohne` | Verjaehrung Grundschema Vertreter Ohne: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vertragsschluss-antrag-abgabe` | Vertragsschluss Antrag Abgabe: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `willenserklaerung-wucher-ausbeutung-zugang` | Willenserklaerung Wucher Ausbeutung Zugang: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `zugangsvereitelung-annahmeverweigerung` | Zugangsvereitelung Annahmeverweigerung: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
