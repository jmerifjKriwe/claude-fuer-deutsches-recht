...
Automatisch generierte Gesamtuebersicht aller **20903 Skills** in **213 Plugins**.
...
Die Detailseiten liegen unter [`skills-index/`](skills-index/) -- eine eigene `.md`-Datei pro Plugin. So bleibt diese Hauptseite klein und laedt schnell, statt mit 20903 Tabellenzeilen den Browser-Renderer von GitHub zu ueberfordern.
...
| **verhaeltnismaessigkeitspruefer** | 80 | [Skills ansehen](skills-index/verhaeltnismaessigkeitspruefer.md) | [Download](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/verhaeltnismaessigkeitspruefer.zip) |
