...
Gleiche Quelle wie das [`gesellschaftsrecht`](../../gesellschaftsrecht)-Plugin – dieses Verzeichnis ist das Managed-Agent-Kochbuch für `POST /v1/agents`. Der Tabellenmodus nutzt den `gesellschaftsrecht-tabellenpruefung-cap-table`-Skill und läuft headless über eine Extractor-Worker-Flotte.
