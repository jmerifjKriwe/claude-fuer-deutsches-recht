...
- **Themenprofile.** Die Wesentlichkeitsschwellen und Themencluster (Finanzaufsicht, Netzregulierung, Kartellrecht, Datenschutz) werden in der `CLAUDE.md` des deployenden Teams konfiguriert. Führen Sie dort `/regulatorisches-recht:anpassen` durch, bevor Sie den Sweep-Modus in den Live-Betrieb bringen.
