...
| `insolvenzverwaltung-sicht-tatbestand-beweis-belege` | Sicht Tatbestand Beweis Belege im Plugin Insolvenzverwaltung: fachlicher Arbeitsgang mit Prüffeldwahl, Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
