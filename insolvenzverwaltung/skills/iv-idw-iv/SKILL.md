---
name: iv-idw-iv
description: "IV IDW IV im Plugin Insolvenzverwaltung: prüft konkret Prüft aus Insolvenzverwalter-, Sachwalter- oder vorläufiger Verwalterperspektive, Einstiegspunkt für neue Insolvenzverwaltungsmandate. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **IV IDW IV** als zusammenhängenden Arbeitsgang im Plugin Insolvenzverwaltung. Im Mittelpunkt steht die Prüfung von Prüft aus Insolvenzverwalter-, Sachwalter- oder vorläufiger Verwalterperspektive, Einstiegspunkt für neue Insolvenzverwaltungsmandate. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
