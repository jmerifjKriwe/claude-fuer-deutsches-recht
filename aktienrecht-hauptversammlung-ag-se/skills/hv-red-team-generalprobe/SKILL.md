...
description: "Hauptversammlung AG und SE: HV Red Team Generalprobe; konkretisierter Spezialmodul mit Prüfachsen, Red Flags, Varianten, Quellenhygiene und verwertbarem Output."
---

# HV Red Team Generalprobe

## Fachkern: HV Red Team Generalprobe
- **Spezialgegenstand:** HV Red Team Generalprobe wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
...
Dieser Skill ist für **HV Red Team Generalprobe** gedacht. Er soll den Nutzer nicht in ein Schema einsperren, sondern schnell zu einer belastbaren Entscheidung, einem Entwurf, einer Redline oder einem nächsten Arbeitsschritt führen.
