...
description: "Anlagen fuer beA-Versand vorbereiten: PDF/A-konform, max. zulaessige Dateigroesse beachten, OCR ueber Scans laufen lassen, korrekt strukturiertes XJustiz-Begleitformular. Liste der Anlagen pro Schriftsatz mit Pruefsumme. Verhindert wiederholte Zurueckweisung."
---

# Anlagen fuer beA-Versand

## Aufgabe
Anlagen fuer beA-Versand vorbereiten: PDF/A-konform, max.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `anlagen-zu-schriftsaetzen` zum Thema `anlagen-fuer-bea-versand`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Anlagen fuer beA-Versand vorbereiten: PDF/A-konform, max. zulaessige Dateigroesse beachten, OCR ueber Scans laufen lassen, korrekt strukturiertes XJustiz-Begleitformular. Liste der Anlagen pro Schriftsatz mit Pruefsumme. Verhindert wiederholte Zurueckweisung..
