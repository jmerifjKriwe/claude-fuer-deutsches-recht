...
## Aufgabe
Bilder und Screenshots als Anlagen: Beweiskraft, Manipulationsanfaelligkeit, EXIF-Daten, Metadaten.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `anlagen-zu-schriftsaetzen` zum Thema `anlagen-bilder-screenshots`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Bilder und Screenshots als Anlagen: Beweiskraft, Manipulationsanfaelligkeit, EXIF-Daten, Metadaten. Empfehlung: Original und Vergroesserung beifuegen, EXIF-Export anhaengen, Standortdaten transparent machen. Bei Screenshots: voller Browser/App-Rahmen mit URL und Uhrzeit..
