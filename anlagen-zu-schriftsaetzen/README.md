...
| `anlage-red-anlagen-anlagenkonvolut-sonderfall` | Anlage RED Anlagen Anlagenkonvolut Sonderfall: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `anlagen-an-assistenz-uebersetzungspflicht` | AN Assistenz Uebersetzungspflicht: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagen-berufung-revision-eilantrag-eu-bilder` | Berufung Revision Eilantrag EU Bilder: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagen-check-zustellung-redaktion-dsgvo` | Check Zustellung Redaktion DSGVO: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagen-elektronische-dokumente-format` | Elektronische Dokumente Format: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagen-schriftsaetze-start-belegmatrix-fristen` | Schriftsaetze Start Belegmatrix Fristen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagenband-strukturieren-anlagenbezug` | Anlagenband Strukturieren Anlagenbezug: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `anlagenverzeichnis-kanzlei-grundaufbau-bea` | Anlagenverzeichnis Kanzlei Grundaufbau BEA: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `baut-beweislast-benennt-bereits-excel` | Baut Beweislast Benennt Bereits Excel: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `beweisangebot-anlage-emails-chats-excel` | Beweisangebot Anlage Emails Chats Excel: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `frist-eilversand-schiedsverfahren-anlagenband` | Frist Eilversand Schiedsverfahren Anlagenband: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `haftpflicht-versicherer-konvention-k` | Haftpflicht Versicherer Konvention K: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `k1-anlagenpaket-k1-sortierwerkstatt` | K1 Anlagenpaket K1 Sortierwerkstatt: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `konform-interessen-konvertiert-oben` | Konform Interessen Konvertiert Oben: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `nachreichung-berichtigung-ocr-scan-original` | Nachreichung Berichtigung OCR Scan Original: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `pruefmodus-fristennotiz-datenraum-sharepoint` | Pruefmodus Fristennotiz Datenraum Sharepoint: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `sortiert-stempelt-word` | Sortiert Stempelt Word: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `zuordnung-zeitleiste-belegkette` | Zuordnung Zeitleiste Belegkette: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
