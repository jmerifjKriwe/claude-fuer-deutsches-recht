...
| `anlage-red-anlagen-anlagenkonvolut-sonderfall` | Anlage: Red-Team und Qualitätskontrolle im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `anlagen-tatbestand-beweis-und-belege` | Anlagen: Tatbestandsmerkmale, Beweisfragen und Beleglage im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `anlagenkonvolut-sonderfall-und-edge-case` | Anlagenkonvolut: Sonderfall und Edge-Case-Prüfung im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `benennt-compliance-dokumentation-und-akte` | Benennt: Compliance-Dokumentation und Aktenvermerk im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `bereits-abschlussprodukt-und-uebergabe` | Bereits: Abschlussprodukt und Übergabe im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `frist-eilversand-schiedsverfahren-anlagenband` | Red-Team Qualitygate: prüft das Ergebnis auf Halluzinationen, Fristenfehler, Zuständigkeit, Quellen, Beweise und Ton im Anlagen zu Schriftsätzen. |
...
| `gerichtlichen-fristen-form-und-zustaendigkeit` | Gerichtlichen: Fristen, Form, Zuständigkeit und Rechtsweg im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `konform-interessen-konvertiert-oben` | Konform: Mehrparteienkonflikt und Interessenmatrix im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `sortiert-risikoampel-und-gegenargumente` | Sortiert: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
| `sortiert-stempelt-word` | Schriftsatz: Verhandlung, Vergleich und Eskalation im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `stempelt-internationaler-bezug-und-schnittstellen` | Stempelt: Internationaler Bezug und Schnittstellen im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
...
| `workflow-chronologie-und-belegmatrix` | Chronologie und Belegmatrix: macht aus unordentlichem Material eine Timeline mit Belegstellen und offenen Widersprüchen im Anlagen zu Schriftsätzen. |
| `workflow-fristen-und-risikoampel` | Fristen- und Risikoampel: macht eine Sofortampel für Frist, Zuständigkeit, Haftung, Eilbedarf und fehlende Unterlagen im Anlagen zu Schriftsätzen. |
| `workflow-mandantenkommunikation` | Mandantenkommunikation: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten im Anlagen zu Schriftsätzen. |
...
| `zuordnung-zeitleiste-belegkette` | Zuordnung: Erstprüfung, Rollenklärung und Mandatsziel im Plugin anlagen zu schriftsaetzen im Anlagen zu Schriftsätzen. |
