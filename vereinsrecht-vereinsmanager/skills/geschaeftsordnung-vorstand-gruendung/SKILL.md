...
description: "Geschaeftsordnung Vorstand Gruendung im Plugin Vereinsrecht Vereinsmanager: prüft konkret Regelt Sitzungen, Beschlüsse, Ressorts, Zeichnungsrechte. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Geschaeftsordnung Vorstand Gruendung** als zusammenhängenden Arbeitsgang im Plugin Vereinsrecht Vereinsmanager. Im Mittelpunkt steht die Prüfung von Regelt Sitzungen, Beschlüsse, Ressorts. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
