...
| `liquiditaetsplanung-liquiditaetsvorschau-3wochen` | Liquiditaetsvorschau 3wochen / Liquiditaetsvorschau Insolvenzrechtlich / Spezial Ampel Zahlen Schwellen Berechnung: bearbeitet die maßgeblichen Prüffelder, setzt den passenden Prüfpfad und erzeugt den nächsten belastbaren Output. |
...
| `wochen-liqui-ausgabengruppen-cash` | Wochen Fristen Form Und Zustaendigkeit, Liqui Ausgabengruppen Systematik, Liqui Cash Pooling Konzern: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
