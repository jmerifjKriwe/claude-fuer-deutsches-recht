---
name: liqui-grundbegriffe-cashflow
description: "Liquiditaetsplanung Grundbegriffe: Cashflow vs. Gewinn, indirekte vs. direkte Methode, Liquiditaet 1./2./3. Grades, Working Capital. Abgrenzung zur GuV-Planung. Empfehlung: direkte Methode fuer 13-Wochen-Forecast, indirekte fuer Jahresplanung."
---

# Liquiditaetsplanung: Grundbegriffe

## Aufgabe
Liquiditaetsplanung Grundbegriffe: Cashflow vs.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `liquiditaetsplanung` zum Thema `liqui-grundbegriffe-cashflow`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Liquiditaetsplanung Grundbegriffe: Cashflow vs. Gewinn, indirekte vs. direkte Methode, Liquiditaet 1./2./3. Grades, Working Capital. Abgrenzung zur GuV-Planung. Empfehlung: direkte Methode fuer 13-Wochen-Forecast, indirekte fuer Jahresplanung..
