...
| Skill | Beschreibung |
| --- | --- |
| `alternativen-keine-aufgabe-kompetenz` | Alternativen Keine Aufgabe Kompetenz: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `buerokratieabbau-katalog-buerokratiekosten-vs` | Buerokratieabbau Katalog Buerokratiekosten VS: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `einmalig-vs-erforderlichkeitspruefung-warum` | Einmalig VS Erforderlichkeitspruefung Warum: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `erfuellungsaufwand-buerger-grundbegriff` | Erfuellungsaufwand Buerger Grundbegriff: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `eu-ebene-eu-richtlinien` | EU Ebene EU Richtlinien: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `evaluation-jahresbericht-fallzahlen` | Evaluation Jahresbericht Fallzahlen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `evaluierung-befristung-verfahrensgang` | Evaluierung Befristung Verfahrensgang: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `gleichstellungs-gendercheck-handelsregister` | Gleichstellungs Gendercheck Handelsregister: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `leitfaden-ermittlung` | Leitfaden Ermittlung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `nachhaltigkeit-klimacheck-one` | Nachhaltigkeit Klimacheck ONE: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `nkr-digital-anschlussfaehigkeit-digitalcheck` | Digital Anschlussfaehigkeit Digitalcheck: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `orientierung-mandatsaufnahme-praktikabilitaet` | Orientierung Mandatsaufnahme Praktikabilitaet: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `pruefumfang-was-standardkostenmodell-skm` | Pruefumfang WAS Standardkostenmodell SKM: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stellungnahme-aufbau-ergebnis` | Stellungnahme Aufbau Ergebnis: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stellungnahme-evaluationsklausel` | Stellungnahme Evaluationsklausel: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stellungnahme-grundsatzfeststellung` | Stellungnahme Grundsatzfeststellung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stellungnahme-pressepolitik-bundestag` | Stellungnahme Pressepolitik Bundestag: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `verhaeltnismaessigkeit-sicht-zeitwerttabelle` | Verhaeltnismaessigkeit Sicht Zeitwerttabelle: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zusammenarbeit-bundesregierung` | Zusammenarbeit Bundesregierung: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
