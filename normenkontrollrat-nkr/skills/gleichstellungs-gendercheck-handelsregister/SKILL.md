...
description: "Gleichstellungs Gendercheck Handelsregister im Plugin Normenkontrollrat Nkr: prüft konkret Fachmodul Gleichstellungs- und Gendercheck nach § 1 BGleiG, Fachmodul fuer Vorhaben mit Handelsregister-Bezug und. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Gleichstellungs Gendercheck Handelsregister** als zusammenhängenden Arbeitsgang im Plugin Normenkontrollrat Nkr. Im Mittelpunkt steht die Prüfung von Fachmodul Gleichstellungs- und Gendercheck nach § 1 BGleiG, Fachmodul fuer Vorhaben mit Handelsregister-Bezug und. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
