...
description: "Erfuellungsaufwand Buerger Grundbegriff im Plugin Normenkontrollrat Nkr: prüft konkret Trennt den Erfuellungsaufwand methodisch nach den drei, Definiert den Grundbegriff Erfuellungsaufwand nach NKRG GGO. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Erfuellungsaufwand Buerger Grundbegriff** als zusammenhängenden Arbeitsgang im Plugin Normenkontrollrat Nkr. Im Mittelpunkt steht die Prüfung von Trennt den Erfuellungsaufwand methodisch nach den drei, Definiert den Grundbegriff Erfuellungsaufwand nach NKRG GGO. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
