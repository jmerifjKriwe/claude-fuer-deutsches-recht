---
name: schwerbehindertenausweis-gdb
...
Der Bescheid weist nur den Gesamt-GdB aus. Eine Pruefung ist mangels
ausgewiesener Einzelwerte und Wechselwirkungen nicht moeglich. Wir
beantragen die Auflistung aller Einzel-GdB-Werte und die Begruendung
der Gesamt-GdB-Bildung (Akteneinsicht parallel beantragt).

II. Funktionsstoerung [Name] zu niedrig bewertet

Der Einzel-GdB fuer [Diagnose] wurde mit [X] angesetzt. Nach VersMedV
...
III. Merkzeichen G — Pruefung 2-km-30-Min-Kriterium

Die Versorgungsaerztin hat ohne konkrete Pruefung das Merkzeichen G
abgelehnt. Tatsaechlich kann die Mandantin nicht zwei Kilometer in
dreissig Minuten zuruecklegen. Belegt durch Verkehrsprotokoll Anlage
W [Nr] sowie aerztliches Attest Dr. [Name].

IV. Gesamt-GdB falsche Bildung
