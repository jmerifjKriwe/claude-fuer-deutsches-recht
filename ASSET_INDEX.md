...
| **Fachanwalt fuer Steuerrecht** (nicht separat) | ⚠️ Kein eigenes Light-Touch-Plugin. Konsolidiert in `steuerrecht-anwalt-und-berater` (siehe naechste Zeile) mit `fa-` Skill-Praefix. |
| `steuerrecht-anwalt-und-berater` | Steuerberater und Fachanwalt fuer Steuerrecht: Bescheidanalyse Einspruch Klage Finanzgericht Aussenpruefung Selbstanzeige Verbindliche Auskunft Akteneinsicht. Steuerberater-Werkzeuge BWA SuSa Bilanzpruefung Krisenfrueherkennung. Praefixe anw- fa- stb-. |
