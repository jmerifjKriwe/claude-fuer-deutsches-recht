...
description: "apothekenrecht: Konsolidiertes Skill-Kompendium 17; bündelt 3 frühere Spezialskills (retaxationsabwehr-nullretax-risiko, rezeptsammelstelle-botendienst-versandhandel, rezeptur-plausibilitaetspruefung-herstellungsanweisung) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 17 - apothekenrecht
...
**Frühere Beschreibung:** Retaxationsabwehr Nullretax Risiko: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: ApoG, ApBetrO, AMG, AMPreisV, HWG, BtMG/BtMVV, SGB V, DSGVO, E-Rezept/TI-Hinweise, Landesaufsicht.
...
**Frühere Beschreibung:** Rezeptsammelstelle Botendienst Versandhandel: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: ApoG, ApBetrO, AMG, AMPreisV, HWG, BtMG/BtMVV, SGB V, DSGVO, E-Rezept/TI-Hinweise, Landesaufsicht.
...
**Frühere Beschreibung:** Rezeptur Plausibilitätsprüfung Herstellungsanweisung: prüft die einschlägigen Voraussetzungen, Dokumente, Risiken und Ausnahmen. Norm-/Quellenanker: ApoG, ApBetrO, AMG, AMPreisV, HWG, BtMG/BtMVV, SGB V, DSGVO, E-Rezept/TI-Hinweise, Landesaufsicht.
