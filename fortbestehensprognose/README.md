...
| Skill | Beschreibung |
| --- | --- |
| `annahmen-sammeln-bilanzieller-status` | Annahmen Sammeln Bilanzieller Status: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `comfortletter-sonderfall-edge` | Comfortletter Sonderfall Edge: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fbp-zahlungsunfaehigkeit` | FBP Zahlungsunfaehigkeit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fortbestehensdokumentation-insolvenzrecht` | Fortbestehensdokumentation Insolvenzrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `fortbestehensprognose-fbp-bankenkommunikation-waiver-integrierte` | FBP Bankenkommunikation Waiver Integrierte: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fortbestehensprognose-fp-dokumentation-gerichtsfaehigkeit` | FP Dokumentation Gerichtsfaehigkeit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `fortbestehensprognose-mandantenkommunikation-redteam` | Mandantenkommunikation Redteam: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `fortbestehensprognose-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gesellschafterdarlehen-rangruecktritt` | Gesellschafterdarlehen Rangruecktritt: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `liquiditaet-patronatserklaerung-interessen` | Liquiditaet Patronatserklaerung Interessen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `negativer-fristennotiz-ausloesendes-ereignis` | Negativer Fristennotiz Ausloesendes Ereignis: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `prognose-stichtag-stundungsanfrage-glaeubiger` | Prognose Stichtag Stundungsanfrage Glaeubiger: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `rangruecktritt-sanierungsbausteine` | Rangruecktritt Sanierungsbausteine: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `sanierungsbausteine-vorschlagen-annahmen` | Sanierungsbausteine Vorschlagen Annahmen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `starug-beweislast-stundung-red-zwoelf` | Starug Beweislast Stundung RED Zwoelf: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `wenn-prognose` | Wenn Prognose: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
