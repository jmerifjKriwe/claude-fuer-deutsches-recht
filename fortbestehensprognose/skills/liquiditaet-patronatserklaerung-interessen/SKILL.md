...
description: "Liquiditaet Patronatserklaerung Interessen im Plugin Fortbestehensprognose: prüft konkret Liquiditaet, Patronatserklaerung, Plausibilisierung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Liquiditaet Patronatserklaerung Interessen** als zusammenhängenden Arbeitsgang im Plugin Fortbestehensprognose. Im Mittelpunkt steht die Prüfung von Liquiditaet, Patronatserklaerung, Plausibilisierung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
