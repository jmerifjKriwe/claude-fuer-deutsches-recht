...
description: "Prognose Stichtag Stundungsanfrage Glaeubiger im Plugin Fortbestehensprognose: prüft konkret Abschließende Selbstdokumentation der Fortbestehensprognose, Erzeugt Stundungsanfragen an Gläubiger (Lieferanten Bank, Plausibilisiert die in `annahmen-sammeln-fortführung`. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Prognose Stichtag Stundungsanfrage Glaeubiger** als zusammenhängenden Arbeitsgang im Plugin Fortbestehensprognose. Im Mittelpunkt steht die Prüfung von Abschließende Selbstdokumentation der Fortbestehensprognose, Erzeugt Stundungsanfragen an Gläubiger (Lieferanten Bank, Plausibilisiert die in `annahmen-sammeln-fortführung`. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
