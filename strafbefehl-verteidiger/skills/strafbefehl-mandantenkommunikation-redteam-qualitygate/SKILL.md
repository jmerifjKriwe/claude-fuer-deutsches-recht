...
Dieser Skill behandelt **Mandantenkommunikation Redteam Qualitygate** als zusammenhängenden Arbeitsgang im Plugin Strafbefehl Verteidiger. Im Mittelpunkt steht die Prüfung von Mandantenkommunikation im Plugin strafbefehl-verteidiger, Red-Team Qualitygate im Plugin strafbefehl-verteidiger, Rechtsprechung zum Strafbefehlsverfahren recherchieren für. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
