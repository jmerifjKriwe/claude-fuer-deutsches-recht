...
description: "dfg-foerderantrag: Konsolidiertes Skill-Kompendium 08; bündelt 3 frühere Spezialskills (dfg-publikationsstrategie-projekt, dfg-replikationskrise-statistik-spezial, dfg-sachbeihilfe-elan-formalia) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 08 - dfg-foerderantrag
...
**Frühere Beschreibung:** Publikationsstrategie fuer das beantragte Projekt: realistische Zahl Publikationen, geplante Zeitschriften mit Impact und Open-Access-Status, DFG-Open-Access-Politik, Praeprints, Datenpublikation. Im Antrag muss Publikationsplan zu Arbeitsprogramm und Projektdauer passen. Vermeidet Ueberversprechen.
...
**Frühere Beschreibung:** Spezialfall Statistikabschnitt nach Replikationskrise: a-priori-Power-Analyse, Effektgroessenschaetzung, Vorab-Festlegung Hypothesen, Korrektur fuer multiple Testung, Sensitivitaetsanalysen. Pruefraster fuer Reviewer-Akzeptanz.
...
**Frühere Beschreibung:** DFG-Sachbeihilfe und elan-Formalia prüfen: Antragsberechtigung, Module, Vordrucke, Anlagen, Seitenlogik, Fachzuordnung, Fortsetzungsantrag, internationale Kooperation, formale Einreichungsreife.
