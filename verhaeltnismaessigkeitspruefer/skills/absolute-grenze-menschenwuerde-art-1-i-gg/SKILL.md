...
## Vorgehen in der Pruefung

1. **Eingriff** unstreitig oder offen lassen.
2. Anwendung der Objektformel: Wird der Betroffene zum blossen Objekt?
3. Wenn ja: Pruefung endet hier, Gesetz oder Massnahme ist verfassungswidrig.
4. Wenn nein: Pruefung verlaeuft normal weiter mit Stufe 4 Angemessenheit.

## Grenzen der Objektformel

- Nicht jeder schwerwiegende Eingriff verletzt die Wuerde – sonst waere Art 1 I GG inflationiert.
- Beispiel BVerfGE 109, 279 (Grosser Lauschangriff): Wohnraumueberwachung verletzt Art 13 I GG, aber nicht ohne weiteres Art 1 I GG, sofern Kernbereich gewahrt ist.
...
- BVerfGE 109, 279 (Grosser Lauschangriff)
