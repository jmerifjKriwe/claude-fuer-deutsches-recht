...
Dieser Skill behandelt **SPA APA Vertragsmarkup KEY Rechtsabteilung** als zusammenhängenden Arbeitsgang im Corporate/M&A (Großkanzlei-Praxis). Im Mittelpunkt steht die Prüfung von SPA Share Purchase Agreement und APA Asset Purchase, SPA/APA/NDA Markup analysieren und Key Issues List erstellen, Rechtsabteilungs-Fachmodul für MAC-Klausel bei. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
