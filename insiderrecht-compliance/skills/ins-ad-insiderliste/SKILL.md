...
description: "INS AD Insiderliste im Insiderrecht und Compliance: prüft konkret Fuehrt durch die vollstaendige Ad-hoc-Pflicht nach Art, Erstellt und pflegt Insiderlisten nach Art, Inhalt, Akt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INS AD Insiderliste** als zusammenhängenden Arbeitsgang im Insiderrecht und Compliance. Im Mittelpunkt steht die Prüfung von Fuehrt durch die vollstaendige Ad-hoc-Pflicht nach Art, Erstellt und pflegt Insiderlisten nach Art, Inhalt. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
