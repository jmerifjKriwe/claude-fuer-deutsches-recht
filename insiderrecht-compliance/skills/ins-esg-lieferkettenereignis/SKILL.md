...
description: "INS ESG Lieferkettenereignis im Insiderrecht und Compliance: prüft konkret Prueft Insiderinformations-Qualitaet und Ad-hoc-Pflicht bei. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INS ESG Lieferkettenereignis** als zusammenhängenden Arbeitsgang im Insiderrecht und Compliance. Im Mittelpunkt steht die Prüfung von Prueft Insiderinformations-Qualitaet und Ad-hoc-Pflicht bei. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
