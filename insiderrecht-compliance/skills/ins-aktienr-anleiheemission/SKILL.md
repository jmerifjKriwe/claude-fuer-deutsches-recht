...
**INS Aktienr Anleiheemission** ordnet den Fall über die tragenden Prüffelder: Prueft Aktienrueckkaufprogramme auf MAR-Konformitaet, Prueft insiderrechtliche Anforderungen bei Anleiheemissionen. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
