...
description: "INS Aktienr Anleiheemission im Insiderrecht und Compliance: prüft konkret Prueft Aktienrueckkaufprogramme auf MAR-Konformitaet, Prueft insiderrechtliche Anforderungen bei Anleiheemissionen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INS Aktienr Anleiheemission** als zusammenhängenden Arbeitsgang im Insiderrecht und Compliance. Im Mittelpunkt steht die Prüfung von Prueft Aktienrueckkaufprogramme auf MAR-Konformitaet, Prueft insiderrechtliche Anforderungen bei Anleiheemissionen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
