...
description: "INS Vorstandswechsel Dividenden im Insiderrecht und Compliance: prüft konkret Prueft Insiderrecht bei Vorstandswechseln, Prueft Insiderinformations-Entstehung bei. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INS Vorstandswechsel Dividenden** als zusammenhängenden Arbeitsgang im Insiderrecht und Compliance. Im Mittelpunkt steht die Prüfung von Prueft Insiderrecht bei Vorstandswechseln, Prueft Insiderinformations-Entstehung bei. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
