...
description: "Native Apps iOS und Android pruefen: Accessibility-API VoiceOver bzw. TalkBack, Plattform-spezifische Pattern, EN 301 549 Klausel 11. Tooling Xcode Accessibility Inspector, Android Accessibility Scanner. Konkrete Code-Beispiele Swift und Kotlin fuer haeufige Probleme."
---

# Native Apps iOS und Android

## Aufgabe
Native Apps iOS und Android pruefen: Accessibility-API VoiceOver bzw.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `barrierefreiheit-web-checker` zum Thema `native-apps-ios-android-pruefung`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Native Apps iOS und Android pruefen: Accessibility-API VoiceOver bzw. TalkBack, Plattform-spezifische Pattern, EN 301 549 Klausel 11. Tooling Xcode Accessibility Inspector, Android Accessibility Scanner. Konkrete Code-Beispiele Swift und Kotlin fuer haeufige Probleme..
