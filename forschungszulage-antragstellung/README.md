...
| **Forschungszulage-Antragstellung-Plugin** | Vollständiges Plugin mit Skills, README und Begleitdateien. | [`forschungszulage-antragstellung.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/forschungszulage-antragstellung.zip) |
| **Forschungszulage-Antragstellung-Testakte** | Demonstrationsmaterial zum Ausprobieren des Workflows. | [`testakte-forschungszulage-sensorik-startup-taunus.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-forschungszulage-sensorik-startup-taunus.zip) (Forschungszulage Riedblick Sensorik GmbH) |
