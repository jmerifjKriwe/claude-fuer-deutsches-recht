...
| `forsch-bsfz-pruefung-spezial` | Spezialfall BSFZ-Prüfung und Nachfragen: typische Rueckfragen Bescheinigungsstelle, Stellungnahmefrist, Widerspruch. Pruefraster für Antragsteller und Steuerberater. |
...
| `koordinierung-zwei` | Koordinierung Forschungszulage mit anderen Foerderwegen: keine Doppelfoerderung derselben Kosten, aber Kombination über Modulgrenze hinweg (ZIM, IGF, Horizon Europe, Landesfoerderung). Pruefraster für Kostentrennung, Buchhaltung, Besche... |
| `koordinierung-zwei-foerderwege` | Koordinierung Forschungszulage mit anderen Foerderwegen: keine Doppelfoerderung derselben Kosten, aber Kombination über Modulgrenze hinweg (ZIM, IGF, Horizon Europe, Landesfoerderung). Pruefraster für Kostentrennung, Buchhaltung, Besche... |
