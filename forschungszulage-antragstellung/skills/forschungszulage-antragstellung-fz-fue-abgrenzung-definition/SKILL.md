...
Dieser Skill behandelt **FZ FUE Abgrenzung Definition** als zusammenhängenden Arbeitsgang im Forschungszulage-Antragstellung. Im Mittelpunkt steht die Prüfung von FuE-Definition Grenzfaelle nach Frascati-Manual und FZulG, FuE-Definition für die Forschungszulage praxisnah prüfen, Spezialfall Konzern und Organschaft. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
