...
**DSV Meldung LDA LDI NRW LFD Niedersachsen** ordnet den Fall über die tragenden Prüfungslinien: Reicht eine Meldung nach Art. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüfungslinien
