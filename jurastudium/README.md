...
| Skill | Beschreibung |
| --- | --- |
| `ag-vorbereitung-examens-prognose` | AG Vorbereitung Examens Prognose: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fall-zusammenfassung-gliederungs-baukasten` | Fall Zusammenfassung Gliederungs Baukasten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `jurastudium-anschluss-router` | Anschluss Router: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `jurastudium-juristisches-schreiben-jus` | Juristisches Schreiben JUS: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `jurastudium-jus-referendariat-stationen-staatsexamen` | JUS Referendariat Stationen Staatsexamen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `jurastudium-klausurkorrektur-lernplanung-red` | Klausurkorrektur Lernplanung RED: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `jurastudium-pruefungsgespraech-muendlich` | Pruefungsgespraech Muendlich: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `karteikarten-lernplan-lernsitzung` | Karteikarten Lernplan Lernsitzung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `lernstrategien-livecheck-sonderfall` | Lernstrategien Livecheck Sonderfall: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `lernstrategien-loesungsschemata-methodenlehre` | Lernstrategien Loesungsschemata Methodenlehre: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `methodenlehre-oeffentliches-strafrecht` | Methodenlehre Oeffentliches Strafrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `methodenlehre-rechtsgeschichte-referendariat` | Methodenlehre Rechtsgeschichte Referendariat: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `pruefungsgespraech-ag-rechtsgeschichte` | Pruefungsgespraech AG Rechtsgeschichte: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafrecht-studium-subsumtionslehre` | Strafrecht Studium Subsumtionslehre: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `tatbestaende-lernen` | Tatbestaende Lernen: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
| `tradition-zivilrecht-subsumtionslehre` | Tradition Zivilrecht Subsumtionslehre: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
