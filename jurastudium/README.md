...
| Skill | Beschreibung |
| --- | --- |
| `ag-vorbereitung-examens-prognose` | Nutze dies, wenn Ag Vorbereitung, Examens Prognose, Examensvorbereitung Fragen im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Ag Vorbereitung, Examens Prognose, Examensvorbereitung Fragen prüfen.; Erstelle eine Arb... |
| `anschluss-router` | Nutze dies, wenn Allgemein, Workflow Anschluss Skills Router, Workflow Chronologie Und Belegmatrix im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Allgemein, Workflow Anschluss Skills Router, Workflow Chronologie Un... |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Jurastudium.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `fall-zusammenfassung-gliederungs-baukasten` | Nutze dies, wenn Fall Zusammenfassung, Gliederungs Baukasten, Gutachten Uebung im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Fall Zusammenfassung, Gliederungs Baukasten, Gutachten Uebung prüfen.; Erstelle eine Arb... |
| `jurastudium-juristisches-schreiben-jus` | Nutze dies, wenn Jurastudium Anpassen, Juristisches Schreiben, Jus Klausurtraining Leitfaden im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Jurastudium Anpassen, Juristisches Schreiben, Jus Klausurtraining Leitfade... |
...
| `jurastudium-klausurkorrektur-lernplanung-red` | Nutze dies, wenn Spezial Jurastudium Mandantenkommunikation Entscheidungsvorlage, Spezial Klausurkorrektur Formular Portal Und Einreichung, Spezial Lernplanung Red Team Und Qualitaetskontrolle im Plugin Jurastudium konkret bearbeitet wer... |
| `jus-referendariat-jus-staatsexamen-jus` | Nutze dies, wenn Jus Referendariat Stationen Spezial, Jus Staatsexamen Vorbereitung Spezial, Jus Studienplan Bauleiter im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Jus Referendariat Stationen Spezial, Jus Staatse... |
| `karteikarten-lernplan-lernsitzung` | Nutze dies, wenn Karteikarten, Lernplan, Lernsitzung im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Karteikarten, Lernplan, Lernsitzung prüfen.; Erstelle eine Arbeitsfassung zu Karteikarten, Lernplan, Lernsitzung.;... |
| `lernstrategien-livecheck-sonderfall` | Nutze dies, wenn Spezial Lernstrategien Compliance Dokumentation Und Akte, Spezial Livecheck Sonderfall Und Edge Case, Spezial Loesungsschemata Mehrparteien Konflikt Und Interessen im Plugin Jurastudium konkret bearbeitet werden soll. Au... |
| `lernstrategien-loesungsschemata-methodenlehre` | Nutze dies, wenn Lernstrategien, Loesungsschemata, Methodenlehre Grundlagen im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Lernstrategien, Loesungsschemata, Methodenlehre Grundlagen prüfen.; Erstelle eine Arbeitsfa... |
| `methodenlehre-oeffentliches-strafrecht` | Nutze dies, wenn Methodenlehre Oeffentliches Recht, Methodenlehre Strafrecht, Methodenlehre Zivilrecht im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Methodenlehre Oeffentliches Recht, Methodenlehre Strafrecht, Met... |
| `methodenlehre-rechtsgeschichte-referendariat` | Nutze dies, wenn Spezial Methodenlehre Behörden Gericht Und Registerweg, Spezial Rechtsgeschichte Zahlen Schwellen Und Berechnung, Spezial Referendariat Tatbestand Beweis Und Belege im Plugin Jurastudium konkret bearbeitet werden soll. A... |
| `oeffentliches-quellenkarte` | Nutze dies, wenn Oeffentliches Quellenkarte im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `output-waehlen` | Nutze dies, wenn Output wählen im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Output wählen prüfen.; Erstelle eine Arbeitsfassung zu Output wählen.; Welche Normen und Nachweise brauche ich?. |
| `pruefungsgespraech` | Nutze dies, wenn Workflow Fristen Und Risikoampel, Workflow Redteam Qualitygate, Spezial Pruefungsgespraech Fristen Form Und Zustaendigkeit im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Was kann hier schiefgehen?; Bitte... |
| `pruefungsgespraech-ag-rechtsgeschichte` | Nutze dies, wenn Pruefungsgespraech Ag, Rechtsgeschichte, Spezial Gutachtenstil Internationaler Bezug Und Schnittstellen im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Pruefungsgespraech Ag, Rechtsgeschichte, Spezi... |
| `quellen-livecheck` | Nutze dies, wenn Rechtsquellen-Livecheck im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `rechtsquellen-beweislast-darlegungslast` | Nutze dies, wenn Rechtsquellen: Beweislast, Darlegungslast und Substantiierung im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen... |
| `strafrecht-studium-subsumtionslehre` | Nutze dies, wenn Spezial Strafrecht Verhandlung Vergleich Und Eskalation, Spezial Studium Erstpruefung Und Mandatsziel, Spezial Subsumtionslehre Risikoampel Und Gegenargumente im Plugin Jurastudium konkret bearbeitet werden soll. Auslöse... |
| `tatbestaende-lernen` | Nutze dies, wenn Tatbestaende Lernen im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Tatbestaende Lernen prüfen.; Erstelle eine Arbeitsfassung zu Tatbestaende Lernen.; Welche Normen und Nachweise brauche ich?. |
| `tradition-zivilrecht-subsumtionslehre` | Nutze dies, wenn Spezial Tradition Dokumentenmatrix Und Lueckenliste, Spezial Zivilrecht Schriftsatz Brief Und Memo Bausteine, Subsumtionslehre im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Bitte Spezial Tradition Dokum... |
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Jurastudium konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
