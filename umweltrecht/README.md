...
| Skill | Beschreibung |
| --- | --- |
| `abfall-anlagen-bimschg` | Abfall Anlagen Bimschg: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `boden-csddd-csrd-sonderfall` | Boden Csddd CSRD Sonderfall: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `diligence-greenwashing-beweislast-klimaklagen` | Diligence Greenwashing Beweislast Klimaklagen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `esg-greenwashing-klimaklagen-verbandsklage` | ESG Greenwashing Klimaklagen Verbandsklage: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `lieferkettensorgfalt-lksg-red-naturschutz` | Lieferkettensorgfalt Lksg RED Naturschutz: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `stoerfall-anlagen-transaktionen-dd` | Stoerfall Anlagen Transaktionen DD: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `tehg-verfahren-umweltrecht` | Tehg Verfahren Umweltrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `umwelt-umweltrecht-umwrg` | Umwelt Umweltrecht Umwrg: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `umweltrecht-bussgeld-emissionshandel-tehg-uwr` | Bussgeld Emissionshandel Tehg UWR: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `umweltrecht-immissionsschutz-bimschg` | Immissionsschutz Bimschg: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `umweltrecht-mandantenkommunikation-redteam-qualitygate-stoerfall` | Mandantenkommunikation Redteam Qualitygate Stoerfall: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `umweltrecht-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `umweltrecht-uwr-bundesnaturschutzgesetz-eingriff-co2` | UWR Bundesnaturschutzgesetz Eingriff CO2: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `uwr-wasserrechtliche` | UWR Wasserrechtliche: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
| `wasser-abfall-circular-umweltrecht-schulung` | Wasser Abfall Circular Umweltrecht Schulung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `wasser-bodenschutz-uwr-altlasten-bimschg` | Wasser Bodenschutz UWR Altlasten Bimschg: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
