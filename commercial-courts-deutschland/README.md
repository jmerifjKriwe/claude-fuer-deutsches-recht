...
| Skill | Beschreibung |
| --- | --- |
| `arbitration-clause-bea-erv` | Arbitration Clause Conflict Check, Bea Erv English Pleadings: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `bgh-english-bilingual-client` | Bgh English Proceedings 184b Gvg, Bilingual Client Board Briefing: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `bundle-index-case-management` | Bundle Index Electronic Filing, Case Management Conference: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `claim-intake-chamber-vs` | Claim Intake Fakten Und Exhibits, Commercial Chamber Vs Commercial Court: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `commercial-court-kaltstart-interview` | Kaltstart-Interview für neue Commercial-Court-Mandate: Parteien, Streitgegenstand, Streitwert, Gerichtsstands-/Sprachklausel, gewünschte Sprache, Unterlagen, Fristen, Output. |
...
| `confidentiality-trade-contract-interpretation` | Confidentiality Trade Secrets 273a Zpo, Contract Interpretation De En: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `costs-court-counterclaim-setoff` | Costs Court Fees Risk Budget, Counterclaim Setoff Claim Amendment: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `cross-border-default-judgment` | Cross Border Jurisdiction Brussels Ia, Default Judgment And Nonappearance: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `defence-answer-director-officer` | Defence Answer And Jurisdiction Objections, Director Officer Liability Dispute: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `document-production-earn-out` | Document Production 142 Zpo, Earn Out Accounting Dispute: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `enforcement-translation-english-legal` | Enforcement And Translation, English Legal Writing For German Courts: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `englische-verfahrenssprache-late-submissions` | Englische Verfahrenssprache 184a Gvg, Late Submissions 296 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `evidence-map-exhibits-translation` | Evidence Map Zpo Vs Common Law, Exhibits Translation 608 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `expert-evidence-finance-banking` | Expert Evidence German Court Expert, Finance Banking Dispute: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `forumwahl-court-glossary` | Forumwahl Commercial Court Vs Schiedsgericht, Glossary Commercial Court De En: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `governing-law-hearing-script` | Governing Law Rome I Ii, Hearing Script English Advocacy: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `interim-relief-issues-list` | Interim Relief Arrest Injunction, Issues List And Roadmap: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `judgment-publication-jurisdiction-clause` | Judgment Publication And Anonymisation, Jurisdiction Clause Drafting De En: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `klageschrift-english-limitation-tolling` | Klageschrift English Statement Of Claim, Limitation And Tolling Check: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `local-rules-mediation-settlement` | Local Rules And Court Guidelines, Mediation Settlement Window: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `post-ma-pre-litigation` | Post Ma Warranty Claim, Pre Litigation Notice And Standstill: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `procedural-calendar-protective-measures` | Procedural Calendar Timetable Order, Protective Measures Confidential Exhibits: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `public-hearing-appeal-revision` | Public Hearing And Press, Appeal And Revision 614 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `redteam-commercial-court-qualitygate` | Red-Team-Gate für alle Commercial-Court-Outputs: Zuständigkeit, Sprache, Fristen, Beweise, Übersetzungen, Geheimnisschutz, Kosten, Rechtsmittel. |
| `ruegelose-einlassung-service-abroad` | Ruegelose Einlassung Und Sprache, Service Abroad Hague Eu: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `settlement-court-shareholder-board` | Settlement Court Recorded Settlement, Shareholder Board Dispute: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `supply-chain-third-party` | Supply Chain International Sale Dispute, Third Party Notice 607 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `verbatim-transcript-video-hearing` | Verbatim Transcript 613 Zpo, Video Hearing 128a 284 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `witness-preparation-zustandigkeit-119b` | Witness Preparation English Zpo, Zustandigkeit 119b Gvg Check: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
