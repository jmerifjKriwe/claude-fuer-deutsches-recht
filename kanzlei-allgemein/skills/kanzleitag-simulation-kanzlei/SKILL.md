...
description: "Kanzleitag Simulation Kanzlei im Plugin Kanzlei Allgemein: prüft konkret Führt im Simulationsmodus durch einen achtstuendigen, Schnellstart und Command Center für Kanzlei-Allgemein-Plugin. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Kanzleitag Simulation Kanzlei** als zusammenhängenden Arbeitsgang im Plugin Kanzlei Allgemein. Im Mittelpunkt steht die Prüfung von Führt im Simulationsmodus durch einen achtstuendigen, Schnellstart und Command Center für Kanzlei-Allgemein-Plugin. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
