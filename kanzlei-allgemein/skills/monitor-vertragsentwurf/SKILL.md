...
description: "Monitor Vertragsentwurf im Plugin Kanzlei Allgemein: prüft konkret Scannt Akteninhalt auf Fristen Action-Items Wiedervorlagen, Erstellt Vertragsentwuerfe aus Term Sheet Mandantenangaben. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Monitor Vertragsentwurf** als zusammenhängenden Arbeitsgang im Plugin Kanzlei Allgemein. Im Mittelpunkt steht die Prüfung von Scannt Akteninhalt auf Fristen Action-Items Wiedervorlagen, Erstellt Vertragsentwuerfe aus Term Sheet Mandantenangaben. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
