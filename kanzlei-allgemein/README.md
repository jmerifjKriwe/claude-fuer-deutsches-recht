...
| Skill | Beschreibung |
| --- | --- |
| `akte-anlegen-und-aktenzeichen-zuordnen` | Akte Anlegen und Aktenzeichen Zuordnen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aktenbestand-pflege-bea-versand` | Aktenbestand Pflege BEA Versand: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `buchhaltung-konten-kanzlei-erechnung` | Buchhaltung Konten Kanzlei Erechnung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `freundlicher-copilot-kanzlei` | Freundlicher Copilot Kanzlei: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `geburtstage-feiertage-abwesenheiten-urlaub` | Geburtstage Feiertage Abwesenheiten Urlaub: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hr-personal-kanzlei-intake` | HR Personal Kanzlei Intake: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `integrationen-simulation-kanzlei` | Integrationen Simulation Kanzlei: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `kanzlei-automationen-bea-journal` | Automationen BEA Journal: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `kanzlei-rechtsprechungsrecherche-fristenbuch` | Rechtsprechungsrecherche Fristenbuch: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kanzleitag-simulation-kanzlei` | Kanzleitag Simulation Kanzlei: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ki-arbeitsauftrag-mahnwesen-honorar` | KI Arbeitsauftrag Mahnwesen Honorar: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `lohn-sv-kanzlei-rechnung` | Lohn SV Kanzlei Rechnung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `look-feel-mandatsannahme-gwg` | Look Feel Mandatsannahme GWG: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandantenakte-anlegen-mandantenbrief-vorlagen` | Mandantenakte Anlegen Mandantenbrief Vorlagen: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandatsvereinbarung-postlauf` | Mandatsvereinbarung Postlauf: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `monitor-vertragsentwurf` | Monitor Vertragsentwurf: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `posteingang-ausgang-sekretariats-tagesbrief` | Posteingang Ausgang Sekretariats Tagesbrief: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `qualitaetsgate-hardening-kanzlei` | Qualitaetsgate Hardening Kanzlei: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `timesheet-aktenzeitung-umgang-ki` | Timesheet Aktenzeitung Umgang KI: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `turbo-zeitnarrative` | Turbo Zeitnarrative: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ustva-buchhaltung-simulation` | Ustva Buchhaltung Simulation: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `versand-check-weihnachtskarten` | Versand Check Weihnachtskarten: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
