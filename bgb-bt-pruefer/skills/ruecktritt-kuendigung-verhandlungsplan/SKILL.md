...
description: "Ruecktritt Kuendigung Verhandlungsplan im Plugin Bgb Bt Pruefer: prüft konkret Fristen, Rücktritt und Kündigung im BGB BT, Vergleich und Verhandlungsplan im BGB BT, Prüft Fristen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Ruecktritt Kuendigung Verhandlungsplan** als zusammenhängenden Arbeitsgang im Plugin Bgb Bt Pruefer. Im Mittelpunkt steht die Prüfung von Fristen, Rücktritt und Kündigung im BGB BT, Vergleich und Verhandlungsplan im BGB BT. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
