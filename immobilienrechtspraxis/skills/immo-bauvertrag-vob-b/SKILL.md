---
name: immo-bauvertrag-vob-b
description: "Bauvertrag nach VOB-B oder BGB §§ 650a ff. BGB: Wahl Recht, Abnahme, Maengelrechte, Sicherheiten, Vergutung Stundenlohnarbeiten, Nachtraege. Pruefraster fuer beide Vertragstypen."
---

# Bauvertrag VOB-B / BGB

## Aufgabe
Bauvertrag nach VOB-B oder BGB §§ 650a ff.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `immobilienrechtspraxis` zum Thema `immo-bauvertrag-vob-b`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Bauvertrag nach VOB-B oder BGB §§ 650a ff. BGB: Wahl Recht, Abnahme, Maengelrechte, Sicherheiten, Vergutung Stundenlohnarbeiten, Nachtraege. Pruefraster fuer beide Vertragstypen..
