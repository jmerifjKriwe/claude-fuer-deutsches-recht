...
| Skill | Beschreibung |
| --- | --- |
| `130a-zpo-fax-grenzen-mein-justizpostfach` | Einreichung 130a Zpo Elektronisch Buerger, Einreichung Fax Und Grenzen, Einreichung Mein Justizpostfach Mjp 2024: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
| `anfaenger-amtsgericht-rechtsprechungschat` | Anfaenger Amtsgericht, Rechtsprechungschat Amtsgericht, Fristbeginn Zustellung Protokollieren, Skill: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `anspruchsgrundlage-finden-anwaltszwang-zpo` | Anspruchsgrundlage Finden Laienhilfe, Anwaltszwang Prüfen 78 Zpo, Augenscheinsbeweis 371 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `ausnahmen-streitwertgrenze-aussergerichtliche` | Ausnahmen Streitwertgrenze 23 Nr 2 Gvg, Aussergerichtliche Mahnung 286 Bgb, Beratungshilfe Aussergerichtlich Brh: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
...
| `berechnen-bgb-buch-fuehren-fristverlaengerung` | Fristen Berechnen 187 188 Bgb, Fristen Buch Fuehren Laien, Fristverlaengerung Antrag 225 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `berufung-zpo-berufungs-zulassung-beweislast` | Berufung Amtsgericht 511 Zpo, Berufungs Zulassung Niedrig Streitwert, Beweislast Grundregel Wer Was: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `beweismittel-vorab-dokumenten-erzeugung` | Beweismittel Vorab Sammeln Checkliste, Dokumenten Erzeugung Pdf Laien Amtsgericht, Dolmetscher 185 Gvg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `duplik-eidesstattliche-versicherung-einreden` | Duplik Nach Replik, Eidesstattliche Versicherung 294 Zpo, Einreden Aktiv Geltend Machen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `kein-folgen-klage-streitwert-zusammenstellen` | Kein Beweis Folgen Laienwarnung, Klage Streitwert Angabe 3 Zpo, Klage Zusammenstellen Komplettes Bundle Amtsgericht: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbar... |
...
| `klage-vereinfachtes-klageerwiderung-zpo` | Klage Vereinfachtes Verfahren 495a Zpo, Klageerwiderung Fristen 274 Zpo, Mahnverfahren 688 Ff Zpo Vor Klage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `klageerwiderung-checkliste-replik-anlagen` | Klageerwiderung Checkliste Alle Punkte, Klageerwiderung Replik Anlagen B1 B2 Fortlaufend, Klageschrift Anlagen Bezeichnen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten bel... |
...
| `klageschrift-anschreiben-an-antrag-bestimmt` | Klageschrift Anschreiben An Gericht Laien, Klageschrift Antrag Bestimmt Formulieren, Klageschrift Beweisangebote Einbauen 373 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den näch... |
...
| `klageschrift-pflichtbestandteile` | Klageschrift Pflichtbestandteile 253 Zpo, Klageschrift Tatsachenvortrag Strukturieren, Kostenfestsetzung 103 104 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastba... |
...
| `kostenrisiko-streitwert-ladung-termin` | Kostenrisiko Streitwert Berechnen Gkg, Ladung Termin 216 Zpo, Muendliche Verhandlung Akten Griffbereit: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `nachgereichter-296a-orientierung` | Nachgereichter Schriftsatz 296a Zpo, Orientierung Selbstvertreter Amtsgericht, Parteivernehmung 445 Ff Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `oertliche-zpo-online-verfahren` | Oertliche Zustaendigkeit 12 37 Zpo, Online Verfahren 11 Buch Zpo Experimentell, Rechtsmittelfrist 517 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `pkh-bewilligung-ratenzahlung` | Pkh Bewilligung Ablehnung Folgen, Pkh Ratenzahlung Bewilligung, Prozesskostenhilfe Pkh 114 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `rechtsantragsstelle-selbst-gegnerische` | Einreichung Rechtsantragsstelle Selbst, Gegnerische Vollstreckung Abwehr, Gerichtskostenvorschuss 12 Gkg: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `replik-klageerwiderung-richterlicher-hinweis` | Replik Auf Klageerwiderung Systematik, Richterlicher Hinweis 139 Zpo Reaktion, Sachverstaendigenbeweis 402 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Ou... |
...
| `richtervorschlag-ii-verhalten-gerichtssaal` | Vergleich Richtervorschlag 278 Ii Zpo, Verhalten Gerichtssaal Laienleitfaden, Video Verhandlung 128a Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `sachliche-gvg-verjaehrungsfrist-bgb` | Sachliche Zustaendigkeit Amtsgericht 23 Gvg, Verjaehrungsfrist Prüfen 195 Bgb, Wiedereinsetzung Frist 233 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Out... |
...
| `saeumnis-termin-vermeiden-sanity-check` | Saeumnis Im Termin 330 Zpo, Saeumnis Vermeiden 330 Ff Zpo, Sanity Check Selbstvertretung Amtsgericht, Zulassungsgrenzen Check Amtsgericht: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert... |
...
| `selbstvertreter-amtsgericht-kaltstart-triage` | Einstieg, Schnelltriage und Fallrouting im Selbstvertreter-Amtsgericht-Plugin. Fragt Erfahrungslevel, Rolle, Ziel, Fristen, Streitwert, Gericht, Unterlagen, Risiken und Wunsch-Output ab, schlägt passende Fachmodule aus diesem Plugin vor... |
...
| `substantiiertes-bestreiten-zerlegen` | Substantiiertes Bestreiten 138 Iv Zpo, Tatbestand Zerlegen Anspruchspruefung Laien, Terminvorbereitung Checkliste: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
...
| `typische-laien-urkundenbeweis-ff-urteil-zpo` | Typische Laien Fehler, Urkundenbeweis 415 Ff Zpo, Urteil Prüfen 313 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `urteil-rechtskraft-urteilsverkuendung-zpo` | Urteil Rechtskraft 705 Zpo, Urteilsverkuendung 310 Zpo, Verbrauchergerichtsstand 29c Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `vollstreckungsklausel-zpo-papierform` | Vollstreckungsklausel 724 Zpo, Einreichung Papierform Mit Abschriften, Anlagen Formatieren K1 K2 Pdf Amtsgericht: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren... |
...
| `vorabklaerung-erfolgsaussichten-wann-doch` | Vorabklaerung Erfolgsaussichten Selbstcheck, Wann Doch Anwalt Grenzfaelle, Widerklage 33 Zpo: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `zeugenbeweis-ff-zulassungsgrenzen-check` | Zeugenbeweis 373 Ff Zpo, Zulassungsgrenzen Check Amtsgericht, Zurechnungsproblem Versand Durch Dritte: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `zwangsvollstreckung-querverweis` | Zwangsvollstreckung Querverweis Substitutionsagent: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
