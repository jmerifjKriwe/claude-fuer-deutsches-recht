...
description: "Alleinvertrieb Kundengruppen Alternative im Kartellrecht (Marktabgrenzung): prüft konkret Alleinvertrieb Kundengruppen Gebietsschutz, Mandant will eine engere Marktabgrenzung argumentieren um, Mandant will eine weitere Marktabgrenzung argumentieren um, Anmeldepflicht Joint Venture. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**Alleinvertrieb Kundengruppen Alternative** ordnet den Fall über die tragenden Prüffelder: Alleinvertrieb Kundengruppen Gebietsschutz, Mandant will eine engere Marktabgrenzung argumentieren um, Mandant will eine weitere Marktabgrenzung argumentieren um. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
