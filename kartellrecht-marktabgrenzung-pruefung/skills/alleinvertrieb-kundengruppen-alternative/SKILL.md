...
Dieser Skill behandelt **Alleinvertrieb Kundengruppen Alternative** als zusammenhängenden Arbeitsgang im Kartellrecht (Marktabgrenzung). Im Mittelpunkt steht die Prüfung von Alleinvertrieb Kundengruppen Gebietsschutz, Mandant will eine engere Marktabgrenzung argumentieren um, Mandant will eine weitere Marktabgrenzung argumentieren um und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
