...
description: "Private Enforcement Rechtsabteilung im Kartellrecht (Marktabgrenzung): prüft konkret zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Private Enforcem, Rechtsabteilungs-Fachmodul für Kartellschadenersatz nach, Sammelklagen Abtretungsmodelle Kartellschaden. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Private Enforcement Rechtsabteilung** als zusammenhängenden Arbeitsgang im Kartellrecht (Marktabgrenzung). Im Mittelpunkt steht die Prüfung von zur strukturierten Aufnahme, Priorisierung und Ausgabe im Thema Private Enforcem, Rechtsabteilungs-Fachmodul für Kartellschadenersatz nach und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
