# _GERICHTE_EXPERIMENTAL — Legal-AI-Plugins fuer Gerichte

> **Experimentelle Plugin-Sammlung fuer den moeglichen Einsatz von KI an deutschen Gerichten.**
...
| Plugin | Rolle |
|---|---|
| `richter-amtsgericht-zivil` | Amtsrichter:in in Zivilsachen (Streitwert bis 5.000 Euro, sonstige Zustaendigkeiten nach Paragraf 23 GVG) |
| `richter-amtsgericht-straf` | Strafrichter:in oder Schoeffengericht am Amtsgericht (Paragraf 24 GVG, Paragraf 25 GVG, Paragrafen 28-30 GVG) |
...
| `richter-amtsgericht-handelsregister` | Registerrichter:in oder Rechtspfleger:in fuer Handelsregister, Genossenschaftsregister, Partnerschaftsregister, Vereinsregister |
| `richter-landgericht-zivilkammer` | Vorsitzende:r oder Berichterstatter:in einer Zivilkammer (Paragraf 71 GVG, Streitwert ab 5.001 Euro; auch sonstige Zustaendigkeiten Paragrafen 71-74 GVG) sowie zweite Instanz Berufung Paragraf 511 ZPO |
| `richter-landgericht-strafkammer` | Vorsitzende:r oder Berichterstatter:in einer grossen oder kleinen Strafkammer (Paragraf 74 GVG, Paragraf 76 GVG); Schwurgericht Paragraf 74 Abs. 2 GVG |
...
| `richter-familiengericht` | Familienrichter:in am Amtsgericht (Paragraf 23a Abs. 1 Nr. 1 GVG i.V.m. Paragraf 23b GVG) fuer Ehe-, Kindschafts-, Unterhalts-, Versorgungsausgleichs-, Gewaltschutz- und sonstige Familiensachen nach FamFG |
...
| `relationstechnik-zivilrecht` | Jede:r Zivilrechtler:in (Richter, Referendar, Anwalt) der eine grosse Relation aufbauen will |
...
- `README.md` — Plugin-Beschreibung mit vollstaendigem Vorspruch
- `MEGAPROMPT.md` — vollstaendiger Arbeits-Prompt, portabel
