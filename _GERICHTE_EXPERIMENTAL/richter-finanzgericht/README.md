...
- **01-zulaessigkeit-finanzgerichtsklage** — Zulaessigkeit der Klage Paragrafen 40-65 FGO: Klagearten (Anfechtung Verpflichtung Feststellung Untaetigkeit), Vorverfah
...
- **04-steuerbescheid-pruefen** — Pruefung des angegriffenen Steuerbescheids: formelle Rechtmaessigkeit (Begruendung Paragraf 121 AO, Bekanntgabe Paragraf
- **05-est-pruefungsschema** — Einkommensteuer-Pruefung: Einkunftsart, Einkunftsermittlung (Paragrafen 4, 5 EStG oder Paragraf 11 EStG), Sonderausgaben
...
- **07-koerperschaft-und-gewerbesteuer** — Koerperschaftsteuer: Subjektsteuerpflicht Paragraf 1 KStG, Einkommensermittlung Paragraf 8 KStG i.V.m. EStG, verdeckte G
...
- **09-urteil-finanzgericht-und-revision** — Urteil Paragraf 105 FGO: Tatbestand, Entscheidungsgruende, Tenor; Revision Paragraf 115 FGO an BFH (grundsaetzliche Bede
- **10-entscheidungsvorschlag-finanzgericht** — Strukturierter Entscheidungsvorschlag: Tenor, Pruefungsschema Zulaessigkeit Begruendetheit, materielle Pruefung der Steu
