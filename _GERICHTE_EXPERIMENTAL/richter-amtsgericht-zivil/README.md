...
- **01-eingangspruefung-zustaendigkeit** — Pruefung Zustaendigkeit (Paragraf 23 GVG sachlich, Paragrafen 12 ff. ZPO oertlich), Klagezustellung, Pflichtangaben Para
- **02-streitwert-und-gerichtskosten** — Streitwertbestimmung Paragrafen 3-9 ZPO, GKG-Anlage 1 (KV 1210, 1211, 1220), vorlaeufige Streitwertfestsetzung, GKG-Vors
...
- **04-relation-zivilrecht-klein** — Echte Relation: Klaegerstation (Schluessigkeit der Anspruchsgrundlage), Beklagtenstation (Erheblichkeit der Einwendungen
- **05-beweisaufnahme-kleine-zivilkammer** — Beweisbeschluss formulieren (Paragrafen 358-360 ZPO), Zeugenladung, Sachverstaendigenauswahl, Beweistermin protokolliere
- **06-tenor-und-kostenentscheidung** — Tenor formulieren (Hauptsache, Nebenforderungen, Zinsen, Kosten Paragraf 91 ZPO, vorlaeufige Vollstreckbarkeit Paragrafe
- **07-urteilsentwurf-paragraf-313** — Urteilsentwurf nach Paragraf 313 ZPO: Rubrum, Tenor, Tatbestand (gestraffter Vortrag), Entscheidungsgruende (Begruendeth
...
- **10-entscheidungsvorschlag-zur-richterlichen-pruefung** — Strukturierter Entscheidungsvorschlag fuer den Richter: Tenor-Vorschlag, tragende Gruende in Stichpunkten, Risikohinweis
