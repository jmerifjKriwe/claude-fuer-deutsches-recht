...
Dieser Skill behandelt **Expansion Auftakt Fehlzeit Erfassen** als zusammenhängenden Arbeitsgang im Plugin Arbeitsrecht. Im Mittelpunkt steht die Prüfung von Startet die Planung einer Neueinstellung in einem weiteren, Neue Abwesenheit oder neuen Urlaubseintrag im Register, Überprüft offene Abwesenheiten und Fristen – und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
