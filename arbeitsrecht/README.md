...
| Skill | Beschreibung |
| --- | --- |
| `arbeitsrecht-arbeitnehmer-status-problem` | Arbeitnehmer Status Problem: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `bag-equal-mindesturlaub-kein-betriebsrat` | BAG Equal Mindesturlaub Kein Betriebsrat: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `betriebsrat-ladung-betriebsuebergang-613a` | Betriebsrat Ladung Betriebsuebergang 613a: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `entfristung-klageschrift-anwalt-laie` | Entfristung Klageschrift Anwalt Laie: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `entfristung-kueschk-anwendbarkeit` | Entfristung Kueschk Anwendbarkeit: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `entfristung-sachgrund-abs-sachgrundlos` | Entfristung Sachgrund ABS Sachgrundlos: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `entfristung-schriftform-abs-triage-was` | Entfristung Schriftform ABS Triage WAS: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `expansion-auftakt-fehlzeit-erfassen` | Expansion Auftakt Fehlzeit Erfassen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `faktenbank-untersuchung-abfrage-ergaenzen` | Faktenbank Untersuchung Abfrage Ergaenzen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hinschg-whistleblower-interne-untersuchung` | Hinschg Whistleblower Interne Untersuchung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kueschk-allgemeiner-besonderer` | Kueschk Allgemeiner Besonderer: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kueschk-annahmeverzug-lohnsteuer` | Kueschk Annahmeverzug Lohnsteuer: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kueschk-formfehler-guetetermin-strategie` | Kueschk Formfehler Guetetermin Strategie: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kueschk-klageschrift-laie-kuendigungsgrund` | Kueschk Klageschrift Laie Kuendigungsgrund: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `kueschk-replik-arbeitnehmer` | Kueschk Replik Arbeitnehmer: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kueschk-triage-laie-vergleichsverhandlung` | Kueschk Triage Laie Vergleichsverhandlung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `lohn-arbeitszeit-mandat-triage` | Lohn Arbeitszeit Mandat Triage: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `richtlinien-entwurf-kueschk-grundwarnung` | Richtlinien Entwurf Kueschk Grundwarnung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `untersuchungs-zusammenfassung-kuendigung` | Untersuchungs Zusammenfassung Kuendigung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zugang-einwurf-einschreiben-bote-liest` | Zugang Einwurf Einschreiben Bote Liest: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zugang-kuendigung-mehrfachzustellung` | Zugang Kuendigung Mehrfachzustellung: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zugang-kuendigungsschutzklage` | Zugang Kuendigungsschutzklage: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
