...
Dieser Skill behandelt **Bericht Hinweisgeberschutz Jahresreport Idev** als zusammenhängenden Arbeitsgang im Berichtspflichten-Praxis. Im Mittelpunkt steht die Prüfung von Hinweisgeberstelle, Elektronische Statistikmeldungen über IDEV/eSTATISTIK.core, Gebäudeenergie. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
