...
description: "Bericht Aussenhandel Intrastat Battg im Berichtspflichten-Praxis: prüft konkret Intrastat/Außenhandelsstatistik, Batterierecht, Baustatistik und Bauunterlagen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Bericht Aussenhandel Intrastat Battg** als zusammenhängenden Arbeitsgang im Berichtspflichten-Praxis. Im Mittelpunkt steht die Prüfung von Intrastat/Außenhandelsstatistik, Batterierecht, Baustatistik und Bauunterlagen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
