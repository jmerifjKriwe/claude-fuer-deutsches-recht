...
| `anwaltliche-ki-art-kompetenz-automatisierte` | Anwaltliche KI ART Kompetenz Automatisierte: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `betreiber-deployer-bevollmaechtigter` | Betreiber Deployer Bevollmaechtigter: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `einfuehrer-importer-eu-datenbank-fallfremde` | Einfuehrer Importer EU Datenbank Fallfremde: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `entscheidungsbaum-gesamt-owi-verfahren` | Entscheidungsbaum Gesamt OWI Verfahren: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gerichtliche-ki-governance-aufsichtsbehoerden` | Gerichtliche KI Governance Aufsichtsbehoerden: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gpai-systemisches-risiko-urheberrecht-policy` | Gpai Systemisches Risiko Urheberrecht Policy: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `haendler-distributor-harmonisierte-normen` | Haendler Distributor Harmonisierte Normen: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `hochrisiko-art-abs-aufzeichnungspflichten` | Hochrisiko ART ABS Aufzeichnungspflichten: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `hochrisiko-genauigkeit-konformitaetsbewertung` | Hochrisiko Genauigkeit Konformitaetsbewertung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `hochrisiko-transparenz-zuordnung-art` | Hochrisiko Transparenz Zuordnung ART: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `kanzlei-outsourcing-zivilprozess-rollen-liegt` | Kanzlei Outsourcing Zivilprozess Rollen Liegt: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ki-kunst-abgrenzung-konventionelle` | Kunst Abgrenzung Konventionelle: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `marktaufsicht-behoerdenkommunikation` | Marktaufsicht Behoerdenkommunikation: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `persoenlicher-anwendungsbereich-polizeiliche` | Persoenlicher Anwendungsbereich Polizeiliche: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `rechtsabteilung-hr-ai-ki` | Rechtsabteilung HR AI KI: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `risikoklassen-uebersicht-rolle-anbieter` | Risikoklassen Uebersicht Rolle Anbieter: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `sachlicher-ausschluss-schwerwiegender-vorfall` | Sachlicher Ausschluss Schwerwiegender Vorfall: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `sanktionen-art-bussgeldverteidigung-bildung` | Sanktionen ART Bussgeldverteidigung Bildung: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `strafverfolgung-beweisbewertung-territorialer` | Strafverfolgung Beweisbewertung Territorialer: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `triage-ki-vendor-due-verbotene-praktiken` | Triage KI Vendor DUE Verbotene Praktiken: bündelt 4 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `wettbewerb-flaschenhaelse` | Wettbewerb Flaschenhaelse: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
