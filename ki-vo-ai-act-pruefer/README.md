...
| `anwaltliche-ki-art-kompetenz-automatisierte` | Anwaltliche KI ART Kompetenz Automatisierte im EU KI-VO (AI Act): prüft konkret Anwaltliche KI-Nutzung ohne Halluzinationsschaden, Art, Schnittstelle KI-VO und DSGVO Art, Unternehmen setzt Chatbot Deepfake-Tool oder. Liefert priorisierte... |
...
| `betreiber-deployer-bevollmaechtigter` | Betreiber Deployer Bevollmaechtigter im EU KI-VO (AI Act): prüft konkret Unternehmen oder Behoerde setzt ein Hochrisiko-KI-System, GPAI-System oder allge, Drittstaaten-Anbieter ohne EU-Niederlassung oder, Biometrie. Liefert priorisierten... |
...
| `einfuehrer-importer-eu-datenbank-fallfremde` | Einfuehrer Importer EU Datenbank Fallfremde im EU KI-VO (AI Act): prüft konkret Importeur von KI-Systemen aus Drittstaaten fragt, Anbieter oder Betreiber von Hochrisiko-KI fragt, Fallfremde KI-Textbausteine erkennen und entschärfen, Nutz... |
...
| `entscheidungsbaum-gesamt-owi-verfahren` | Entscheidungsbaum Gesamt OWI Verfahren im EU KI-VO (AI Act): prüft konkret Master-fuer die vollstaendige KI-VO-Pruefung, KI-VO-Ordnungswidrigkeiten und interne Untersuchung, Compliance-Beauftragter oder Unternehmen fragt, Vertragsmatrix... |
...
| `gerichtliche-ki-governance-aufsichtsbehoerden` | Gerichtliche KI Governance Aufsichtsbehoerden im EU KI-VO (AI Act): prüft konkret Justizielle KI als Hochrisiko-Kontext, Unternehmen oder Behoerde fragt, GPAI Code of Practice und Evidence-Logik, Entwickler oder Anbieter eines Sprachmode... |
...
| `gpai-systemisches-risiko-urheberrecht-policy` | Gpai Systemisches Risiko Urheberrecht Policy im EU KI-VO (AI Act): prüft konkret Anbieter eines sehr grossen Basismodells fragt, GPAI-Urheberrechtspflichten nach Art, Prueft, ob ein Modell oder Dienst ein General-Purpose-AI-Modell. Liefe... |
...
| `haendler-distributor-harmonisierte-normen` | Haendler Distributor Harmonisierte Normen im EU KI-VO (AI Act): prüft konkret Distributeur oder Grosshaendler von KI-Systemen fragt, Harmonisierte Normen, gemeinsame Spezifikationen und ISO/IEC-Standards im KI-VO-, Negativvermerk zur Hoc... |
...
| `hochrisiko-art-abs-aufzeichnungspflichten` | Hochrisiko ART ABS Aufzeichnungspflichten im EU KI-VO (AI Act): prüft konkret Vertiefter Hochrisiko-Checker fuer Art, Anbieter von Hochrisiko-KI fragt, Anbieter hat Hochrisiko-Einstufung des eigenen KI-Systems. Liefert priorisierten Outp... |
...
| `hochrisiko-genauigkeit-konformitaetsbewertung` | Hochrisiko Genauigkeit Konformitaetsbewertung im EU KI-VO (AI Act): prüft konkret Anbieter von Hochrisiko-KI fragt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `hochrisiko-transparenz-zuordnung-art` | Hochrisiko Transparenz Zuordnung ART im EU KI-VO (AI Act): prüft konkret Anbieter von Hochrisiko-KI fragt, Gesamtuebersicht zur Hochrisiko-Zuordnung nach Art, KI-Detektoren in Schule, Hochschule und Auswahlverfahren. Liefert priorisierte... |
...
| `kanzlei-outsourcing-zivilprozess-rollen-liegt` | Kanzlei Outsourcing Zivilprozess Rollen Liegt im EU KI-VO (AI Act): prüft konkret KI-Outsourcing fuer Kanzleien und Rechtsabteilungen, KI im Zivilprozess, Erster Schritt jeder KI-VO-Pruefung, Mechanik-erkennt Anzeichen von Faellen die an... |
...
| `ki-kunst-abgrenzung-konventionelle` | Kunst Abgrenzung Konventionelle im EU KI-VO (AI Act): prüft konkret KI-Kunst, Werbung und Design, Grenzfall-Skill zur Abgrenzung konventioneller Software, Automation. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächs... |
...
| `ki-vo-mechanik-erstpruefung-rollenklaerung-mandatsziel` | Mechanik: Erstprüfung, Rollenklärung und Mandatsziel im EU KI-VO (AI Act): 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwell... |
...
| `marktaufsicht-behoerdenkommunikation` | Marktaufsicht Behoerdenkommunikation im EU KI-VO (AI Act): prüft konkret Marktaufsicht und Behoerdenkommunikation, Anbieter oder Betreiber hat einen schwerwiegenden Vorfall, Prüfung hat ergeben, Notariat. Liefert priorisierten Output mit... |
...
| `persoenlicher-anwendungsbereich-polizeiliche` | Persoenlicher Anwendungsbereich Polizeiliche im EU KI-VO (AI Act): prüft konkret Erster Schritt der KI-VO-Prüfung, Polizeiliche KI-Anwendungen, KI-Beschaffung der oeffentlichen Hand, Rechtsabteilungs-Fachmodul für General Purpose AI im.... |
...
| `rechtsabteilung-hr-ai-ki` | Rechtsabteilung HR AI KI im EU KI-VO (AI Act): prüft konkret Rechtsabteilungs-Fachmodul für HR-AI als Hochrisikosystem, Rechtsabteilungs-Fachmodul für KI-Konformitätsbescheinigung, Rechtsabteilungs-Fachmodul für Kreditwürdigkeits-KI nach... |
...
| `risikoklassen-uebersicht-rolle-anbieter` | Risikoklassen Uebersicht Rolle Anbieter im EU KI-VO (AI Act): prüft konkret Schnelle Risikoklassen-Triage nach KI-VO mit Fokus auf Art, Unternehmen das Software oder KI entwickelt fragt, Unternehmen kauft oder lizenziert ein KI-System vo... |
...
| `sachlicher-ausschluss-schwerwiegender-vorfall` | Sachlicher Ausschluss Schwerwiegender Vorfall im EU KI-VO (AI Act): prüft konkret Unternehmen fragt, Schwerwiegender KI-Vorfall nach Art, Shadow-AI und Off-label-Nutzung beherrschen, Mechanik. Liefert priorisierten Output mit Norm-Pinpoi... |
...
| `sanktionen-art-bussgeldverteidigung-bildung` | Sanktionen ART Bussgeldverteidigung Bildung im EU KI-VO (AI Act): prüft konkret Unternehmen moechte die Kostenrisiken einer, Art, Anhang III KI-VO fuer Bildung, Pruefung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und n... |
...
| `strafverfolgung-beweisbewertung-territorialer` | Strafverfolgung Beweisbewertung Territorialer im EU KI-VO (AI Act): prüft konkret KI in Strafverfolgung und Beweisbewertung, Nicht-EU-Unternehmen oder Exporteur fragt, Training generativer Modelle mit Text, Bild. Liefert priorisierten Ou... |
...
| `triage-ki-vendor-due-verbotene-praktiken` | Triage KI Vendor DUE Verbotene Praktiken im EU KI-VO (AI Act): prüft konkret Nutzer kommt mit unklarer KI-VO-Frage oder möglicherweise, KI-Beschaffung und Vendor Due Diligence, Unternehmen prüft ob ein KI-Einsatz in den Bereich der, Anwa... |
...
| `wettbewerb-flaschenhaelse` | Wettbewerb Flaschenhaelse im EU KI-VO (AI Act): fachlicher Arbeitsgang mit Prüffeldwahl, Norm-/Quellencheck, Risikoampel und verwertbarem Output. |
