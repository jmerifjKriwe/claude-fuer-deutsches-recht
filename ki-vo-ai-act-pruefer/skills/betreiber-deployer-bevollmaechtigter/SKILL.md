...
**Betreiber Deployer Bevollmaechtigter** ordnet den Fall über die tragenden Prüffelder: Unternehmen oder Behoerde setzt ein Hochrisiko-KI-System, GPAI-System oder allge, Drittstaaten-Anbieter ohne EU-Niederlassung oder. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
