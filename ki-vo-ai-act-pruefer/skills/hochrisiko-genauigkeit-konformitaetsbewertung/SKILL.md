...
description: "Hochrisiko Genauigkeit Konformitaetsbewertung im EU KI-VO (AI Act): prüft konkret Anbieter von Hochrisiko-KI fragt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**Hochrisiko Genauigkeit Konformitaetsbewertung** ordnet den Fall über die tragenden Prüffelder: Anbieter von Hochrisiko-KI fragt. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
