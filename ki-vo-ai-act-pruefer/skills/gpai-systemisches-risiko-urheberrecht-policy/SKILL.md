...
description: "Gpai Systemisches Risiko Urheberrecht Policy im EU KI-VO (AI Act): prüft konkret Anbieter eines sehr grossen Basismodells fragt, GPAI-Urheberrechtspflichten nach Art, Prueft, ob ein Modell oder Dienst ein General-Purpose-AI-Modell. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Gpai Systemisches Risiko Urheberrecht Policy** als zusammenhängenden Arbeitsgang im EU KI-VO (AI Act). Im Mittelpunkt steht die Prüfung von Anbieter eines sehr grossen Basismodells fragt, GPAI-Urheberrechtspflichten nach Art, Prueft und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
