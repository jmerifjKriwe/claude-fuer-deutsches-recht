...
description: "Triage KI Vendor DUE Verbotene Praktiken im EU KI-VO (AI Act): prüft konkret Nutzer kommt mit unklarer KI-VO-Frage oder möglicherweise, KI-Beschaffung und Vendor Due Diligence, Unternehmen prüft ob ein KI-Einsatz in den Bereich der, Anwalt oder Compliance-Beauftragter fragt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**Triage KI Vendor DUE Verbotene Praktiken** ordnet den Fall über die tragenden Prüffelder: Nutzer kommt mit unklarer KI-VO-Frage oder möglicherweise, KI-Beschaffung und Vendor Due Diligence, Unternehmen prüft ob ein KI-Einsatz in den Bereich der. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
