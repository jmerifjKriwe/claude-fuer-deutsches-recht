...
description: "Registerrecht Aktiengesellschaft Vorstand im Handelsregister-Praxis: prüft konkret Prüft Bestellung, Vertretung, Satzungsänderungen, Kapitalmaßnahmen und Eintragun. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Registerrecht Aktiengesellschaft Vorstand** als zusammenhängenden Arbeitsgang im Handelsregister-Praxis. Im Mittelpunkt steht die Prüfung von Prüft Bestellung, Vertretung, Satzungsänderungen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
