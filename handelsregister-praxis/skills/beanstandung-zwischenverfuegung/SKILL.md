...
description: "Beanstandung Zwischenverfuegung im Handelsregister-Praxis: prüft konkret Analysiert Registerbeanstandungen, trennt behebbare Formmängel von Rechtsstreit, Erstellt Monitoringplan für Bekanntmachungen, Friststart. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Beanstandung Zwischenverfuegung** als zusammenhängenden Arbeitsgang im Handelsregister-Praxis. Im Mittelpunkt steht die Prüfung von Analysiert Registerbeanstandungen, trennt behebbare Formmängel von Rechtsstreit, Erstellt Monitoringplan für Bekanntmachungen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
