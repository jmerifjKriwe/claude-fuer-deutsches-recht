...
| Skill | Beschreibung |
| --- | --- |
| `anspruchsformulierungen-formverstoss` | Anspruchsformulierungen Formverstoss: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `arbeitsrecht-befristung-schriftform-checker` | Arbeitsrecht Befristung Schriftform Checker: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `befristungsabrede-qes-rechtsprechung` | Befristungsabrede QES Rechtsprechung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `elektronische-paragraph-formerfordernisse` | Elektronische Paragraph Formerfordernisse: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `empfangsbeduerftiger-international` | Empfangsbeduerftiger International: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `formwahl-zugang-live-prozessablauf` | Formwahl Zugang Live Prozessablauf: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `klauselgenerator-formvorbehalt-maklervertrag` | Klauselgenerator Formvorbehalt Maklervertrag: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kuendigung-per-mandantenkorrespondenz-zugang` | Kuendigung PER Mandantenkorrespondenz Zugang: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `notarielle-beurkundung-prozessablauf-papier` | Notarielle Beurkundung Prozessablauf Papier: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `prozessordnungen-textform-verifikation` | Prozessordnungen Textform Verifikation: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `schriftform-textform-bgb-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `sftf-arbeitsvertraege-nachweisgesetz` | Sftf Arbeitsvertraege Nachweisgesetz: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `sftf-formvorgaben-bgb-interessen-checklisten` | Sftf Formvorgaben BGB Interessen Checklisten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `textform-paragraph-verteidigungsstrategie` | Paragraph Verteidigungsstrategie: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `willenserklaerung-zivilrecht-zugang` | Willenserklaerung Zivilrecht Zugang: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zugang-empfangsbeduerftiger-formgerechter` | Zugang Empfangsbeduerftiger Formgerechter: bündelt 2 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
