...
description: "Parteigericht Effektiver Parteigruendung im Parteienrecht: prüft konkret Prüft, ob der Vorrang parteiinterner Schiedsgerichtsbarkeit noch, Begleitet Gründung, Erstellt Rundmail. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Parteigericht Effektiver Parteigruendung** als zusammenhängenden Arbeitsgang im Parteienrecht. Im Mittelpunkt steht die Prüfung von Prüft, ob der Vorrang parteiinterner Schiedsgerichtsbarkeit noch, Begleitet Gründung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
