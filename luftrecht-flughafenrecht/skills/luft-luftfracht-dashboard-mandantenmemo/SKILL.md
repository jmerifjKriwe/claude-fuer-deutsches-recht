...
Dieser Skill behandelt **Luft Luftfracht Dashboard Mandantenmemo** als zusammenhängenden Arbeitsgang im Plugin Luftrecht Flughafenrecht. Im Mittelpunkt steht die Prüfung von Luftfrachtfuehrer oder grosser Spediteur braucht Dashboard, Anwalt schreibt Mandantenmemo fuer Luftfrachtfuehrer oder, Mandant will ACC3-Designierungsstatus und Validierungsstand und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
