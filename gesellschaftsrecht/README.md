...
| Skill | Beschreibung |
| --- | --- |
| `arbeitsbereich-mandantenentscheidung` | Arbeitsbereich Mandantenentscheidung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-beratungsfunktion-beschlussfassung` | Beirat Beratungsfunktion Beschlussfassung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-familiengesellschaft` | Beirat Familiengesellschaft: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-informationsrechte-insolvenznaehe` | Beirat Informationsrechte Insolvenznaehe: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-internal-investigation-datenschutz-ki` | Beirat Internal Investigation Datenschutz KI: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `beirat-mitbestimmung-abgrenzung-nachfolge` | Beirat Mitbestimmung Abgrenzung Nachfolge: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-musterklauseln-haftung` | Beirat Musterklauseln Haftung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-satzungsgrundlage-sitzung-protokoll` | Beirat Satzungsgrundlage Sitzung Protokoll: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `beirat-verguetung-verschwiegenheit-veto` | Beirat Verguetung Verschwiegenheit Veto: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `dealteam-zusammenfassung` | Dealteam Zusammenfassung: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `discovery-gesellschafterbeschluesse` | Discovery Gesellschafterbeschluesse: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `gesellschaftsrecht-anschluss` | Anschluss: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `gesr-gesellschaftsformwahl-aufsichtsrat` | Gesr Gesellschaftsformwahl Aufsichtsrat: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `handelsregisteranmeldung-integrations` | Handelsregisteranmeldung Integrations: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `livecheck-sonderfall-loesungsstrategie-mandat` | Livecheck Sonderfall Loesungsstrategie Mandat: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandat-arbeitsbereich-gesr-corporate` | Mandat Arbeitsbereich Gesr Corporate: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `output-waehlen-workflow-redteam-interessen` | Output Waehlen Workflow Redteam Interessen: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `rechtsabteilung-gesellschafterliste` | Rechtsabteilung Gesellschafterliste: bündelt 5 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `wesentliche-vertraege` | Wesentliche Vertraege: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
