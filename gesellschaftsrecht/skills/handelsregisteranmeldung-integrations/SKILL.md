...
description: "Handelsregisteranmeldung Integrations im Plugin Gesellschaftsrecht: prüft konkret Vorbereitung und Prüfung von Handelsregisteranmeldungen (HRB, HRA, GnR, PartGR). Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**Handelsregisteranmeldung Integrations** ordnet den Fall über die tragenden Prüffelder: Vorbereitung und Prüfung von Handelsregisteranmeldungen (HRB, HRA, GnR. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
