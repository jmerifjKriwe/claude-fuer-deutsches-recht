...
Dieser Skill behandelt **Handelsregisteranmeldung Integrations** als zusammenhängenden Arbeitsgang im Plugin Gesellschaftsrecht. Im Mittelpunkt steht die Prüfung von Vorbereitung und Prüfung von Handelsregisteranmeldungen (HRB, HRA, GnR und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
