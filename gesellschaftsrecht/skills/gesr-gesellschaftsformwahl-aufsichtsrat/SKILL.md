...
description: "Gesr Gesellschaftsformwahl Aufsichtsrat im Plugin Gesellschaftsrecht: prüft konkret Bauleiter Gesellschaftsformwahl, Erstellt Protokolle von Vorstandssitzungen (AG), Aufsichtsratssitzungen (AG, § 1. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Gesr Gesellschaftsformwahl Aufsichtsrat** als zusammenhängenden Arbeitsgang im Plugin Gesellschaftsrecht. Im Mittelpunkt steht die Prüfung von Bauleiter Gesellschaftsformwahl, Erstellt Protokolle von Vorstandssitzungen (AG), Aufsichtsratssitzungen (AG und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
