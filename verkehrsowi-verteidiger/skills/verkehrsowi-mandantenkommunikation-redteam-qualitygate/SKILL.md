...
**Mandantenkommunikation Redteam Qualitygate** ordnet den Fall über die tragenden Prüffelder: Mandantenkommunikation im Plugin verkehrsowi-verteidiger, Red-Team Qualitygate im Plugin verkehrsowi-verteidiger, Rechtsprechungsrecherche für OWi-Verkehrsmandate. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
