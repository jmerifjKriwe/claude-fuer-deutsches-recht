...
| --- | --- | --- |
| Plugin als Komplett-ZIP (Hauptweg, für Claude Code / Cowork) | ZIP | [`{plugin_name}.zip`]({RELEASE_BASE}/{plugin_name}.zip) |
| Großer Prompt (Werkstatt, Alternative ohne Plugin-Setup) | Markdown | [`{werkstatt_file}`]({werkstatt_url}) |
| Kleiner Prompt (Schnellstart, höchstens 7500 Zeichen, Spar-Alternative) | Markdown | [`{schnellstart_file}`]({schnellstart_url}) |
