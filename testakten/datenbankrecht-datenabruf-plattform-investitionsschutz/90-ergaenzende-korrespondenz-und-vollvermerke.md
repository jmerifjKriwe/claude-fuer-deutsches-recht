# Ergänzende Plattformakte automatisiertes Auslesen und Datenbankinvestition

## Vollständige Gesprächsnotiz

Am 04.06.2026 schilderte LindenMetrics GmbH, Betreiberin einer B2B-Preisdatenbank für Baustoffe die Angelegenheit in einem längeren Telefonat. Gegenstand ist Massenauslesen durch eine Vergleichsplattform, Abgrenzung Datenbankwerk und Datenbankherstellerrecht, Investitionsnachweis, technische Schutzmaßnahmen und Auskunftsbegehren gegen Hostinganbieter. Die Darstellung war nicht linear: Zunächst standen praktische Fristen und die Sorge vor Eskalation im Vordergrund, danach erst die rechtliche Einordnung. Für die weitere Bearbeitung ist deshalb wichtig, die Akte nicht nur nach Rechtsgebieten, sondern nach Entscheidungsdruck zu ordnen: Was muss sofort gesichert werden, was darf noch offen bleiben, und welche Erklärung kann später als Einlassung, Geständnis, Anerkenntnis oder zumindest als ungünstige Tatsachenbehauptung gelesen werden.

Die Logs zeigen 1,8 Millionen Requests über rotierende IPs, aber nur ein Teil betrifft öffentlich sichtbare Tabellen. Kritisch sind die Detailseiten mit Lieferzeiten, regionalen Rabatten und historischen Preisständen. Vertrieb hat bereits zwei Kunden verloren, weil die Konkurrenz dieselben Preiscluster anbietet. Nach Durchsicht der bisherigen Unterlagen fällt auf, dass mehrere Beteiligte dieselben Worte unterschiedlich verwenden. “Freigabe”, “Kenntnis”, “Sicherung”, “Rüge” und “Abstimmung” tauchen in E-Mails, Tabellen und Gesprächsnotizen auf, ohne dass klar ist, ob damit eine rechtliche Erklärung, eine interne Arbeitsanweisung oder nur eine vorläufige Arbeitshypothese gemeint ist. Für die weitere Bearbeitung genügt deshalb kein bloßer Ergebnisvermerk. Erforderlich ist ein nachvollziehbarer Ablauf mit Tonfall, Unsicherheiten und Belegstellen, damit spätere Schreiben, Gespräche und Anträge auf derselben Tatsachengrundlage stehen.

## E-Mail des CTO an Legal mit Log-Auszug

```
Von:      cto@lindenmetrics.test
An:       legal@lindenmetrics.test
Datum:    Do 04.06.2026, 08:47 Uhr
Betreff:  Auslesedienst Wellen 22./23.05. - Export kompletter Preisgraphen
```
...
Bitte beweisen Sie nicht nur Kopie, sondern auch die wesentliche Investition in Beschaffung, Überprüfung und Darstellung der Daten. Bitte geben Sie mir bis morgen 12:00 Uhr eine Fassung, die ich intern weiterleiten kann. Sie darf gern klar sein, aber sie soll nicht dramatisieren. Wir brauchen eine Sprache, die die Sache ernst nimmt und trotzdem handhabbar bleibt.

Viele Grüße

LindenMetrics GmbH, Betreiberin einer B2B-Preisdatenbank für Baustoffe
...
## Entwurf Abmahnung und Preservation Notice
