...
## Kostenpositionen Vorprozess

| Position | Betrag |
|---|---|
| Gerichtsgebühren (3,0 GKG aus Streitwert 14.880 EUR + Raeumung) | ca. 1.182 EUR |
| Anwaltshonorar 1. Instanz (1,3 VV 3100 + 1,2 VV 3104) | ca. 1.644 EUR |
| Anwaltshonorar Berufung LG Hamburg | ca. 822 EUR |
| Auslagen (Porto, Kopien) | ca. 60 EUR |
| **Summe Kostenfestsetzungsantrag** | **ca. 3.708 EUR** |
...
KFB noch nicht beantragt (Stand 15.02.2026). Antrag soll nach Raeumung und Abschluss des § 765a-Verfahrens gestellt werden.

**Wiedervorlage:** 01.04.2026 (nach Raeumung)
