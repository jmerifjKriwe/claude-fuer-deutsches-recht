...
Dieser Megaprompt enthaelt top-15 von 246 Skills des Plugins `legistik-werkstatt`.
...
9. **bmas-rente-und-altersvorsorgerecht** — Sachbereich Rente und Altersvorsorgerecht im Geschaeftsbereich BMAS: Normbestand (SGB VI; AVG (alt); FRG; ZRBG; Riester;…
10. **bmas-sozialversicherungsrecht-sgb** — Sachbereich Sozialversicherungsrecht (SGB) im Geschaeftsbereich BMAS: Normbestand (SGB I bis SGB XII; ASVG-Aequivalent; …
11. **bmbfsfj-familien-und-elterngeldrecht** — Sachbereich Familien- und Elterngeldrecht im Geschaeftsbereich BMBFSFJ: Normbestand (BEEG; BKGG; UnterhVG; FamFG (famili…
12. **bmbfsfj-schul-und-berufsbildungsrecht** — Sachbereich Schul- und Berufsbildungsrecht im Geschaeftsbereich BMBFSFJ: Normbestand (BAfoeG; AFBG; BBiG; HwO; Schulgese…
13. **bmds-datenrecht-und-data-act** — Sachbereich Datenrecht und Data Act im Geschaeftsbereich BMDS: Normbestand (Data Act (EU); Data Governance Act (EU); BDS…
14. **bmds-digitale-verwaltung-ozg-und-egovg** — Sachbereich Digitale Verwaltung (OZG; EGovG) im Geschaeftsbereich BMDS: Normbestand (OZG; OZG-AeG; EGovG; EGovG-Länder; …
15. **bmds-ki-verordnung-und-aufsichtsstruktur** — Sachbereich KI-Verordnung und Aufsichtsstruktur im Geschaeftsbereich BMDS: Normbestand (KI-VO (EU); BDSG; ProdSG; ProdHa…
...
## Skill: `bmas-rente-und-altersvorsorgerecht`

_Sachbereich Rente und Altersvorsorgerecht im Geschaeftsbereich BMAS: Normbestand (SGB VI; AVG (alt); FRG; ZRBG; Riester; Foerderhinweise Steuer (mit BMF).); Akteure (DRV Bund; Aufsicht ueber Pensionsfonds (BaFin Schnittstelle); ZfA (Zulagenstelle).); EU-Bezug (VO 883/2004; PEPP-VO.); typische Leg..._
...
## Skill: `bmas-sozialversicherungsrecht-sgb`

_Sachbereich Sozialversicherungsrecht (SGB) im Geschaeftsbereich BMAS: Normbestand (SGB I bis SGB XII; ASVG-Aequivalent; AsylbLG (mit BMI).); Akteure (DRV Bund; BA; GKV-Spitzenverband; BAS (Bundesamt für Soziale Sicherung); SGericht.); EU-Bezug (VO 883/2004 (Koordinierung); EFTA; bilaterale Abkomm..._
...
## Skill: `bmbfsfj-familien-und-elterngeldrecht`

_Sachbereich Familien- und Elterngeldrecht im Geschaeftsbereich BMBFSFJ: Normbestand (BEEG; BKGG; UnterhVG; FamFG (familienverfahrensrechtlich); MuSchG.); Akteure (Elterngeldstellen der Länder; BMBFSFJ; Familiengerichte.); EU-Bezug (Work-Life-Balance-RL; Mutterschutz-RL.); typische Legistik-Aufgab..._

# Familien- und Elterngeldrecht (BMBFSFJ)

> Vierter und tiefster Skill in der Ressort-Kette: Sachfeld-Kompass für das Spezialthema Familien- und Elterngeldrecht im Geschaeftsbereich BMBFSFJ. Liefert dem Normgeber Normbestand, Akteure, EU-Bezug und Pruefpunkte für dieses eine Sachfeld.
...
## Skill: `bmbfsfj-schul-und-berufsbildungsrecht`

_Sachbereich Schul- und Berufsbildungsrecht im Geschaeftsbereich BMBFSFJ: Normbestand (BAfoeG; AFBG; BBiG; HwO; Schulgesetze der Länder; AufstFoeG.); Akteure (BMBFSFJ; Länder-Kultusministerien; KMK; BIBB; Berufsverbaende.); EU-Bezug (Berufsanerkennungs-RL; Europass; Erasmus+.); typische Legistik-A..._
...
## Skill: `bmds-datenrecht-und-data-act`

_Sachbereich Datenrecht und Data Act im Geschaeftsbereich BMDS: Normbestand (Data Act (EU); Data Governance Act (EU); BDSG; IFG; UIG.); Akteure (BMDS; BfDI; ggf. Datenmittlerdienste-Aufsicht; BNetzA.); EU-Bezug (Data Act; Data Governance Act; Open Data RL.); typische Legistik-Aufgaben und Pruefpun..._
...
## Skill: `bmds-digitale-verwaltung-ozg-und-egovg`

_Sachbereich Digitale Verwaltung (OZG; EGovG) im Geschaeftsbereich BMDS: Normbestand (OZG; OZG-AeG; EGovG; EGovG-Länder; eIDAS-DurchG; XOeV.); Akteure (BMDS; ITZBund; FITKO; Länder-CIOs; Bundesdruckerei.); EU-Bezug (Single Digital Gateway; eIDAS 2.0; EU Digital Wallet.); typische Legistik-Aufgaben..._
...
## Skill: `bmds-ki-verordnung-und-aufsichtsstruktur`

_Sachbereich KI-Verordnung und Aufsichtsstruktur im Geschaeftsbereich BMDS: Normbestand (KI-VO (EU); BDSG; ProdSG; ProdHaftG; einschlaegige Sektorgesetze.); Akteure (BMDS; BNetzA (Marktaufsicht KI; geplant); BSI; BfDI; Länderbehoerden.); EU-Bezug (KI-VO; AI Office; AI Liability Directive (Entwurf)..._

# KI-Verordnung und Aufsichtsstruktur (BMDS)

> Vierter und tiefster Skill in der Ressort-Kette: Sachfeld-Kompass für das Spezialthema KI-Verordnung und Aufsichtsstruktur im Geschaeftsbereich BMDS. Liefert dem Normgeber Normbestand, Akteure, EU-Bezug und Pruefpunkte für dieses eine Sachfeld.
