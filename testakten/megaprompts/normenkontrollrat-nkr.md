...
3. **digitalcheck-und-onlinezugangsgesetz-ozg** — Fachmodul OZG und Digitalcheck. Beschreibt das Onlinezugangsgesetz die OZG-Leistungen den Portalverbund das Once-Only-Pr…
4. **einmalig-vs-erforderlichkeitspruefung-warum** — Trennscharfe Unterscheidung zwischen einmaligem Umstellungsaufwand und jaehrlich laufendem Erfuellungsaufwand. Erklaert …
5. **erfuellungsaufwand-buerger-grundbegriff** — Trennt den Erfuellungsaufwand methodisch nach den drei Adressatengruppen Buerger Wirtschaft Verwaltung. Erklaert Spezifi…
6. **erfuellungsaufwand-grundbegriff** — Definiert den Grundbegriff Erfuellungsaufwand nach NKRG GGO § 44 und HdR. Trennt den Begriff von benachbarten Konzepten …
7. **evaluierung-befristung-verfahrensgang** — Praxis-Skill zur Empfehlung von Evaluierungsklauseln Befristungen und Sunset-Klauseln. Beschreibt wann der NKR welches I…
8. **fallzahlen-schaetzung-bandbreiten** — Methodischer Fachmodul für Schaetzungen mit Bandbreiten wenn keine harten Statistik-Daten vorliegen. Beschreibt Plausibi…
9. **standardkostenmodell-skm** — Beschreibt das Standardkostenmodell SKM als methodischen Kern der Erfuellungsaufwandsberechnung. Erklaert die Standardfo…
10. **stellungnahme-zum-bundestag-anhoerung** — Vorbereitung einer Anhörung im federfuehrenden Ausschuss des Bundestages. Beschreibt typische Anhörungssituation NKR-Ver…
11. **zeitwerttabelle-und-fallzahlen** — Praxisleitfaden zu Zeitwerttabellen und Fallzahlenermittlung. Zeigt die Struktur der Leitfaden-Zeitwerttabelle die Kompl…
12. **zusammenarbeit-bundesregierung-ressorts** — Verhaltens-Skill für die taegliche Zusammenarbeit zwischen NKR-Sekretariat und Ressorts. Beschreibt informelle Vorklaeru…
13. **aufgabe-und-kompetenz-nkrg** — Zeigt Aufgabe Zuständigkeit Unabhaengigkeit und Befassungspflichten des Nationalen Normenkontrollrats nach NKRG. Erklaer…
14. **buerokratiekosten-vs-erfuellungsaufwand** — Trennt den engen Begriff Buerokratiekosten von dem umfassenderen Begriff Erfuellungsaufwand. Beschreibt historische Entw…
15. **praktikabilitaet-vollzug-test** — Praktikabilitaetstest für den Vollzug. Prüft ob die Regelung von Behörden und Adressaten ueberhaupt leistbar ist. Faktor…
...
## Skill: `stellungnahme-zum-bundestag-anhoerung`

_Vorbereitung einer Anhörung im federfuehrenden Ausschuss des Bundestages. Beschreibt typische Anhörungssituation NKR-Vertretung muendliche Eingangsaussage Vorbereitung Folienpaket Antworten auf Abgeordnetenfragen und Folge-Stellungnahme. Mit Mustersaetzen Frage-Antwort-Vorlagen und Dramaturgie-Hi..._
...
## Skill: `zeitwerttabelle-und-fallzahlen`

_Praxisleitfaden zu Zeitwerttabellen und Fallzahlenermittlung. Zeigt die Struktur der Leitfaden-Zeitwerttabelle die Komplexitaetsstufen die Standard-Lohnsaetze DESTATIS-Quellen die Datenwege zur Fallzahlenermittlung und die typischen Quellen (Statistisches Bundesamt Bundesregister Ressortdaten Bra..._
...
## Skill: `zusammenarbeit-bundesregierung-ressorts`

_Verhaltens-Skill für die taegliche Zusammenarbeit zwischen NKR-Sekretariat und Ressorts. Beschreibt informelle Vorklaerungen Datenanforderungen § 5 NKRG Eskalationsstufen Konfliktbewaeltigung Dialog mit dem federfuehrenden Referat und Schnittstelle Bundesministerium der Justiz als institutionelle..._
...
_Zeigt Aufgabe Zuständigkeit Unabhaengigkeit und Befassungspflichten des Nationalen Normenkontrollrats nach NKRG. Erklaert insbesondere § 1 Einsetzung beim BMJ § 2 Erfuellungsaufwand § 3 Zusammensetzung § 4 Prüfung § 6 Stellungnahme und die institutionelle Stellung als Beratungs- und Kontrollgrem..._
...
_Trennt den engen Begriff Buerokratiekosten von dem umfassenderen Begriff Erfuellungsaufwand. Beschreibt historische Entwicklung (SKM 2006 nur Informationspflichten; Ausweitung 2011) und zeigt Folgen für Prüfung Berichtswesen Vorblatt One-in-one-out. Mit Vergleichstabelle und Begriffsklaerung für..._
...
_Praktikabilitaetstest für den Vollzug. Prüft ob die Regelung von Behörden und Adressaten ueberhaupt leistbar ist. Faktoren Personalbedarf IT-Voraussetzungen Datenverfuegbarkeit Schulungserfordernisse Vollzugskaskaden Konnexitaet Konfliktloesung mit Adressaten. Mit Mustertexten zur Vollzugskritik..._
