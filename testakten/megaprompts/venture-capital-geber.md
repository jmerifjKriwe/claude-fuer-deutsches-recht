...
Dieser Megaprompt enthaelt top-15 von 105 Skills des Plugins `venture-capital-geber`.
...
9. **nda-und-confidentiality-vc** — Prüft, wann ein VC ein NDA akzeptieren sollte, welche Informationen vertraulich bleiben und wann ein NDA den Dealfluss u…
10. **investorprofil-family-office-fonds-angel** — Baut aus Herkunft des Geldes, Mandat, Risikoappetit, Ticketgröße, Haltedauer, Steuer, Reputation und Regulatorik ein VC-…
11. **rookie-modus-vc-begriffe** — Erklärt Pre-Seed, Seed, Series A/B, bridge, runway, lead, follow-on, pro rata, SAFE, cap table und liquidation preferenc…
12. **direktinvestment-spv-club-deal** — Vergleicht Direktbeteiligung, Treuhand, Pooling-SPV, Club Deal, Angel-Syndikat und Fondsvehikel aus Sicht eines deutsche…
13. **wandeldarlehen-deutschland** — Prüft deutsche Wandeldarlehen mit Discount, Cap, Laufzeit, qualifizierter Finanzierungsrunde, Rang, Zinsen, Wandlung und…
14. **euveca-eltif-und-vc-fonds** — Ordnet EuVECA- und ELTIF-Optionen als regulierte VC-/Private-Markets-Hüllen ein und grenzt sie von Direkt- und SPV-Inves…
15. **tax-investor-portfolio** — Ordnet Beteiligungserträge, Wandeldarlehenszinsen, Veräußerung, Verlustnutzung, Fonds-/SPV-Steuer und Reporting auf hohe…
...
## Skill: `nda-und-confidentiality-vc`

_Prüft, wann ein VC ein NDA akzeptieren sollte, welche Informationen vertraulich bleiben und wann ein NDA den Dealfluss unnötig blockiert im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
_Baut aus Herkunft des Geldes, Mandat, Risikoappetit, Ticketgröße, Haltedauer, Steuer, Reputation und Regulatorik ein VC-Investorprofil im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
## Skill: `rookie-modus-vc-begriffe`

_Erklärt Pre-Seed, Seed, Series A/B, bridge, runway, lead, follow-on, pro rata, SAFE, cap table und liquidation preference auf Deutsch im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
## Skill: `direktinvestment-spv-club-deal`

_Vergleicht Direktbeteiligung, Treuhand, Pooling-SPV, Club Deal, Angel-Syndikat und Fondsvehikel aus Sicht eines deutschen VC-Gebers im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
## Skill: `wandeldarlehen-deutschland`

_Prüft deutsche Wandeldarlehen mit Discount, Cap, Laufzeit, qualifizierter Finanzierungsrunde, Rang, Zinsen, Wandlung und Notarfolge im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
## Skill: `euveca-eltif-und-vc-fonds`

_Ordnet EuVECA- und ELTIF-Optionen als regulierte VC-/Private-Markets-Hüllen ein und grenzt sie von Direkt- und SPV-Investments ab im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
...
## Skill: `tax-investor-portfolio`

_Ordnet Beteiligungserträge, Wandeldarlehenszinsen, Veräußerung, Verlustnutzung, Fonds-/SPV-Steuer und Reporting auf hoher Ebene im Venture Capital (Geber): prüft konkret die einschlägigen Tatbestandsmerkmale, Fristen, Belege und Rechtsprechung._
