...
description: "robotik-recht: Konsolidiertes Skill-Kompendium 07; bündelt 6 frühere Spezialskills (datenverlust-und-digitaler-schaden, deliktische-haftung-paragraph-823-bgb, haftung-arzt-klinik-hersteller, schadensberechnung-produktionsausfall, cra-produkt-mit-digitalen-elementen und 1 weitere) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 07 - robotik-recht
...
**Frühere Beschreibung:** Bewertet Schäden durch Datenverlust, Fehlsteuerung, Produktionsstillstand, Privacy-Schäden und reine Vermögensschäden.
...
**Frühere Beschreibung:** Prüft deliktische Haftung nach § 823 BGB bei Robotik: Verkehrssicherung, Organisationsverschulden, Schutzgesetze, Beweis und Verschulden.
...
**Frühere Beschreibung:** Ordnet Haftung zwischen Arzt, Klinik, Betreiber, Hersteller, Wartung und Softwareanbieter bei Medizinrobotik.
...
**Frühere Beschreibung:** Prüft Schaden bei Produktionsausfall, Körperverletzung, Sachschaden, Datenverlust, Rückrufkosten und Regress.
...
## 5. `cra-produkt-mit-digitalen-elementen`

**Frühere Beschreibung:** Prüft Cyber Resilience Act für Roboter, Steuerungssoftware, Apps, Cloud-Komponenten und Updatekanäle.
...
## 6. `lager-und-intralogistikflotte`

**Frühere Beschreibung:** Prüft Roboterflotten in Lager und Intralogistik: Flottensteuerung, Zonen, Mitarbeiterschutz, Telemetrie, Wartung und Incident Logs.
