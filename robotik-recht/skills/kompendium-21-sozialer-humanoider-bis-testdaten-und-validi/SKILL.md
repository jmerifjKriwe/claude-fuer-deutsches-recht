...
description: "robotik-recht: Konsolidiertes Skill-Kompendium 21; bündelt 6 frühere Spezialskills (sozialer-humanoider-roboter, spielzeug-und-kinderroboter, strom-emv-und-niederspannung, systemintegrator-als-hersteller, technische-besichtigung-und-geheimnisschutz und 1 weitere) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 21 - robotik-recht
...
**Frühere Beschreibung:** Prüft soziale/humanoide Roboter: Vertrauen, Anthropomorphisierung, Manipulation, Kinder, Pflege, Transparenz und Datenschutz.
...
**Frühere Beschreibung:** Prüft Kinder-, Lern- und Spielzeugroboter: Spielzeugrecht, GPSR, Datenschutz Minderjähriger, KI-Transparenz und Verbraucherschutz.
...
**Frühere Beschreibung:** Prüft elektrische Sicherheit, EMV, Niederspannung, Ladegeräte und Schnittstelle zur Maschinenverordnung.
...
**Frühere Beschreibung:** Bewertet, wann ein Systemintegrator durch Zusammenbau, Marke, Umbau oder Konfiguration zum verantwortlichen Hersteller wird.
...
## 5. `technische-besichtigung-und-geheimnisschutz`

**Frühere Beschreibung:** Plant gerichtliche oder außergerichtliche Besichtigung eines Roboters mit Geheimnisschutz, Sachverständigem und Testprotokoll.
...
## 6. `testdaten-und-validierung-vor-marktstart`

**Frühere Beschreibung:** Prüft Testdaten, Validierungsplan, Feldtest, Pilotkunden, Beta-Betrieb und regulatorische Grenzen vor Marktstart.
