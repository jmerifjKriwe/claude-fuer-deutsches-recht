...
description: "Lieferantenqualifizierung Sensor im Robotik- und KI-Recht: prüft konkret Prüft Lieferantenqualifizierung für Sensoren, Aktoren, Batterien, Cloud. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Lieferantenqualifizierung Sensor** als zusammenhängenden Arbeitsgang im Robotik- und KI-Recht. Im Mittelpunkt steht die Prüfung von Prüft Lieferantenqualifizierung für Sensoren, Aktoren, Batterien. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
