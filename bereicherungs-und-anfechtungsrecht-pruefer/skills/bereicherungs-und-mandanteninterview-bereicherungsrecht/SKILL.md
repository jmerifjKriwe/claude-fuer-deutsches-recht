...
description: "Mandanteninterview Bereicherungsrecht im Plugin Bereicherungs Und Anfechtungsrecht Pruefer: prüft konkret Dieses Fachmodul greift, wenn die Tatsachen für einen Bereicherungsfall erst str, Komplexitätsindikatoren erkennen, Bereicherungsausgleich in Mehrpersonenverhältnissen prüfen. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Mandanteninterview Bereicherungsrecht** als zusammenhängenden Arbeitsgang im Plugin Bereicherungs Und Anfechtungsrecht Pruefer. Im Mittelpunkt steht die Prüfung von Dieses Fachmodul greift, wenn die Tatsachen für einen Bereicherungsfall erst str, Komplexitätsindikatoren erkennen und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
