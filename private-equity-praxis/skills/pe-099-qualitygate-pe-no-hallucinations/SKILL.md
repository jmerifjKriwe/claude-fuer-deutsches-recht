---
name: pe-099-qualitygate-pe-no-hallucinations
...
- **Spezialgegenstand:** Qualitygate: keine PE-Halluzinationen wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
