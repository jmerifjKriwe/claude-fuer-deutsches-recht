...
Dieser Skill behandelt **DB B2B Kundendaten Datenbank Insolvenz ALS** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Analysiert Datenbankherstellerrecht (§§ 87a-87e UrhG) und, Datenbankrecht in der Insolvenz, Bewertet Datenbankrechte (§§ 87a-87e UrhG) als. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
