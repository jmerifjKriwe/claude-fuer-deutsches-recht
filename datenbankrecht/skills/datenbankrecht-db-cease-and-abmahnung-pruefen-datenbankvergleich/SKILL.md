...
Dieser Skill behandelt **DB Cease AND Abmahnung Pruefen Datenbankvergleich** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Cease-and-Desist-Letter (Abmahnung) im Datenbankrecht nach, Prüfung einer erhaltenen Datenbankrechts-Abmahnung, Datenbankvergleich und Bereinigungsplan bei. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
