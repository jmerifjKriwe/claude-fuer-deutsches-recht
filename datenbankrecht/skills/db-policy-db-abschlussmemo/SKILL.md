...
description: "DB Policy DB Abschlussmemo im Plugin Datenbankrecht: prüft konkret Erstellung und Prüfung unternehmensinterner, Erstellung eines strukturierten Abschlussmemos nach. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **DB Policy DB Abschlussmemo** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Erstellung und Prüfung unternehmensinterner, Erstellung eines strukturierten Abschlussmemos nach. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
