...
Dieser Skill behandelt **DB Grenzueberschreitende Datenbank** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Grenzüberschreitendes Datenbankrecht, Text-und-Data-Mining-Schranken im Datenbankrecht, Technische und rechtliche Prüfung des TDM-Opt-outs nach §. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
