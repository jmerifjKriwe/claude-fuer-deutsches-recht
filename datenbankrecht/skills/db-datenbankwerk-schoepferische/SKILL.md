...
description: "DB Datenbankwerk Schoepferische im Plugin Datenbankrecht: prüft konkret Prüft, ob eine Datenbank als Datenbankwerk nach § 4 Abs, Analysiert das sui-generis-Datenbankherstellerrecht nach §§, Bestimmt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **DB Datenbankwerk Schoepferische** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Prüft, ob eine Datenbank als Datenbankwerk nach § 4 Abs, Analysiert das sui-generis-Datenbankherstellerrecht nach §§. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
