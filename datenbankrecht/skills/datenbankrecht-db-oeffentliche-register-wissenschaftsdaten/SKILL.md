...
description: "DB Oeffentliche Register Wissenschaftsdaten im Plugin Datenbankrecht: prüft konkret Datenbankrecht für öffentliche Register (Handelsregister, Grundbuch, Transparenz, Datenbankrecht für Forschungsdatenbanken und. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **DB Oeffentliche Register Wissenschaftsdaten** als zusammenhängenden Arbeitsgang im Plugin Datenbankrecht. Im Mittelpunkt steht die Prüfung von Datenbankrecht für öffentliche Register (Handelsregister, Grundbuch, Transparenz. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
