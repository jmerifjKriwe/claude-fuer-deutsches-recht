...
description: "Distressed DUE im Plugin Mittelstand Corporate Ma: prüft konkret Disclosure Schedules, Distressed M&A, Kommerzielle Vertrags-DD, Legal Due Diligence. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**Distressed DUE** ordnet den Fall über die tragenden Prüffelder: Disclosure Schedules, Distressed M&A, Kommerzielle Vertrags-DD. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
