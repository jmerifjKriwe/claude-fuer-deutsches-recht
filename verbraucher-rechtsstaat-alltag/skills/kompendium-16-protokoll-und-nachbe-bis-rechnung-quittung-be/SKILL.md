...
description: "verbraucher-rechtsstaat-alltag: Konsolidiertes Skill-Kompendium 16; bündelt 3 frühere Spezialskills (protokoll-und-nachbereitung, rechnung-ohne-auftrag, rechnung-quittung-beleg) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 16 - verbraucher-rechtsstaat-alltag
...
**Frühere Beschreibung:** Protokoll und Nachbereitung: erklärt sichert Verlauf, Zusagen, Beschlüsse, Auflagen und nächste Wiedervorlagen in einfacher, aber richtiger Sprache; sortiert Dokumente, Fristen, Risiken und nächste Schritte ohne unnötige Preisgabe persönlicher Daten.
...
**Frühere Beschreibung:** Rechnung ohne Auftrag: führt Laien durch Unbestellte Leistung, Branchenbuch, angeblicher Telefonvertrag und Abwehr. mit Fristen-, Beleg-, Datenschutz- und Kommunikationscheck in einfacher, aber rechtlich belastbarer Sprache.
...
**Frühere Beschreibung:** Rechnung, Quittung und Beleg: erklärt wann ein Beleg nötig ist, was geprüft wird und wie man reklamiert in einfacher, aber richtiger Sprache; sortiert Dokumente, Fristen, Risiken und nächste Schritte ohne unnötige Preisgabe persönlicher Daten.
