...
description: "Arzt Rechnung Bankentgelte Zustimmungsfiktion im Plugin Verbraucher Rechtsstaat Alltag: prüft konkret Arztrechnung GOÄ für Laien, Bankentgelte und Zustimmungsfiktion, Baubehörde und Nachbarbrief. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Arzt Rechnung Bankentgelte Zustimmungsfiktion** als zusammenhängenden Arbeitsgang im Plugin Verbraucher Rechtsstaat Alltag. Im Mittelpunkt steht die Prüfung von Arztrechnung GOÄ für Laien, Bankentgelte und Zustimmungsfiktion, Baubehörde und Nachbarbrief. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
