...
description: "Protokoll Nachbereitung Rechnung Ohne im Plugin Verbraucher Rechtsstaat Alltag: prüft konkret Protokoll und Nachbereitung, Rechnung ohne Auftrag, Rechnung, Quittung und Beleg. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Protokoll Nachbereitung Rechnung Ohne** als zusammenhängenden Arbeitsgang im Plugin Verbraucher Rechtsstaat Alltag. Im Mittelpunkt steht die Prüfung von Protokoll und Nachbereitung, Rechnung ohne Auftrag, Rechnung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
