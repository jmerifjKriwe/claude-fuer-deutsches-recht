...
## Aufgabe
Pflichtenuebersicht DMA fuer benannte Gatekeeper: Interoperabilitaet Messenger Art.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `dsa-dma-digitalregulierung` zum Thema `dma-pflichten-uebersicht`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Pflichtenuebersicht DMA fuer benannte Gatekeeper: Interoperabilitaet Messenger Art. 7, Datenportabilitaet Art. 6 Abs. 9 DMA, Selbstbevorzugungsverbot Art. 6 Abs. 5 DMA, Anti-Steering Art. 5 Abs. 4 DMA, FRAND-Bedingungen Art. 6 Abs. 12 DMA. Tabelle mit Pflicht, Adressat, Frist, Reporting. Fuer Gatekeeper-internes Compliance-Setup..
