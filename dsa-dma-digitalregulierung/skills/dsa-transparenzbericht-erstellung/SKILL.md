---
name: dsa-transparenzbericht-erstellung
...
## Aufgabe
Transparenzbericht nach Art.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `dsa-dma-digitalregulierung` zum Thema `dsa-transparenzbericht-erstellung`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Transparenzbericht nach Art. 15 DSA jaehrlich erstellen: Behoerdenanordnungen (Loeschung, Auskunft), Nutzermeldungen, eigene Inhaltsmoderation, automatisierte Tools, Statement of Reasons, Beschwerden. Format-Anforderungen der EU-Kommission, Excel-Templates, Veroeffentlichungspflichten. Fuer VLOP zusaetzlich Halbjahresbericht..
