---
name: dsa-dark-patterns-anti-design
description: "Dark Patterns nach Art. 25 DSA pruefen und vermeiden: irrefuehrende Cookie-Banner, Confirmshaming, Roach Motel, Bait-and-Switch, versteckte Kosten. Kataloge der EDPB-Leitlinien und der EU-Kommissions-Guidance. Code- und Design-Review fuer Plattformen mit konkreten Aenderungsvorschlaegen."
---

# DSA: Dark Patterns Audit

## Aufgabe
Dark Patterns nach Art.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `dsa-dma-digitalregulierung` zum Thema `dsa-dark-patterns-anti-design`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Dark Patterns nach Art. 25 DSA pruefen und vermeiden: irrefuehrende Cookie-Banner, Confirmshaming, Roach Motel, Bait-and-Switch, versteckte Kosten. Kataloge der EDPB-Leitlinien und der EU-Kommissions-Guidance. Code- und Design-Review fuer Plattformen mit konkreten Aenderungsvorschlaegen..
