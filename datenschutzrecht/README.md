...
| `behoerdenpaket-datenpanne-datenschutzrecht` | Behoerdenpaket Datenpanne Datenschutzrecht im Datenschutzrecht: prüft konkret Behoerdenpaket, Datenpanne, Datenschutzrecht, Dpia. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `behoerdenpaket-zahlen-schwellenwerte-berechnung` | Behoerdenpaket: Zahlen, Schwellenwerte und Berechnung im Datenschutzrecht: 1. Welche Rolle hat die fragende Person und wer ist Gegenüber? 2. Welches konkrete Ziel soll erreicht oder verhindert werden? 3. Welche Frist, Zustellung, Schwell... |
...
| `datenschutz-en-six-step-eu-us-data-laender-bewertung-china` | Datenschutz EN SIX Step EU US Data Laender Bewertung China im Datenschutzrecht: prüft konkret English-language version of the EDPB Recommendation 01/2020, Aktueller Stand zum EU-US Data Privacy Framework (DPF) als, TIA-Laenderbewertung j... |
...
| `datenschutz-ropa-art-processor-anwendungsfall-triage-joint` | Datenschutz Ropa ART Processor Anwendungsfall Triage Joint im Datenschutzrecht: prüft konkret Vollvorlage fuer das Verzeichnis von, Datenschutzrechtlichen Sachverhalt einordnen und, Joint-Controller-Vereinbarung nach Art, Grundtatbestand... |
...
| `dsfa-drittlandtransfer-behoerdenpaket-dsb` | Dsfa Drittlandtransfer Behoerdenpaket DSB im Datenschutzrecht: prüft konkret Behördenfähiges Dokumentations- und Antwortpaket für, Bestellungspflicht für Datenschutzbeauftragten prüfen, Pruefung wann eine DSFA nach Art, Abgleich einer Ve... |
...
| `dsfa-edpb-leitlinien-erstellung` | Dsfa Edpb Leitlinien Erstellung im Datenschutzrecht: prüft konkret Anwendung der EDPB-/EDSA-Leitlinien WP 248 rev.01 zur DSFA, Datenschutz-Folgenabschaetzung nach Art, DSFA bei internationalen Datentransfers nach Kapitel V DSGVO, DSFA fu... |
...
| `dsv-art-besondere-aufnahme-statusinformation` | DSV ART Besondere Aufnahme Statusinformation im Datenschutzrecht: prüft konkret Bewertet einen Datenschutzvorfall mit besonderen Kategorien, Erstellt nach einem gemeldeten Datenschutzvorfall eine, Prüft die Ausnahmen von der Benachrichti... |
...
| `dsv-kein-risiko-kinderdaten-besondere` | DSV Kein Risiko Kinderdaten Besondere im Datenschutzrecht: prüft konkret Erstellt die interne Dokumentation eines Datenschutzvorfalls, der nicht an die A, Bewertet einen Datenschutzvorfall mit Daten von, Etabliert eine interne und extern... |
...
| `dsv-meldung-art-baylda-bfdi-bln-bdi-hbdi-lfd` | DSV Meldung ART Baylda Bfdi BLN BDI Hbdi LFD im Datenschutzrecht: prüft konkret Erstellt eine vollständige Meldung nach Art, Reicht eine Meldung nach Art. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-meldung-lfdi-bw-mv-rlp-saarland` | DSV Meldung Lfdi BW MV RLP Saarland im Datenschutzrecht: prüft konkret Reicht eine Meldung nach Art. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-meldung-saechsdsb-tlfdi-uld-sh` | DSV Meldung Saechsdsb Tlfdi ULD SH im Datenschutzrecht: prüft konkret Reicht eine Meldung nach Art, Erstellt die Nachmeldung zu einer vorläufigen Erstmeldung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schr... |
...
| `dsv-risikobewertung-enisa-art-schnelltriage` | DSV Risikobewertung Enisa ART Schnelltriage im Datenschutzrecht: prüft konkret Wendet die ENISA-Methodik Recommendations for a methodology, Strukturiert die Schwellenwertentscheidung nach Art, Liefert in 15-30 Minuten eine Schnelltriage... |
...
| `dsv-sanktion-akteneinsicht-anhoerung-owig` | DSV Sanktion Akteneinsicht Anhoerung Owig im Datenschutzrecht: prüft konkret Datenschutzrecht-Brückenskill. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-sanktion-beschwerde-einspruch-owig` | DSV Sanktion Beschwerde Einspruch Owig im Datenschutzrecht: prüft konkret Datenschutzrecht-Brückenskill. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-sanktion-datenpanne-akteneinsicht-vorlage` | DSV Sanktion Datenpanne Akteneinsicht Vorlage im Datenschutzrecht: prüft konkret Datenschutzrecht-Brückenskill. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-sanktion-rechtsweg-sanktionsmandat` | DSV Sanktion Rechtsweg Sanktionsmandat im Datenschutzrecht: prüft konkret Datenschutzrecht-Brückenskill. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
...
| `dsv-spezialfaelle-uebersicht-stakeholder` | DSV Spezialfaelle Uebersicht Stakeholder im Datenschutzrecht: prüft konkret Liefert eine schnelle Übersicht über häufige Spezialfälle, Kartiert alle internen und externen Stakeholder eines, Bestimmt den richtigen Tonfall und die Sprachre... |
...
| `ropa-richtlinien-monitor-art-controller-dsgvo` | Ropa Richtlinien Monitor ART Controller DSGVO im Datenschutzrecht: prüft konkret Datenschutzrichtlinien und Unternehmensanweisungen auf, Vollvorlage fuer das Verzeichnis von, Grundlagen des Verzeichnisses von Verarbeitungstaetigkeiten, R... |
...
| `waehlen-dsv-rechtsprechung-datenschutz` | Waehlen DSV Rechtsprechung Datenschutz im Datenschutzrecht: prüft konkret Output wählen im Plugin datenschutzrecht, Red-Team Qualitygate im Plugin datenschutzrecht, Analysiert die deutsche Rechtsprechung zum immateriellen, Bußgeldverteid... |
