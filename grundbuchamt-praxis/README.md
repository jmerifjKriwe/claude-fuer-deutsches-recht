...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`grundbuchamt-praxis-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/grundbuchamt-praxis-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`grundbuchamt-praxis-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/grundbuchamt-praxis-unified-mini-prompt.md)
