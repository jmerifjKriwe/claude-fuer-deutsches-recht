...
description: "Reallast Erbbauzins Sanierungsvermerk im Plugin Grundbuchamt Praxis: prüft konkret Prüft Inhalt, Anpassung, Rang, Vollstreckbarkeit und Zusammenhang mit Erbbaurech. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---

# Reallast Erbbauzins Sanierungsvermerk

## Arbeitsbereich

Dieser Skill behandelt **Reallast Erbbauzins Sanierungsvermerk** als zusammenhängenden Arbeitsgang im Plugin Grundbuchamt Praxis. Im Mittelpunkt steht die Prüfung von Prüft Inhalt, Anpassung, Rang. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
