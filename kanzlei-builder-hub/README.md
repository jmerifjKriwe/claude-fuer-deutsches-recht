...
| Großer Prompt (Werkstatt, Alternative ohne Plugin-Setup) | Markdown | [`kanzlei-builder-hub-werkstatt.md`](https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/kanzlei-builder-hub/kanzlei-builder-hub-werkstatt.md) |
| Kleiner Prompt (Schnellstart, höchstens 7500 Zeichen, Spar-Alternative) | Markdown | [`kanzlei-builder-hub-schnellstart.md`](https://raw.githubusercontent.com/Klotzkette/claude-fuer-deutsches-recht/main/kanzlei-builder-hub/kanzlei-builder-hub-schnellstart.md) |
