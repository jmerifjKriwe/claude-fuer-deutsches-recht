...
| Skill | Beschreibung |
| --- | --- |
| `community-leistungsmatrix-fristennotiz` | Community Fristen Form Und Zustaendigkeit, Leistungsmatrix Fristennotiz Und Naechster Schritt, Automatischer Aktualisierer: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten be... |
| `deployment-eigenen-einsteiger` | Deployment Schriftsatz Brief Und Memo Bausteine, Eigenen Formular Portal Und Einreichung, Einsteiger Mandantenkommunikation Entscheidungsvorlage: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und l... |
| `findet-gate-installiert` | Findet Erstpruefung Und Mandatsziel, Gate Behörden Gericht Und Registerweg, Installiert Tatbestand Beweis Und Belege: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastba... |
| `grosskanzlei-rollout-thema-prozesse-abbilden` | Grosskanzlei Rollout Spezial, Kanzlei Builder Hub Anpassen, Kanzlei Prozesse Abbilden: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `kanzlei-builder-hub-anschluss-router` | Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix, ...: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `kanzlei-builder-hub-fristen-risikoampel-mandantenkommunikation` | Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `kanzlei-builder-hub-output-waehlen` | Output wählen: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
...
| `kanzleiumgebung-khub-sonderfall-livecheck` | Kanzleiumgebung Verhandlung Vergleich Und Eskalation, Khub Sonderfall Und Edge Case, Livecheck Mehrparteien Konflikt Und Interessen: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nä... |
| `khub-kanzlei-coi-onboarding-bauleiter` | Khub Kanzlei Coi Konfliktmatrix Spezial, Khub Kanzlei Onboarding Bauleiter, Khub Leistungsmatrix Mandanten Checkliste: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastb... |
| `khub-mandantenkonferenz-paralegal-rollen` | Khub Mandantenkonferenz Templates Spezial, Paralegal Rollen Automatisieren, Rentier Rechtsanwalt Spezial: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `playbook-qualitaetspruefung-beweislast-review` | Playbook Internationaler Bezug Und Schnittstellen, Qualitaetspruefung Beweislast Und Darlegungslast, Review Risikoampel Und Gegenargumente: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert... |
| `qa-kanzleiweit-templating-praxis-verwalter` | Skill Qa Kanzleiweit Spezial, Skill Templating Praxis, Skill Verwalter: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `qualitaetspruefung-builder-daten-red` | Skills Qualitaetspruefung, Builder Zahlen Schwellen Und Berechnung, Daten Red Team Und Qualitaetskontrolle: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
| `security-installation-security` | Security Dokumentenmatrix Und Lueckenliste, Skill Installation Security Gate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
...
| `uebersicht-einsteiger-deaktivieren` | Builder Uebersicht Für Einsteiger, Deaktivieren, Deinstallieren: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
