...
| `security-installation` | Security Dokumentenmatrix Und Lueckenliste, Skill Installation Security Gate: wählt den konkreten Prüfpfad, trennt Frist, Zuständigkeit, Belege und Rechtsgrundlage und liefert den nächsten belastbaren Output. |
