...
**Grosskanzlei Rollout Thema Prozesse Abbilden** ordnet den Fall über die tragenden Prüffelder: Grosskanzlei-Rollout, Kanzlei-Builder-Hub an kanzleispezifische Anforderungen, Typische Kanzlei-Prozesse mit Plugins und Skills abbilden. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
