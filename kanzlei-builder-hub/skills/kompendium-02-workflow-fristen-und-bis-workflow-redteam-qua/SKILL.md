...
description: "kanzlei-builder-hub: Konsolidiertes Skill-Kompendium 02; bündelt 3 frühere Spezialskills (workflow-fristen-und-risikoampel, workflow-mandantenkommunikation, workflow-redteam-qualitygate) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 02 - kanzlei-builder-hub
...
**Frühere Beschreibung:** Fristen- und Risikoampel im Plugin kanzlei-builder-hub: macht eine Sofortampel für Frist, Zuständigkeit, Haftung, Eilbedarf und fehlende Unterlagen.
...
**Frühere Beschreibung:** Mandantenkommunikation im Plugin kanzlei-builder-hub: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten.
...
**Frühere Beschreibung:** Red-Team Qualitygate im Plugin kanzlei-builder-hub: prüft das Ergebnis auf Halluzinationen, Fristenfehler, Zuständigkeit, Quellen, Beweise und Ton.
