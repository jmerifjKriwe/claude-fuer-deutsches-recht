...
| `gesetzgebungskompetenz-grundrechtspruefung` | Gesetzgebungskompetenz Grundrechtspruefung im Plugin Verfassungsrecht: prüft konkret Gesetzgebungskompetenz, Grundrechtsprüfung und Verhältnismäßigkeit, Live. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schr... |
...
| `grundrechtspruefung-acht-formelle-interessen` | Grundrechtspruefung Acht Formelle Interessen im Plugin Verfassungsrecht: prüft konkret Grundrechtsprüfung nach dem Drei-Stufen-Schema durchführen, Acht, Formelle. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem... |
| `materielle-petition-sonderfall-recherche` | Materielle Petition Sonderfall Recherche im Plugin Verfassungsrecht: prüft konkret Materielle, Petition, Recherche. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `rechtsprechungsgetrieben-rechtsweg-bverfg` | Rechtsprechungsgetrieben Rechtsweg Bverfg im Plugin Verfassungsrecht: prüft konkret Rechtsprechungsgetrieben, BVerfG-Verfahrenssicht, Annahmerisiko und Tenorierungsziel, Grundgesetz. Liefert priorisierten Output mit Norm-Pinpoints, Risik... |
| `sicht-spezialkanzlei-unter` | Sicht Spezialkanzlei Unter im Plugin Verfassungsrecht: prüft konkret Sicht, Spezialkanzlei, Unter. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `verfassung-beweislast-verfassungsbeschwerde` | Verfassung Beweislast Verfassungsbeschwerde im Plugin Verfassungsrecht: prüft konkret Verfassung, Verfassungsbeschwerde, Verfassungsmaessigkeit. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `verfassung-grundgesetz-organstreitverfahren` | Verfassung Grundgesetz Organstreitverfahren im Plugin Verfassungsrecht: prüft konkret Verfahren der Verfassungsaenderung Art, Organstreitverfahren Art, § 13 Nr, §§ 63 ff. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und n... |
| `verfassung-grundrechte-juristische-uebersicht` | Verfassung Grundrechte Juristische Uebersicht im Plugin Verfassungsrecht: prüft konkret Grundrechtsfaehigkeit juristischer Personen Art, Grundrechte des GG Ueberblick, Verhaeltnis GG-Grundrechte und EU-Grundrechtecharta. Liefert priorisi... |
| `verfassung-konkrete-normenkontrolle` | Verfassung Konkrete Normenkontrolle im Plugin Verfassungsrecht: prüft konkret Konkrete Normenkontrolle Art, §§ 80 ff, Parteiverbot Art, § 13 Nr. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `verfassung-staatsorganisation` | Verfassung Staatsorganisation im Plugin Verfassungsrecht: prüft konkret Staatsorganisation des GG, Verfassungsrechtliche Prüfung einer Massnahme oder Norm, Verhältnismäßigkeitsprüfung für staatliche Massnahmen oder. Liefert priorisierten... |
| `verfassungsbeschwerde-entwurf-formelle` | Verfassungsbeschwerde Entwurf Formelle im Plugin Verfassungsrecht: prüft konkret Verfassungsbeschwerde beim BVerfG nach §§ 90 ff, Formelle Verfassungsmäßigkeit eines Gesetzes prüfen, Gesetzgebungskompetenz des Bundes oder eines Landes fü... |
| `verfassungsrecht-anschluss-routing` | Anschluss-Routing: Einstieg und Routing; klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `verfassungsrecht-dokumente-intake` | Dokumentenintake: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `verfassungsrecht-einstieg-routing` | Einstieg und Routing: Einstieg und Routing; klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `verfassungsrecht-mandantenkommunikation-redteam-qualitygate` | Mandantenkommunikation Redteam Qualitygate im Plugin Verfassungsrecht: prüft konkret Mandantenkommunikation im Plugin verfassungsrecht, Red-Team Qualitygate im Plugin verfassungsrecht, BVerfG-Rechtsprechung zu konkreter Verfassungsfrage.... |
| `verfassungsrecht-output-waehlen` | Output wählen im Plugin Verfassungsrecht: Diese Output-Weiche für Verfassungsrecht entscheidet, ob Memo, Antrag, Schriftsatz, Tabelle, Risikoampel, Fragenliste oder Mandantenbrief der richtige nächste Schritt ist. |
| `verfassungsrecht-quellen-livecheck` | Rechtsquellen-Livecheck: Quellenprüfung; Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `verfassungsrecht-start-chronologie-fristen` | Start Chronologie Fristen im Plugin Verfassungsrecht: prüft konkret Einstieg, Schnelltriage und Fallrouting im Verfassungsrecht-Plugin, Chronologie und Belegmatrix im Plugin verfassungsrecht, Fristen- und Risikoampel im Plugin verfassung... |
