...
description: "Rechtsfragen praezise formulieren: jede Frage in einer Frage, mit normativem Bezug. Schlechte Formulierung 'Was sind die rechtlichen Folgen' wird ersetzt durch 'Hat der Mandant einen Anspruch gegen X auf Y aus Norm Z'. Liste der haeufigsten Frageformate."
---

# Memo: Rechtsfragen formulieren

## Aufgabe
Rechtsfragen praezise formulieren: jede Frage in einer Frage, mit normativem Bezug.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `memorandums-ersteller` zum Thema `memo-rechtsfragen-formulieren`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Rechtsfragen praezise formulieren: jede Frage in einer Frage, mit normativem Bezug. Schlechte Formulierung 'Was sind die rechtlichen Folgen' wird ersetzt durch 'Hat der Mandant einen Anspruch gegen X auf Y aus Norm Z'. Liste der haeufigsten Frageformate..
