...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`subsumtions-pruefer-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/subsumtions-pruefer-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`subsumtions-pruefer-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/subsumtions-pruefer-unified-mini-prompt.md)
