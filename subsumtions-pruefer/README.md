...
| `eu-abgrenzung-einschlaegige-normen` | EU Abgrenzung Einschlaegige Normen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `eu-vorabentscheidung-falsche-wiese` | EU Vorabentscheidung Falsche Wiese: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `interessen-rechtsberatung-rechtsfolgen` | Interessen Rechtsberatung Rechtsfolgen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kommentar-literatur-konkurrenzen` | Kommentar Literatur Konkurrenzen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `mandatsabbruch-empfehlung-beweisbedarf` | Mandatsabbruch Empfehlung Beweisbedarf: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `norm-zerlegen-mandantenbrief` | Norm Zerlegen Mandantenbrief: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `rechtsfolge-bestimmen-einreden-interaktiver` | Rechtsfolge Bestimmen Einreden Interaktiver: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `schema-schritt-subsumtions` | Schema Schritt Subsumtions: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `subsumtion-obersatz-rewrite-klausurton-triage` | Subsumtion Obersatz Rewrite Klausurton Triage: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `subsumtions-pruefer-start-chronologie-fristen` | Start Chronologie Fristen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `tatbestandsmerkmale-vier-zerlegen` | Tatbestandsmerkmale Vier Zerlegen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `tbm-grundrechte-grch-kandidatenloesung` | TBM Grundrechte Grch Kandidatenloesung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `unbestimmte-rechtsbegriffe-ungeschriebene` | Unbestimmte Rechtsbegriffe Ungeschriebene: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `verfahrensart-bestimmen-verjaehrung` | Verfahrensart Bestimmen Verjaehrung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `waehlen-rechtsprechung-recherche-europarecht` | Waehlen Rechtsprechung Recherche Europarecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
