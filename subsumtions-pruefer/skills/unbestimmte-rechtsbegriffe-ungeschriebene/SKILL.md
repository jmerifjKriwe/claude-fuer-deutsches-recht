...
Dieser Skill behandelt **Unbestimmte Rechtsbegriffe Ungeschriebene** als zusammenhängenden Arbeitsgang im Plugin Subsumtions Pruefer. Im Mittelpunkt steht die Prüfung von Prüft unbestimmte Rechtsbegriffe, Identifiziert judicativ entwickelte ungeschriebene, Ermittelt interaktiv das Nutzerziel (Anspruchsdurchsetzung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
