...
| Skill | Beschreibung |
| --- | --- |
| `case-dpia-drift` | Case Dpia Drift: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `dsgvo-governance-inventar` | DSGVO Governance Inventar: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `gpai-modelle-ki-anbieter-arbeitsrecht` | Gpai Modelle KI Anbieter Arbeitsrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `inventar-kontrollen-konformitaetsbewertung` | Inventar Kontrollen Konformitaetsbewertung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ki-folgenabschaetzung-ki-governance-mandat` | Folgenabschaetzung KI Governance Mandat: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ki-governance-anschluss-router` | Anschluss Router: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ki-governance-fristen-risikoampel-mandantenkommunikation` | Fristen Risikoampel Mandantenkommunikation: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `ki-inventar-marketing-werbung-rote-linien` | Inventar Marketing Werbung Rote Linien: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `kig-konformitaetsbewertung-risikobewertung` | KIG Konformitaetsbewertung Risikobewertung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `review-richtlinie` | Review Richtlinie: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `richtlinien-monitor-vorlage-anbieter` | Richtlinien Monitor Vorlage Anbieter: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `rollen-rasci-hochrisiko-anhang-incident` | Rollen Rasci Hochrisiko Anhang Incident: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `rollenmodell-use-case-vendor` | Rollenmodell USE Case Vendor: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `triage-haftung-versicherung-anwendungsfall` | Triage Haftung Versicherung Anwendungsfall: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vo-pflichtenpyramide-kig-ai-foundation` | VO Pflichtenpyramide KIG AI Foundation: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `werbung-beweislast` | Werbung Beweislast: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
