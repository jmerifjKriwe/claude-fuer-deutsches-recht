---
name: gpai-modelle-systemic-risk
description: "General-Purpose-AI-Modelle Art. 51 ff. KI-VO: Standardpflichten (Dokumentation, Trainingsdaten, Urheberrecht), zusaetzliche Pflichten fuer Modelle mit systemischem Risiko ab 10E25 FLOPs Trainingsrechenleistung. Verhaltenskodex und CE-Modell. Compliance-Roadmap fuer Modellanbieter."
---

# GPAI: Systemic-Risk-Modelle

## Aufgabe
General-Purpose-AI-Modelle Art.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `ki-governance` zum Thema `gpai-modelle-systemic-risk`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: General-Purpose-AI-Modelle Art. 51 ff. KI-VO: Standardpflichten (Dokumentation, Trainingsdaten, Urheberrecht), zusaetzliche Pflichten fuer Modelle mit systemischem Risiko ab 10E25 FLOPs Trainingsrechenleistung. Verhaltenskodex und CE-Modell. Compliance-Roadmap fuer Modellanbieter..
