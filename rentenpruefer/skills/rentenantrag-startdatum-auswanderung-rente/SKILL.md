...
description: "Rentenantrag Startdatum Auswanderung Rente im Plugin Rentenpruefer: prüft konkret Rentenantrag, Fristen und Startdatum, Rente bei Umzug ins Ausland. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Rentenantrag Startdatum Auswanderung Rente** als zusammenhängenden Arbeitsgang im Plugin Rentenpruefer. Im Mittelpunkt steht die Prüfung von Rentenantrag, Fristen und Startdatum, Rente bei Umzug ins Ausland. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
