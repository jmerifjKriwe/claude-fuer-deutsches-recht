...
description: "Kindererziehungszeiten Zeitenklaerung im Plugin Rentenpruefer: prüft konkret Kindererziehungszeiten und Berücksichtigungszeiten, Kontenklärung bei der Deutschen Rentenversicherung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Kindererziehungszeiten Zeitenklaerung** als zusammenhängenden Arbeitsgang im Plugin Rentenpruefer. Im Mittelpunkt steht die Prüfung von Kindererziehungszeiten und Berücksichtigungszeiten, Kontenklärung bei der Deutschen Rentenversicherung. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
