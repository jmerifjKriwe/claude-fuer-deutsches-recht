...
| Skill | Beschreibung |
| --- | --- |
| `aufgabenstellung-erfassen-fachgebiet` | Aufgabenstellung Erfassen Fachgebiet im Juristische Hausarbeit: prüft konkret Student erhaelt Hausarbeit-Aufgabenstellung und will den, Student weiss nicht in welches Fachgebiet die Hausarbeit, Student erstellt Gliederung für juristische... |
| `ausfluegen-didaktisches-durch` | Ausfluegen Didaktisches Durch im Juristische Hausarbeit: prüft konkret Ausfluegen, Didaktisches, Durch. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `behutsame-frech-haeufige-fehler` | Behutsame Frech Haeufige Fehler im Juristische Hausarbeit: prüft konkret Stil-Anleitung für den Dialog-Ton des Plugins, Student will typische Fehler in juristischen Hausarbeiten, Student prüft Hausarbeit vor Abgabe auf inhaltliche und. L... |
| `europarecht-anwendbarkeit-hausarbeiten` | Europarecht Anwendbarkeit Hausarbeiten im Juristische Hausarbeit: prüft konkret Student bearbeitet Hausarbeit mit Europarecht-Bezug, Hausarbeiten, Student erstellt Zeitplan und Arbeitsplan für juristische. Liefert priorisierten Output mi... |
| `europarecht-interessen-fertigen-sonderfall` | Europarecht Interessen Fertigen Sonderfall im Juristische Hausarbeit: prüft konkret Europarecht, Fertigen, Fuehrt. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `gutachtenstil-vs-haus-fussnotenstil` | Gutachtenstil VS Haus Fussnotenstil im Juristische Hausarbeit: prüft konkret Student ist unsicher ob Gutachtenstil oder Urteilsstil, Spezialfall Fussnotenstil deutsche Jurahausarbeit, Leitfaden Literaturrecherche. Liefert priorisierten O... |
| `haus-plagiatscheck-themaeingrenzung` | Haus Plagiatscheck Themaeingrenzung im Juristische Hausarbeit: prüft konkret Spezialfall Plagiatscheck und Eigenstaendigkeitserklaerung, Bauleiter Themaeingrenzung Hausarbeit, Student muss Meinungsstreit in Hausarbeit darstellen. Liefert... |
| `hausarbeit-quellenrecherche-rspr-literatur` | Hausarbeit Quellenrecherche Rspr Literatur im Juristische Hausarbeit: prüft konkret Fristen- und Risikoampel im Plugin hausarbeitenmacher, Red-Team Qualitygate im Plugin hausarbeitenmacher, Student sucht juristische Quellen für Hausarbei... |
| `hausarbeit-start` | Hausarbeit Start im Juristische Hausarbeit: prüft konkret Einstieg, Schnelltriage und Fallrouting im Hausarbeitenmacher-Plugin, Student beginnt Hausarbeit und braucht vollständige, Chronologie und Belegmatrix im Plugin hausarbeitenmacher... |
...
| `juristische-liefert-beweislast-rechtstheorie` | Juristische Liefert Beweislast Rechtstheorie im Juristische Hausarbeit: prüft konkret Juristische, Liefert, Rechtstheorie. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
| `methodenlehre-auslegung-oeffentliches` | Methodenlehre Auslegung Oeffentliches im Juristische Hausarbeit: prüft konkret Student braucht Anleitung zu den vier Auslegungsmethoden, Student bearbeitet öffentlich-rechtliche Klage in der, Student fragt sich ob er der Lehrmeinung des... |
...
| `rechtstheorie-rechtsphilosophie-seminararbeit` | Rechtstheorie Rechtsphilosophie Seminararbeit im Juristische Hausarbeit: prüft konkret Student schreibt Hausarbeit mit rechtstheoretischem Bezug, Student schreibt Seminararbeit mit persoenlicher Lekture, Adressaten. Liefert priorisierten... |
| `schleimerei-seminararbeiten-sokratisch` | Schleimerei Seminararbeiten Sokratisch im Juristische Hausarbeit: prüft konkret Schleimerei, Seminararbeiten, Sokratisch. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt. |
