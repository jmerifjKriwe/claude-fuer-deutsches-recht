...
| Skill | Beschreibung |
| --- | --- |
| `aufgabenstellung-erfassen-fachgebiet` | Aufgabenstellung Erfassen Fachgebiet: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ausfluegen-didaktisches-durch` | Ausfluegen Didaktisches Durch: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `behutsame-frech-haeufige-fehler` | Behutsame Frech Haeufige Fehler: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `europarecht-anwendbarkeit-hausarbeiten` | Europarecht Anwendbarkeit Hausarbeiten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `europarecht-interessen-fertigen-sonderfall` | Europarecht Interessen Fertigen Sonderfall: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `gutachtenstil-vs-haus-fussnotenstil` | Gutachtenstil VS Haus Fussnotenstil: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `haus-plagiatscheck-themaeingrenzung` | Haus Plagiatscheck Themaeingrenzung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hausarbeit-quellenrecherche-rspr-literatur` | Hausarbeit Quellenrecherche Rspr Literatur: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hausarbeit-start` | Hausarbeit Start: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `juristische-liefert-beweislast-rechtstheorie` | Juristische Liefert Beweislast Rechtstheorie: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `methodenlehre-auslegung-oeffentliches` | Methodenlehre Auslegung Oeffentliches: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `rechtstheorie-rechtsphilosophie-seminararbeit` | Rechtstheorie Rechtsphilosophie Seminararbeit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `schleimerei-seminararbeiten-sokratisch` | Schleimerei Seminararbeiten Sokratisch: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `strafrecht-zivilrecht-rechtswidrigkeit` | Strafrecht Zivilrecht Rechtswidrigkeit: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `subsumtion-schritt-verfassungsrecht` | Subsumtion Schritt Verfassungsrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `zivilrecht-anspruchsgrundlagen` | Zivilrecht Anspruchsgrundlagen: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
