...
| `einfache-leichte-ls-juristisches-glossar-justizportal-pruefen` | LS Juristisches Glossar Justizportal Pruefen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-aufenthaltsrecht-mandant-betreuung` | Elsj Aufenthaltsrecht Mandant Betreuung: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-bescheidmodus-02` | Elsj Bescheidmodus 02: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-familienrecht-erstgespraech-juristische` | Elsj Familienrecht Erstgespraech Juristische: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-leichte-sprache-mietrecht` | Elsj Leichte Sprache Mietrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-qualitaetsgate-rechtsnormen-einfach` | Elsj Qualitaetsgate Rechtsnormen Einfach: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-sozialgerichtsverfahren-strafverfahren` | Elsj Sozialgerichtsverfahren Strafverfahren: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `elsj-uebersetzungsablauf-wortebene-haus` | Elsj Uebersetzungsablauf Wortebene Haus: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `experimentelle-glossar-sonderfall-jura` | Experimentelle Glossar Sonderfall Jura: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fristen-form-zustaendigkeit-rechtsweg` | Einfache: Fristen, Form, Zuständigkeit und Rechtsweg: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
...
| `juristische-juristisches-beweislast-klaeren` | Juristische Juristisches Beweislast Klaeren: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `leichte-qualitaetsgate-rechtsinhalt` | Qualitaetsgate Rechtsinhalt: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `leichte-sprache-jura-fristen-risiko-mandant` | Fristen Risiko Mandant: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `leichte-sprache-jura-ls-bescheid-chronologie` | LS Bescheid Chronologie: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `leichte-sprache-zielgruppe-zahlen-schwellen-berechnung` | Zielgruppe Zahlen Schwellen Berechnung: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
...
| `risikoampel-gegenargumente` | Leichte: Risikoampel, Gegenargumente und Verteidigungslinien: prüft Normen, Belege, Risiken, Gegenargumente und erzeugt ein verwertbares Arbeitsergebnis. |
| `sichern-sprache-standard` | Sichern Sprache Standard: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `texte-uebertragen-zielgruppe-sprachniveau` | Texte Uebertragen Zielgruppe Sprachniveau: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
