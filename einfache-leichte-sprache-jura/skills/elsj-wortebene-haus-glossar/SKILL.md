---
name: elsj-wortebene-haus-glossar
...
## Aufgabe
Hauseigenes Glossar: typische juristische Begriffe und deren Uebersetzungen.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `einfache-leichte-sprache-jura` zum Thema `elsj-wortebene-haus-glossar`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Hauseigenes Glossar: typische juristische Begriffe und deren Uebersetzungen. Beispiele: 'Beklagter' = 'die Person, gegen die geklagt wird'; 'Frist' = 'Zeitraum, in dem etwas getan werden muss'. Aufnahme in Kanzlei-Wiki..
