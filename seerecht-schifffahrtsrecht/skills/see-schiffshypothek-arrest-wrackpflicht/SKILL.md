...
description: "SEE Schiffshypothek Arrest Wrackpflicht im Plugin Seerecht Schifffahrtsrecht: prüft konkret Schiffshypothek. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**SEE Schiffshypothek Arrest Wrackpflicht** ordnet den Fall über die tragenden Prüffelder: Schiffshypothek. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
