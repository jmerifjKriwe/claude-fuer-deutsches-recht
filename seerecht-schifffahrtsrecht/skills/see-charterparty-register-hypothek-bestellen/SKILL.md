...
description: "SEE Charterparty Register Hypothek Bestellen im Plugin Seerecht Schifffahrtsrecht: prüft konkret Charterparty. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**SEE Charterparty Register Hypothek Bestellen** ordnet den Fall über die tragenden Prüffelder: Charterparty. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
