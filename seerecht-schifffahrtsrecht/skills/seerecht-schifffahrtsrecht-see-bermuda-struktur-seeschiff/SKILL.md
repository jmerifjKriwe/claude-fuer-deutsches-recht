...
description: "SEE Bermuda Struktur Seeschiff im Plugin Seerecht Schifffahrtsrecht: prüft konkret Reederei nutzt Bermuda-Holding-Struktur (SPV, Mandant klaert ob sein Fahrzeug Seeschiff oder Binnenschiff, Mandant kauft Schiff und klaert Eigentumslage, Mandant (Bank oder Kaeufer) prueft bestehende. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
**SEE Bermuda Struktur Seeschiff** ordnet den Fall über die tragenden Prüffelder: Reederei nutzt Bermuda-Holding-Struktur (SPV, Mandant klaert ob sein Fahrzeug Seeschiff oder Binnenschiff, Mandant kauft Schiff und klaert Eigentumslage. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
...
- Rolle und Ziel im Seerecht Schifffahrtsrecht klären: Welche Partei vertritt der Mandant, welcher Ergebnistyp ist gefragt (Schriftsatz, Bescheidprüfung, Vertragsentwurf, Eilantrag, Stellungnahme)? Welches der oben gelisteten Prüffelder trägt die Akte wirklich?
