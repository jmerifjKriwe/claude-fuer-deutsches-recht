...
| Skill | Beschreibung |
| --- | --- |
| `anspruchslandkarte-bgb-aufforderungsschreiben` | Anspruchslandkarte BGB Aufforderungsschreiben: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `aufforderung-beweise-red-grenzbaum` | Aufforderung Beweise RED Grenzbaum: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `drohender-einsturz-einfriedung-zaun` | Drohender Einsturz Einfriedung Zaun: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `fristennotiz-naechster-ueberbau-akten` | Fristennotiz Naechster Ueberbau Akten: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `grenzbaum-grenzanlage-hammerschlags` | Grenzbaum Grenzanlage Hammerschlags: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `hammerschlagsrecht-hecke-immissionen` | Hammerschlagsrecht Hecke Immissionen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `immissionen-laerm-landesnachbarrecht` | Immissionen Laerm Landesnachbarrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `klage-beweislast-nachbarrecht` | Klage Beweislast Nachbarrecht: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `laermimmissionen-mediation-vorrang` | Laermimmissionen Mediation Vorrang: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `nachbarschaftsstreit-fristen-risiko-mandant` | Fristen Risiko Mandant: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `nachbarschaftsstreit-pruefer-anschluss-router` | Anschluss Router: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
...
| `notweg-ueberhang-sonderfall-edge` | Notweg Ueberhang Sonderfall Edge: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `notweg-zufahrt-selbsthilfe-eskalationsgrenzen` | Notweg Zufahrt Selbsthilfe Eskalationsgrenzen: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `ueberbau-ueberhang-aeste-mediation` | Ueberbau Ueberhang Aeste Mediation: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
| `vertiefung-baugrube` | Vertiefung Baugrube: bearbeitet den maßgeblichen Prüfpfad und erzeugt den nächsten belastbaren Output im Mandat. |
| `vertiefung-interessen-wurzeln-zaun` | Vertiefung Interessen Wurzeln Zaun: bündelt 3 verwandte Prüffelder und erzeugt den nächsten belastbaren Output — nach Frist, Zuständigkeit, Beweislast und gewünschtem Ergebnis priorisiert. |
