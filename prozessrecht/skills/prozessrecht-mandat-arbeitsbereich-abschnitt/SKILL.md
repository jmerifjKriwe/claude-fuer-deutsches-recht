...
Dieser Skill behandelt **Mandat Arbeitsbereich Abschnitt** als zusammenhängenden Arbeitsgang im Plugin Prozessrecht. Im Mittelpunkt steht die Prüfung von Prozessrechtliche Strategie im laufenden Verfahren anpassen, Digitaler Arbeitsbereich für Prozessmandate, Einzelne Abschnitte eines Schriftsatzes erstellen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
