...
Dieser Skill behandelt **Erforderlichkeit NO Training Mandanten** als zusammenhängenden Arbeitsgang im Plugin Berufsrecht Ki Vertragspruefung. Im Mittelpunkt steht die Prüfung von Ex-ante-Vermerk zur Erforderlichkeit nach § 43e BRAO für, No-Training, Modellverbesserung und Telemetrie im KI-Vertrag prüfen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
