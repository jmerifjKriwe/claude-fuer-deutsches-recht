...
description: "Asbestos Channeling Automatic Stay Avoidance im Plugin Us Bankruptcy Code: prüft konkret Prueft asbestos-specific trust/channeling structure, voting, future claims repre, Prueft automatic stay scope. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Asbestos Channeling Automatic Stay Avoidance** als zusammenhängenden Arbeitsgang im Plugin Us Bankruptcy Code. Im Mittelpunkt steht die Prüfung von Prueft asbestos-specific trust/channeling structure, voting, future claims repre und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
