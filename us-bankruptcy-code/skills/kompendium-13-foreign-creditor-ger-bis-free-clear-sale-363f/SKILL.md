...
description: "us-bankruptcy-code: Konsolidiertes Skill-Kompendium 13; bündelt 4 frühere Spezialskills (foreign-creditor-german-client, fraudulent-lbo, fraudulent-transfers-548, free-clear-sale-363f) und bewahrt deren Workflows, Normanker, Prüfprogramme und Ausgabemuster."
---

# Kompendium 13 - us-bankruptcy-code
...
**Frühere Beschreibung:** Fuehrt deutsche Gläubiger durch US-Bankruptcy: notice, claim, stay, contract, committee, plan vote and distributions.
...
**Frühere Beschreibung:** Prueft leveraged buyout fraudulent-transfer exposure, solvency, reasonably equivalent value and lender/recipient targets.
...
**Frühere Beschreibung:** Prueft actual and constructive fraudulent transfers, two-year lookback, value, insolvency and insider transactions.
...
**Frühere Beschreibung:** Prueft sale free and clear of interests, liens attaching to proceeds, consent, bona fide dispute and statutory bases.
