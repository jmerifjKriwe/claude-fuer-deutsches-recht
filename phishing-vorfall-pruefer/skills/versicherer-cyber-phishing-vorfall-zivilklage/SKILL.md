...
description: "Versicherer Cyber Phishing Vorfall Zivilklage im Plugin Phishing Vorfall Pruefer: prüft konkret Cyberversicherung pruefen, Prüft Phishing-Vorfall im Online-Banking oder, Zivilklage gegen Bank wenn Rueckbuchung verweigert. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Versicherer Cyber Phishing Vorfall Zivilklage** als zusammenhängenden Arbeitsgang im Plugin Phishing Vorfall Pruefer. Im Mittelpunkt steht die Prüfung von Cyberversicherung pruefen, Prüft Phishing-Vorfall im Online-Banking oder, Zivilklage gegen Bank wenn Rueckbuchung verweigert. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
