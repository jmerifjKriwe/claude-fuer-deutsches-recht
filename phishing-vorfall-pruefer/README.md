...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`phishing-vorfall-pruefer-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/phishing-vorfall-pruefer-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`phishing-vorfall-pruefer-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/phishing-vorfall-pruefer-unified-mini-prompt.md)
