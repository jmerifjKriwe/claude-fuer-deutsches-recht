...
| **Phishing-Vorfall-Prüfer-Plugin** | Vollständiges Plugin mit Skills, README und Begleitdateien. | [`phishing-vorfall-pruefer.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/phishing-vorfall-pruefer.zip) |
| **Phishing-Vorfall-Prüfer-Testakte** | Demonstrationsmaterial zum Ausprobieren des Workflows. | [`testakte-phishing-vorfall-mayer-sparkasse-berlin.zip`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/testakte-phishing-vorfall-mayer-sparkasse-berlin.zip) (Akte Phishing-Vorfall Mayer ./. Sparkasse Berlin) |
