...
**Geldwaesche Sicherungsmassnahmen Simulation** ordnet den Fall über die tragenden Prüffelder: Aufbau und Haertung interner Sicherungsmassnahmen ICP nach, Simulation eines Compliance-Arbeitstags mit Onboarding, Erkennung auffälliger Transaktionsmuster und Red-Flags im. Zuerst wird das Feld bestimmt, das die Akte wirklich trägt; ergänzende Felder kommen nur hinzu, wenn sie dieselbe Frist, Zuständigkeit, Beweislast oder denselben Output berühren.
## Prüffelder
