...
description: "Geldwaesche Sicherungsmassnahmen Simulation im Plugin Geldwaeschepraevention Aml Kyc: prüft konkret Aufbau und Haertung interner Sicherungsmassnahmen ICP nach, Simulation eines Compliance-Arbeitstags mit Onboarding, Erkennung auffälliger Transaktionsmuster und Red-Flags im. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Geldwaesche Sicherungsmassnahmen Simulation** als zusammenhängenden Arbeitsgang im Plugin Geldwaeschepraevention Aml Kyc. Im Mittelpunkt steht die Prüfung von Aufbau und Haertung interner Sicherungsmassnahmen ICP nach, Simulation eines Compliance-Arbeitstags mit Onboarding, Erkennung auffälliger Transaktionsmuster und Red-Flags im. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
