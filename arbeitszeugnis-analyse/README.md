...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`arbeitszeugnis-analyse-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/arbeitszeugnis-analyse-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`arbeitszeugnis-analyse-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/arbeitszeugnis-analyse-unified-mini-prompt.md)
