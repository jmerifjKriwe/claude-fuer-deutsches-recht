...
description: "INV Public Healthcare im Internal Investigations: prüft konkret Untersucht Unregelmäßigkeiten bei öffentlichen, VgV, Kart, Untersucht Healthcare-Compliance-Verstöße – § 299a/b StGB. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Public Healthcare** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Untersucht Unregelmäßigkeiten bei öffentlichen, VgV, Kart. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
