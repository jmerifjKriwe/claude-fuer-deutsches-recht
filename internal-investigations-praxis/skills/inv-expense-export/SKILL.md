...
description: "INV Expense Export im Internal Investigations: prüft konkret Untersucht Spesenabrechungs- und Reisekostenbetrug –, Untersucht Verstöße gegen Exportkontrollrecht – AWG, AWV, EG-Dual-Use-VO. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Expense Export** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Untersucht Spesenabrechungs- und Reisekostenbetrug –, Untersucht Verstöße gegen Exportkontrollrecht – AWG, AWV. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
