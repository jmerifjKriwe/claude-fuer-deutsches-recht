...
description: "INV Honeypot Legal im Internal Investigations: prüft konkret Bewertet das Risiko, dass die Untersuchung selbst zum Honeypot für Behörden, Geg, Implementiert Legal Hold – Sicherung. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Honeypot Legal** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Bewertet das Risiko, dass die Untersuchung selbst zum Honeypot für Behörden, Geg. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
