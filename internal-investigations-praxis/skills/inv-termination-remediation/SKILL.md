...
description: "INV Termination Remediation im Internal Investigations: prüft konkret Entwickelt Kündigungsstrategie für Beschuldigte und, Erstellt einen strukturierten Remediation-Plan nach. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Termination Remediation** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Entwickelt Kündigungsstrategie für Beschuldigte und, Erstellt einen strukturierten Remediation-Plan nach. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
