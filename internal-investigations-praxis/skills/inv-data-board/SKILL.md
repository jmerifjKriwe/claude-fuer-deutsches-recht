---
name: inv-data-board
description: "INV Data Board im Internal Investigations: prüft konkret Richtet einen sicheren virtuellen Data Room für externe, Behörden und US, Richtet ein Sonderuntersuchungsausschuss des Vorstands oder. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Data Board** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Richtet einen sicheren virtuellen Data Room für externe, Behörden und US, Richtet ein Sonderuntersuchungsausschuss des Vorstands oder. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
