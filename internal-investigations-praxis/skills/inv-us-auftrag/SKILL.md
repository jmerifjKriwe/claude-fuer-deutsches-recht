---
name: inv-us-auftrag
description: "INV US Auftrag im Internal Investigations: prüft konkret Steuert das US-Discovery-Risiko bei Internal Investigations, Attorney-Cli, Formuliert Untersuchungsauftrag, Scope. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV US Auftrag** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Steuert das US-Discovery-Risiko bei Internal Investigations, Attorney-Cli, Formuliert Untersuchungsauftrag. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
