...
description: "INV Third Vendor im Internal Investigations: prüft konkret Überprüft Third-Party-Agenten und Intermediäre auf, Untersucht Lieferanten-Kickbacks – forensische, Vergabeverfahren. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **INV Third Vendor** als zusammenhängenden Arbeitsgang im Internal Investigations. Im Mittelpunkt steht die Prüfung von Überprüft Third-Party-Agenten und Intermediäre auf, Untersucht Lieferanten-Kickbacks – forensische, Vergabeverfahren. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
