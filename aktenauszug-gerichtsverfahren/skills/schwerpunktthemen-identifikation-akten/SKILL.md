...
description: "Schwerpunktthemen Identifikation Akten im Aktenauszug-Praxis: prüft konkret Anwalt braucht schnellen Überblick über drei bis fuenf, Akten, Aktenauszug. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Schwerpunktthemen Identifikation Akten** als zusammenhängenden Arbeitsgang im Aktenauszug-Praxis. Im Mittelpunkt steht die Prüfung von Anwalt braucht schnellen Überblick über drei bis fuenf, Akten, Aktenauszug. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
