...
description: "Akzg Zeitstrahl Anlagenverzeichnis Extrakt im Aktenauszug-Praxis: prüft konkret Checkliste Zeitstrahl in Aktenauszug, Anwalt sucht alle Anlagen K-/B-/AST-/AG-Verweise in der, Stilrichtlinie für den juristisch sauberen neutralen und. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **Akzg Zeitstrahl Anlagenverzeichnis Extrakt** als zusammenhängenden Arbeitsgang im Aktenauszug-Praxis. Im Mittelpunkt steht die Prüfung von Checkliste Zeitstrahl in Aktenauszug, Anwalt sucht alle Anlagen K-/B-/AST-/AG-Verweise in der, Stilrichtlinie für den juristisch sauberen neutralen und. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
