...
description: "Betreuer als Erbe oder Beschenkter: § 1825 BGB Verbot, Genehmigungspflicht, Anfechtbarkeit. Pruefraster fuer Notarpraxis und Konflikt-Anzeige beim Betreuungsgericht."
---

# Betreuer als Erbe

## Aufgabe
Betreuer als Erbe oder Beschenkter: § 1825 BGB Verbot, Genehmigungspflicht, Anfechtbarkeit.


## Fachlicher Arbeitskern

Dieser Skill ist kein allgemeiner Chat-Modus, sondern ein Arbeitswerkzeug fuer `betreuungsrecht` zum Thema `betreuung-erbe-werden`. Ausgangspunkt ist immer die konkrete Aufgabe aus der Beschreibung: Betreuer als Erbe oder Beschenkter: § 1825 BGB Verbot, Genehmigungspflicht, Anfechtbarkeit. Pruefraster fuer Notarpraxis und Konflikt-Anzeige beim Betreuungsgericht..
