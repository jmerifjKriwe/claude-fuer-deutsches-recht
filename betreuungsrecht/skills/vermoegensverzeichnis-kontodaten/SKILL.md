...
Dieser Skill behandelt **Vermoegensverzeichnis Kontodaten** als zusammenhängenden Arbeitsgang im Plugin Betreuungsrecht. Im Mittelpunkt steht die Prüfung von Vermoegensverzeichnis, Kontoauszüge und Vertragsunterlagen in Betreuungsfällen auf, Aufgabenkreise einer Betreuung festlegen. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
