...
description: "TK Callcenter TK Campusnetze im Telekommunikationsrecht: prüft konkret Telefonwerbung, Einwilligung, Rufnummernanzeige, Dokumentation. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **TK Callcenter TK Campusnetze** als zusammenhängenden Arbeitsgang im Telekommunikationsrecht. Im Mittelpunkt steht die Prüfung von Telefonwerbung, Einwilligung, Rufnummernanzeige. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
