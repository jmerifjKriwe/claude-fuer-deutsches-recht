...
description: "TK Anschlussbereitstellung TK im Telekommunikationsrecht: prüft konkret Bereitstellung von Festnetz-, Glasfaser-, Mobilfunk- oder Business-Anschluss, Kommunikationsstrategie gegenüber der Bundesnetzagentur. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **TK Anschlussbereitstellung TK** als zusammenhängenden Arbeitsgang im Telekommunikationsrecht. Im Mittelpunkt steht die Prüfung von Bereitstellung von Festnetz-, Glasfaser-, Mobilfunk- oder Business-Anschluss. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
