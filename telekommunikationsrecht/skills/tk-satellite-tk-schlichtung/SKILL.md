...
description: "TK Satellite TK Schlichtung im Telekommunikationsrecht: prüft konkret Satelliteninternet/NTN, Verbraucherschlichtung bei TK-Streit. Liefert priorisierten Output mit Norm-Pinpoints, Risikoampel und nächstem Schritt."
---
...
Dieser Skill behandelt **TK Satellite TK Schlichtung** als zusammenhängenden Arbeitsgang im Telekommunikationsrecht. Im Mittelpunkt steht die Prüfung von Satelliteninternet/NTN, Verbraucherschlichtung bei TK-Streit. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
