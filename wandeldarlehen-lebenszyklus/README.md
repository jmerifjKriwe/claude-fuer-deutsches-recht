...
| Skill | Beschreibung |
| --- | --- |
| `begleitet-erstpruefung-und-mandatsziel` | Begleitet: Erstprüfung, Rollenklärung und Mandatsziel im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `bilingual-einsprachig` | Bilingual: Schriftsatz-, Brief- und Memo-Bausteine im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `einsprachig-verhandlung-vergleich-und-eskalation` | Einsprachig: Verhandlung, Vergleich und Eskalation im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `gmbh-vollstaendigen` | GmbH: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `lebenszyklus-bilinguale-vertragserstellung` | Lebenszyklus: Fristen, Form, Zuständigkeit und Rechtsweg im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `vertragserstellung-behoerden-gericht-und-registerweg` | Vertragserstellung: Behörden-, Gerichts- oder Registerweg im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `vollstaendigen-tatbestand-beweis-und-belege` | Vollstaendigen: Tatbestandsmerkmale, Beweisfragen und Beleglage im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
| `wandeldarlehens-wandelereignisse` | Wandeldarlehens: Dokumentenmatrix, Lückenliste und Nachforderung im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
...
| `wandelereignisse-zahlen-schwellen-und-berechnung` | Wandelereignisse: Zahlen, Schwellenwerte und Berechnung im Plugin wandeldarlehen lebenszyklus im Wandeldarlehen Lebenszyklus. |
