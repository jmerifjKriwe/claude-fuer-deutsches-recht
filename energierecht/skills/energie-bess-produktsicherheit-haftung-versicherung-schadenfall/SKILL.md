...
Dieser Skill behandelt **Energie Bess Produktsicherheit Haftung Versicherung Schadenfall** als zusammenhängenden Arbeitsgang im Plugin Energierecht. Im Mittelpunkt steht die Prüfung von Prüft Batteriecontainer, BMS, Wechselrichter und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
