...
Dieser Skill behandelt **ER Bess PPA Projektakte Rechtsmittel** als zusammenhängenden Arbeitsgang im Plugin Energierecht. Im Mittelpunkt steht die Prüfung von Prüft Erlösverträge für Speicher, Prüft die gesamte Speicherakte auf Lücken, Widersprüche und weiteren verwandten Aspekten. Die unten gelisteten Prüffelder bauen aufeinander auf: zuerst das im konkreten Fall tragende Feld identifizieren, dann ergänzend nur die Felder heranziehen, deren Tatbestand die Akte wirklich trägt. Rolle, Frist, Zuständigkeit, Beweislast und gewünschter Output bleiben dabei klar getrennt.
## Prüffelder
