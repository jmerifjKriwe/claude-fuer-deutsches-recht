...
| **Unified Mini Prompt** (Sparversion bis 7.500 Zeichen) | [`verlagsredaktion-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/verlagsredaktion-unified-mini-prompt.md) |
...
- **Sparversion herunterladen:** [`verlagsredaktion-unified-mini-prompt.md`](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/verlagsredaktion-unified-mini-prompt.md)
